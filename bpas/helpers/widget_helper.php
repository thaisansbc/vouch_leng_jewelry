...
if (!function_exists('clock_widget')) {
    function clock_widget($return_as_data = false, $user_id = null) {
        $ci = get_instance();
        $view_data["clock_status"] = $ci->attendances_model->current_clock_in_record($user_id);
        return $ci->load->view($ci->theme . 'attendances/clock_widget', $view_data);
    }
}
