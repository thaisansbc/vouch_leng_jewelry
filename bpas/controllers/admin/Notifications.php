...
class Notifications extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = [
                ...
                'from_date' => $this->input->post('from_date') ? $this->bpas->fld($this->input->post('from_date')) : null,
                'till_date' => $this->input->post('to_date') ? $this->bpas->fld($this->input->post('to_date')) : null,
    ...
    public function delete($id = null)
    {
        ...
        if ($this->cmt_model->deleteComment($id)) {
            $this->bpas->send_json(['error' => 0, 'msg' => lang('notifications_deleted')]);
        }
    }
