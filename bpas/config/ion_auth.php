 ...
 */
$config['site_title']                 = "SBC Solutions";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@sbcsolution.biz"; // Admin Email, admin@example.com This is not more functional
