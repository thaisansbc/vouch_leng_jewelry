...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_keep'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('returns/add_keep', $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php 
                        $current_date = date("d/m/Y", strtotime(" +1 months"));
                        //if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "redate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : date('d/m/Y H:i:s')), 'class="form-control input-tip datetime" id="redate" required="required"'); ?>
                                </div>
                            </div>
                        <?php //} ?>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("expired_date", "expired"); ?>
                                <?php echo form_input('expired_date', (isset($_POST['expired_date']) ? $_POST['expired_date'] : $current_date), 'class="form-control input-tip datetime" required="required"'); ?>
                            </div>
                        </div>
