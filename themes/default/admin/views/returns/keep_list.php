...
<script>
    $(document).ready(function () {
        oTable = $('#REData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('returns/getKeep' . ($warehouse_id ? '/' . $warehouse_id : '')); ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-random"></i><?=lang('keep') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=admin_url('returns/add_keep')?>">
                                <i class="fa fa-plus-circle"></i> <?=lang('add_keep')?>
                            </a>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="REData" class="table table-hover table-striped">
                        <thead>
                            <tr>
