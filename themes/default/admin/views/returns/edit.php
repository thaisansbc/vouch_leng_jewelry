...
<script type="text/javascript">
    ...
    ?>
        ...
        localStorage.setItem('reshipping', '<?= $this->bpas->formatDecimal($inv->shipping); ?>');
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="si_box form-group">
                                <?php
                                    ...
                                    echo form_dropdown('si_reference', $sa_opts, $inv->sale_id, 'id="srlsi_reference" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("si_reference") . '"  class="form-control input-tip select" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4" id="bank_acc">
                                ...
                                //    $bank = array('0' => '-- Select Bank Account --');
                                    ...
                                    echo form_dropdown('bank_account', $bank, $inv->bank_account, 'id="bank_account_1" class="ba form-control kb-pad bank_account" required="required" data-bv-notempty="true"');
