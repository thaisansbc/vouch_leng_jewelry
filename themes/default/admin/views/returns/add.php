                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $reference), 'class="form-control input-tip" id="reref"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="si_box form-group">
                                <?php
                                    ...
                                    echo form_dropdown('si_reference', $sa_opts, '', 'id="srlsi_reference" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("si_reference") . '"  class="form-control input-tip select" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
