...
<div class="modal-dialog  modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_calendar'); ?>sf</h4>
        </div>
        <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form'];
        echo admin_form_open_multipart('calendar/edit/'.$events->id, $attrib); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <?= lang('customer', 'customer'); ?>
                            ...
                            echo form_dropdown('customer', $cust, $events->customer, 'class="form-control"  id="slcustomer" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("customer") . '" required="required"');
                            ?>
                            ...
                            <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                <a href="<?= admin_url('customers/add'); ?>" id="add-customer" class="external" data-toggle="modal" data-backdrop="static" data-target="#myModal2"><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <?= lang('assign_to', 'assign_to'); ?>
                            <?php
                                ...
                                echo form_dropdown('assign_to', $u, $events->assign_to, 'id="useer_id" class="form-control input-tip select" required="required" data-placeholder="' . lang("select") . ' ' . lang("user") . '" ');
                            ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?= form_dropdown('status', $status, $events->status, 'class="form-control tip" id="pdf_lib" required="required"'); ?>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
