...
<script>
    $(document).ready(function () {
        oTable = $('#LTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('calendar/getAppointmentLists'.($biller_id ?'/'.$biller_id:'').'?v=1'.$v); ?>',
            ...
            {column_number: 5,filter_default_label: "[<?=lang('assgin_to');?>]", filter_type: "text", data: []},
			{column_number: 6, filter_default_label: "[<?=lang('start');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('end');?>]", filter_type: "text", data: []},
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
					...
					<ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                       <li>
							<li>
	                            <a href="<?= admin_url('calendar/add') ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
