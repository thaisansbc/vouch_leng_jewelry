...
<script>
    $(document).ready(function () {
        oTable = $('#LTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('calendar/getSchedules'.($biller_id ?'/'.$biller_id:'').'?v=1'.$v); ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.id = aData[0];
                nRow.className = "view_schedule_link";
                return nRow;
            },
            ...
            {column_number: 3, filter_default_label: "[<?=lang('end');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('title');?>]", filter_type: "text", data: []},
			
            {column_number: 5, filter_default_label: "[<?=lang('limit');?>]", filter_type: "text", data: []},
...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-solid fa-calendar-days"></i>
        <?= lang('Schedules'); ?>
    </h2>
    <div class="box-icon">
        <ul class="btn-tasks">
        ...
        <ul class="btn-tasks">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                   <li>
                        <a href="<?= admin_url('calendar/add_schedule') ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                            <i class="fa fa-plus-circle"></i> <?= lang('add_schedule') ?>
                        </a>
                    </li>
                    <li>
...
<div class="box">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <div id="form">
                    <?php echo admin_form_open("calendar/schedules"); ?>
                    <div class="row">
                        <div class="col-sm-4">
