...
<script>
    $(document).ready(function () {
        oTable = $('#TOData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('transfers/getTransferAlerts') ?>',
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bSortable": false,"mRender": attachment}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star-o"></i><?= lang('list_transfer_alerts'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="TOData" cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-hover table-striped">
                        ...
                        <tr class="active">
                            ...
                            <th style="text-align: right !important;"><?= lang('product_tax'); ?></th>
