    ...
    $(document).ready(function () {
        oTable = $('#TOData').dataTable({
            ...
            "aoColumns": [
                    ...
                    <?php } ?>
                    {"mRender": row_status}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}
            ],
            ...
            <?php if (($this->Owner || $this->Admin) || $this->GP['products-cost']) { $c = 8; } else { $c = 5; } ?>
            {column_number: <?= $c ?>, filter_default_label: "[<?=lang('status');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
