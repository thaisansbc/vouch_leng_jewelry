            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if (($this->Owner || $this->Admin) || $this->session->userdata('show_cost')) { ?>
                                ...
                                <?php if ($Settings->tax1) {
                                echo '<td style="width: 80px; text-align:right; vertical-align:middle;">' .$this->bpas->formatMoney($row->item_tax) . '</td>';
                                } ?>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="<?= $col; ?>" style="text-align:right;"><?= lang('total'); ?>(<?= $default_currency->code; ?>)</td>
