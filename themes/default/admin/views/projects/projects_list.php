...
<div id="form">
    ...
    <?php echo admin_form_open('projects/index'); ?>
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                echo form_dropdown('project', $pro, (isset($_POST['project']) ? $_POST['project'] : ''), 'id="poproject" data-placeholder="' . lang("select") . ' ' . lang("project") . '" class="form-control select" ');
                ?>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php if (!empty($projects)) { ?>
                            <tbody>
                                ...
                                ?>
                                    <tr class="project_link" id="<?= $project->id;?>">
                                        <th style="min-width:30px; width: 30px; text-align: center;">
                                            <input class="checkbox" type="checkbox" name="val[]" value="<?= $project->id ?>" id="<?= $project->id ?>" />
                                        </th>
                                        <td><?= $this->bpas->hrld($project->date); ?></td>
                                        <td><?= $project->biller; ?></td>
                                        ...
                                        <td><?= $this->bpas->approved_status($project->approve_status); ?></td>
                                        <td><?= $this->bpas->row_status($project->status); ?></td>
                                        <td>
                                            ...
                                            <?php if ($Owner || $Admin) { ?>
                                                <a href="#" class="tip po" title="" data-content="<p>Are you sure?</p><a class='btn btn-danger' href='<?= admin_url('projects/delete/' . $project->id) ?>'>Yes I'm sure</a> <button class='btn po-close'>No</button>" data-original-title="Delete Project"><i class="fa fa-trash-o"></i></a>
                                            <?php } ?>
