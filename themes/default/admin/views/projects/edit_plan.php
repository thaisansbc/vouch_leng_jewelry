...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_plan'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("projects/edit_plan/" . $inv->id, $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("title", "title"); ?>
                                <?= form_input('title', (isset($_POST['title']) ? $_POST['title'] : $purchase->title), 'required="required" class="form-control input-tip"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
