...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?= lang('edit_note'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo admin_form_open_multipart("projects/edit_note/".$vendor->id, $attrib); ?>
        ...
        <div class="modal-body">
			...
			<div class="form-group">
                <?= lang("title", "title"); ?>
                <?= form_input('title', $vendor->title, 'required="required" class="form-control input-tip"'); ?>
            </div> 
            <div class="form-group">
