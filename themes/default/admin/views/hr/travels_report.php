...
<script>
    $(document).ready(function () {
        oTable = $('#REM').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getTravelsReport/?v=1' . $v); ?>',
            ...
            {column_number: 1, filter_default_label: "[<?=lang('purpose');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('travels_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("hr/getTravelsReport"); ?>
                    <div class="row">
						<div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
	                        <div class="form-group">
								<?php echo lang('from_date', 'from_date'); ?>
								<div class="controls">
									<input type="text" value="<?= (isset($_POST['from_date']) ? $_POST['from_date'] :''); ?>" name="from_date" class="form-control date"/>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								...
								<div class="controls">
									<input type="text" name="to_date" value="<?= (isset($_POST['to_date']) ? $_POST['to_date'] :''); ?>" class="form-control date"/>
								</div>
							</div>
						</div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#xls').click(function (event) {
            ...
            window.location.href = "<?=admin_url('hr/getTravelsReport/xls/?v=1'.$v)?>";
            return false;
        });
