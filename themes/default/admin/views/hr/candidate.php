<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EmployeeTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getCandidates/'.($biller ? $biller->id : '')); ?>',
			...
			'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                if (aData[8] == 'interview' || aData[8] == 'shortlist') {
                    action.find('.add_shortlist').remove();
                }
				return nRow;
			},
            "aoColumns": [{
			...
			{column_number: 7, filter_default_label: "[<?=lang('date_of_birth');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		<h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('candidate').' ('.($biller ? $biller->name : lang('all_billers')).')'; ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('hr/add_candidate/'); ?>">
                                <i class="fa fa-plus"></i> <?= lang('add_candidate') ?>
                            </a>                           
                        </li>
						<li>
                ...
                <div class="table-responsive">
                    <table id="EmployeeTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:150px;"><?php echo lang('first_name'); ?></th>
                            <th style="width:150px;"><?php echo lang('last_name'); ?></th>
                            <th style="width:150px;"><?php echo lang('gender'); ?></th>
							<th style="width:180px;"><?php echo lang('email'); ?></th>
                            <th style="width:150px;"><?php echo lang('phone'); ?></th>	
							<th style="width:150px;"><?php echo lang('nationality'); ?></th>								
