...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_id_card'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("hr/edit_id_card/".$id_card->id, $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
						<div class="panel panel-warning">
							...
							<div class="panel-body" style="padding: 5px;">
								...
								<div class="col-md-4">
									<div class="form-group">
										<?= lang("invalid_date", "invalid_date"); ?>
										<?php echo form_input('invalid_date', (isset($_POST['invalid_date']) ? $_POST['invalid_date'] : $this->bpas->hrld($id_card->invalid_date)), 'class="form-control input-tip datetime" id="invalid_date" required="required"'); ?>
									</div>
								</div>
								<div class="col-md-4">
									<?= lang("sample_id_card", "sample_id_card"); ?>
									<div class="form-group">
										<?php
										foreach ($sample_id_cards as $sample_id_card) {
											$sp[$sample_id_card->id] = $sample_id_card->name;
										}
										echo form_dropdown('sample_id_card', $sp, (isset($_POST['sample_id_card']) ? $_POST['sample_id_card'] : $id_card->sample_id_card), 'id="sample_id_card" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("sample_id_card") . '" required="required" class="form-control input-tip select" style="width:100%;"');
										?>
									</div>
								</div>
								<div class="col-md-4">
