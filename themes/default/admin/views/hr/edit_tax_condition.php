<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_tax_condition'); ?></h4>
        </div>
        <?=  admin_form_open_multipart("hr/edit_tax_condition/".$id); ?>
		<div class="modal-body">
			...
			<div class="form-group">
                ...
                <div class="controls">
                    <input type="text" value="<?= $row->tax_percent ?>" class="form-control" name="tax_percent" required="required"/>
                </div>
            </div>
			...
			<div class="form-group">
                ...
                <div class="controls">
                    <input type="text" value="<?= $row->reduce_tax ?>" class="form-control" name="reduce_tax" required="required"/>
                </div>
            </div>
