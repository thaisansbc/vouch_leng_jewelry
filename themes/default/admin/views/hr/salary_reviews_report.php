...
<script>
    $(document).ready(function () {
        oTable = $('#RSR').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= admin_url('hr/getSalaryReviewsReport/?v=1' . $v); ?>',
			...
			"aoColumns": [null,null,null,null,null,null,{"mRender" : currencyFormat},{"mRender" : currencyFormat},{"mRender" : currencyFormat},{"mRender" : row_status}],
			"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var old_salary = 0, new_salary = 0, gross_salary = 0;
                for (var i = 0; i < aaData.length; i++) {
                    old_salary += parseFloat(aaData[aiDisplay[i]][6]);
					new_salary += parseFloat(aaData[aiDisplay[i]][7]);
					gross_salary += parseFloat(aaData[aiDisplay[i]][8]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[6].innerHTML = currencyFormat(old_salary);
				nCells[7].innerHTML = currencyFormat(new_salary);
				nCells[8].innerHTML = currencyFormat(gross_salary);
            }
        }).fnSetFilteringDelay().dtFilter([
			{column_number: 0, filter_default_label: "[<?=lang('month');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('salary_reviews_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("hr/salary_reviews_report"); ?>
                    <div class="row">
						<div class="col-md-4">
                ...
                <div class="table-responsive">
                    <table id="RSR" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
							<tr class="active">
								...
								<th><?= lang("group"); ?></th>
								<th><?= lang("old_salary"); ?></th>
								<th><?= lang("new_salary"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('hr/getSalaryReviewsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('hr/getSalaryReviewsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
