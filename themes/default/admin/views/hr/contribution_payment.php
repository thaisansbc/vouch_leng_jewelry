...
<script>
    $(document).ready(function () {
        var oTable = $('#GroupTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getConPayConditions/') ?>',
			...
			,'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				{column_number: 3, filter_default_label: "[<?= lang("reduce_tax") ?>]", filter_type: "text", data: []},
				{column_number: 4, filter_default_label: "[<?= lang("tax_percent") ?>]", filter_type: "text", data: []},
			], "footer");
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('contribution_payment'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <table id="GroupTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
							<tr>
								...
								<th><?= lang("OR_Scheme"); ?>(0.8%)</th>
                                <th><?= lang("HC_Scheme"); ?>(2.6%)</th>
