...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_warning'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("hr/add_warning", $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
							...
							<div class="panel-body" style="padding: 5px;">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php echo form_input('subject', (isset($_POST['subject']) ? $_POST['subject'] : ""), 'class="form-control input-tip" id="subject" required="required"'); ?>
									</div>
								</div>
								...
								<div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('warning_type',$field, (isset($_POST['warning_type']) ? $_POST['warning_type'] : ''), 'class="form-control select" id="warning_type"'); ?>
                                    </div>
                                </div>
							</div>
						</div>
