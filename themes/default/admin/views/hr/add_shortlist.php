<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_shortlist'); ?></h4>
        </div>
        <?=  admin_form_open_multipart("hr/add_shortlist"); ?>
		...
		<div class="modal-body">
			...
			<div class="form-group">
                ...
                <div class="controls">
                    ...
                    echo form_dropdown('position', $position_opt, 0, 'id="position" class="form-control position" required="required"');
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" class="form-control date" name="shortlist_date" required="required"/>
                </div>
            </div>
			<div class="form-group">
                <?php echo lang('interview_date', 'interview_date'); ?>
                <div class="controls">
                    <input type="text" class="form-control date" name="interview_date" required="required"/>
                </div>
            </div>
			<div class="form-group">
