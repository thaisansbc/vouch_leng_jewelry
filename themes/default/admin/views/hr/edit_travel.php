...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_travel'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("hr/edit_travel/".$travel->id, $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('purpose',$travel->purpose,'class="form-control input-tip" id="purpose" required="required"');?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("place", "place"); ?>
                                <?php echo form_input('place', $travel->place,'class="form-control input-tip" id="place"');?>
                            </div>
                        </div>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('travel_mode',$field,$travel->travel_mode, 'class="form-control select"'); 
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("budget", "budget"); ?>
                                <?php echo form_input('budget',$this->bpas->formatDecimal($travel->budget),'class="form-control input-tip" id="budget" required="required"');?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("start_date", "start_date"); ?>
                                <?php echo form_input('start_date',$this->bpas->hrsd($travel->start_date), 'class="form-control input-tip date" id="start_date" required="required"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("end_date", "end_date"); ?>
                                <?php echo form_input('end_date',$this->bpas->hrsd($travel->end_date), 'class="form-control input-tip date" id="end_date" required="required"'); ?>
                            </div>
                        </div>
