<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EmployeeTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getShortlists/'.($biller ? $biller->id : '')); ?>',
			...
			'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                if (aData[5] == 'interview') {
                    action.find('.add_interview').remove();
                }
				return nRow;
			},
            "aoColumns": [{
            ...
            {column_number: 1, filter_default_label: "[<?=lang('candidate');?>]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[<?=lang('interviewer');?>]", filter_type: "text", data: []},
			{column_number: 3, filter_default_label: "[<?=lang('shortlist_date');?>]", filter_type: "text", data: []},
			{column_number: 4, filter_default_label: "[<?=lang('interview_date');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		<h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('shortlist').' ('.($biller ? $biller->name : lang('all_billers')).')'; ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('hr/add_shortlist/'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_shortlist') ?>
                            </a>                           
                        </li>
						<li>
                ...
                <div class="table-responsive">
                    <table id="EmployeeTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:150px;"><?php echo lang('shortlist_date'); ?></th>
							<th style="width:180px;"><?php echo lang('interview_date'); ?></th>
							<th style="width:180px;"><?php echo lang('status'); ?></th>
