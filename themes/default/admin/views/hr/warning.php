...
<script>
    $(document).ready(function () {
        oTable = $('#id_cardData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getWarning/'.($biller ? $biller->id : '')); ?>',
            ...
            {column_number: 2, filter_default_label: "[<?=lang('subject');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
		<h2 class="blue"><i class="fa-fw fa fa-heart-o"></i><?= lang('warning').' ('.($biller ? $biller->name : lang('all_billers')).')' ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('hr/add_warning') ?>"><i class="fa fa-plus-circle"></i> <?= lang('add_warning') ?>
                            </a>
                        </li>
                        <li>
