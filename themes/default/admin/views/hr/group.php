...
<script>
    $(document).ready(function () {
        var oTable = $('#GroupTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getGroups/') ?>',
			...
			,'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				{column_number: 1, filter_default_label: "[<?= lang("department") ?>]", filter_type: "text", data: []},
...
<?php if ($Owner || $GP['bulk_actions']) {
	    echo admin_form_open('hr/group_actions', 'id="action-form"');
	}
?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <!-- <a href="<?php echo admin_url('hr/add_group/'.$parent_id); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_group') ?>
                            </a> -->
                            <a href="<?php echo admin_url('hr/add_group'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_group') ?>
                            </a>                           
                        </li>
						<li>
