...
<script>
    $(document).ready(function () {
        oTable = $('#REM').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('hr/getRetirementReport/?v=1' . $v); ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('retirement_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("hr/retirement_report"); ?>
                    <div class="row">
						<div class="col-sm-3">
