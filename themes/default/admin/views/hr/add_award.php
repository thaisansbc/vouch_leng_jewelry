...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_award'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("hr/add_award", $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
							...
							<div class="panel-body" style="padding: 5px;">
								...
								<div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        echo form_dropdown('award_type',$field, (isset($_POST['award_type']) ? $_POST['award_type'] : ''), 'class="form-control select" id="award_type"'); ?>
                                    </div>
                                </div>
								<div class="col-md-4">
									<div class="form-group">
										<?= lang("gift", "gift"); ?>
										<?php echo form_input('gift', (isset($_POST['gift']) ? $_POST['gift'] : ''), 'class="form-control" id="gift"'); ?>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<?= lang("cash", "cash"); ?>
										<?php echo form_input('cash', (isset($_POST['cash']) ? $_POST['cash'] : ''), 'class="form-control" id="cash"'); ?>
									</div>
								</div>
