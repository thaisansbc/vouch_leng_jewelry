...
<script>
    $(document).ready(function () {
        oTable = $('#RIDC').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= admin_url('hr/getIDCardsReport/?v=1' . $v); ?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                ...
                $.ajax({'dataType': 'json', 'type': 'POST', 'url': sSource, 'data': aoData, 'success': fnCallback});
					...
					nRow.id = aData[9];
					nRow.className = "id_card_link";
					return nRow;
				},
				"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {									
			},
			"aoColumns": [{"mRender": fsd, "sClass":"center"},{"mRender": fsd, "sClass":"center"},null,null,null,null,null,null,null],
        }).fnSetFilteringDelay().dtFilter([
			{column_number: 0, filter_default_label: "[<?=lang('issued_date');?>]", filter_type: "text", data: []},
            {column_number: 1, filter_default_label: "[<?=lang('invalid_date');?>]", filter_type: "text", data: []},
			...
			{column_number: 7, filter_default_label: "[<?=lang('sample_id_card');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('id_cards_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("hr/id_cards_report"); ?>
                    <div class="row">
						<div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table id="RIDC" cellpadding="0" cellspacing="0" border="0"
...
<script type="text/javascript">
    $(document).ready(function () {
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('hr/getIDCardsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('hr/getIDCardsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
