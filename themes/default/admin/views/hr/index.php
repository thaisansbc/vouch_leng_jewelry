<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EmployeeTable').dataTable({
			...
			{column_number: 8, filter_default_label: "[<?=lang('employee_type');?>]", filter_type: "text", data: []},
			{column_number: 9, filter_default_label: "[<?=lang('employed_date');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="EmployeeTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:150px;"><?php echo lang('employed_date'); ?></th>
