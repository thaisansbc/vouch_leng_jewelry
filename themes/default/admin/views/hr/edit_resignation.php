                                	...
                                	<div class="form-group">
				                        ...
				                        <div class="row">
				                            <div class="col-xs-6 col-sm-2">
				                                <input type="radio" class="checkbox type" value="1" name="asset" <?= $id_card->returned_asset=='1' ? 'checked="checked"' : ''; ?> required="required">
				                                <label for="full" class="padding05">
				                                    <?= lang('yes'); ?>
				                                </label>
				                            </div>
				                            <div class="col-xs-6 col-sm-2">
				                                <input type="radio" class="checkbox type" value="0" name="asset" <?= $id_card->returned_asset=='0' ? 'checked="checked"' : ''; ?>>
