    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("hr/add_transfer", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
						<?php if ($Owner || $Admin || $GP['travel-date']) { ?>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    echo form_dropdown('from_department', $depa,(isset($_POST['from_department']) ? $_POST['from_department'] : ''), 'id="from_department" class="form-control" required="required"');
                                    ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    echo form_dropdown('to_department', $depa,(isset($_POST['to_department']) ? $_POST['to_department'] : ''), 'id="to_department" class="form-control" required="required"');
                                    ?>
                                </div>
                            </div>
                        </div>
