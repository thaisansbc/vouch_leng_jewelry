...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($travel) { ?>
			localStorage.setItem('dflsdate', '<?= $this->bpas->hrld($travel->date); ?>');
			localStorage.setItem('dflsbiller', '<?= $travel->biller_id; ?>');
			localStorage.setItem('dflsitems', JSON.stringify(<?= $travel_items; ?>));
        <?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_training'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("hr/edit_training/".$travel->id, $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['hr-date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "dflsdate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->bpas->hrld($travel->date)), 'class="form-control input-tip datetime" id="dflsdate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
						...
						<?php if ($Owner || $Admin || !$this->session->userdata('biller_id')) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $travel->biller_id), 'id="dflsbiller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php } else {
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('trainer_option', $t_op, $travel->training_option, 'id="trainer_option" data-placeholder="' . lang("select"). '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('training_type',$field, $travel->training_type, 'class="form-control select" id="training_type"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('trainer', $bl, $travel->traininer, 'id="trainer" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('start_date',$this->bpas->hrld($travel->start_date), 'class="form-control input-tip date" id="start_date" required="required"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("end_date", "end_date"); ?>
                                <?php echo form_input('end_date',$this->bpas->hrld($travel->end_date), 'class="form-control input-tip date" id="end_date" required="required"'); ?>
                            </div>
                        </div>
						...
						<div class="col-md-8">
							<div class="form-group">
								<?= lang("note", "dflsnote"); ?>
								<?php echo form_textarea('note',$this->bpas->decode_html($travel->note), 'class="form-control" id="dflsnote" style="margin-top: 10px; height: 100px;"'); ?>
							</div>
						</div>
						<div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="fprom-group"><?php echo form_submit('edit_travel', lang("submit"), 'id="edit_travel" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
