...
<script>
    $(document).ready(function () {
		oTable = $('#MlRData').dataTable({
			...
			'sAjaxSource': '<?= admin_url('attendances/getMonthlyAttedance/?v=1' . $v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('montly_attendance_report'); ?> </h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="introtext"><?= lang('montly_attendance_report'); ?></p>

                <div id="form">

                    <?php echo admin_form_open("attendances/montly_attendance_report"); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('attendances/getMonthlyAttedance/pdf/?v=1'.$v)?>";
            return false;
        });
		
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('attendances/getMonthlyAttedance/0/xls/?v=1'.$v)?>";
            return false;
        });
