...
<script>
    $(document).ready(function () {
        oTable = $('#RSLD').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('attendances/getDayOffReport/?v=1' . $v); ?>',
			...
			"aoColumns": [null,null,null,null,null,{"mRender": fld},{"mRender":decode_html}],
			...
			{column_number: 5, filter_default_label: "[<?=lang('day_off');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('day_off_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("attendances/day_off_report"); ?>
                    <div class="row">
						<div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=admin_url('attendances/getDayOffReport/xls/?v=1'.$v)?>";
            return false;
        });
