...
<script>
    $(document).ready(function () {
        oTable = $('#RSLD').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('attendances/getOTReport/?v=1' . $v); ?>',
			...
			"aoColumns": [null,null,null,null,null,null,{"mRender": fld},null,{"sClass":"text-center"},{"sClass":"text-center"},{"sClass":"text-center"},{"sClass":"text-right"}],
			"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
				var food_fee = 0;
				for (var i = 0; i < aaData.length; i++) {
					 food_fee += parseFloat(aaData[aiDisplay[i]][11]);
				}
				var nCells = nRow.getElementsByTagName('th');
				nCells[11].innerHTML = currencyFormat(parseFloat(food_fee));
			}
			...
			{column_number: 7, filter_default_label: "[<?=lang('ot_policy');?>]", filter_type: "text", data: []},
			{column_number: 8, filter_default_label: "[<?=lang('ot_time');?>]", filter_type: "text", data: []},
			{column_number: 9, filter_default_label: "[<?=lang('check_time');?>]", filter_type: "text", data: []},
			{column_number: 10, filter_default_label: "[<?=lang('ot');?>]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('ot_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("attendances/ot_report"); ?>
                    <div class="row">
						<div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=admin_url('attendances/getOTReport/xls/?v=1'.$v)?>";
            return false;
        });
