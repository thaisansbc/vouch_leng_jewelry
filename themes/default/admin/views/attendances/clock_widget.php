    ...
    <div class="panel-body bblue" >
        ...
        <div class="widget-details">
            ...
            if (isset($clock_status->id)) {
                ...
                $in_time = ($clock_status->in_time);
                $in_datetime = ($clock_status->in_time); 
                echo "<div class='mb15' title=' $in_datetime '>" . lang('clock_started_at') . " : $in_time </div>";
                // echo anchor('admin/attendances/note_modal_form', "<i class='fa fa-sign-out'></i> " . lang('clock_out'),
                // 'id=>"timecard-clock-out" data-toggle="modal" data-backdrop="static" data-target="#myModal" data-post-id => "'.$clock_status->id.'" data-post-clock_out=>1');

                echo anchor('admin/attendances/note_modal_form', '<i class="fa fa-archive"></i> ' . lang('clock_out'), 'data-post-id='.$clock_status->id.' id="timecard-clock-out" data-post-clock_out=1 data-toggle="modal" data-backdrop="static" data-target="#myModal"');
                ...
                echo anchor('admin/attendances/log_time', "<i class='fa fa-sign-in'></i> " . lang('clock_in'), array("class" => "btn btn-default no-border", "title" => lang('clock_in'), "data-inline-loader" => "1", "data-closest-target" => "#js-clock-in-out"));
