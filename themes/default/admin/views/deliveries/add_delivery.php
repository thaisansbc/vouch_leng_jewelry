            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        $av = (
                            ...
                            : (empty($address)
                                ...
                                : ($address->line1 . '<br>' . $address->line2 . '<br>' . $address->city . ' ' . $address->city . '<br>' . $address->postal_code . ' ' . $address->country)
                                )
                            );
                ...
                <div class="col-md-6">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <?= form_dropdown('delivered_by', $opt, '', 'class="form-control" id="delivered_by" required="required" style="width:100%;"'); ?>
                    </div> -->
                    <div class="form-group">
                        <?= lang('delivered_by', 'delivered_by'); ?>
                        <select name="delivered_by" id="delivered_by" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <?= form_dropdown('collection_status', $collection_status, '', 'class="form-control" id="collection_status" required="required" style="width:100%;"'); ?>
                    </div>
                    <div class="form-group hide">
                        <?= lang('collection_amount', 'collection_amount'); ?>
                        <?= form_input('collection_amount', (isset($_POST['collection_amount']) ? $_POST['collection_amount'] :  $inv->grand_total), 'class="form-control" id="collection_amount"'); ?>
                    </div>
                    <div class="form-group">
