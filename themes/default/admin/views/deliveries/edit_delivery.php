        ...
        <div class="modal-body">
            ...
            ?>
                <div class="form-group">
                    <?= lang('date', 'date'); ?>
                    <?= form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->bpas->hrld($delivery->date)), 'class="form-control datetime" id="date" required="required"'); ?>
                </div>
            <?php
        } ?>
            <div class="form-group">
            ...
            <!-- <div class="form-group"> 
                ...
                <?= form_input('delivered_by', (isset($_POST['delivered_by']) ? $_POST['delivered_by'] : $get_driver->delivered_by), 'class="form-control" id="delivered_by"'); ?>
            </div> -->
            ...
            <!-- <div class="form-group">
                ...
                ?>
                <?= form_dropdown('delivered_by', $opt, '',(isset($_POST['delivered_by']) ? $_POST['delivered_by'] : $get_driver->delivered_by), 'class="form-control" id="delivered_by" required="required" style="width:100%;"'); ?>
            </div> -->
            <div class="form-group">
                <?= lang('delivered_by', 'delivered_by'); ?>
                <select name="delivered_by" id="delivered_by" class="form-control">
                    ...
                    <?php foreach ($drivers as $driver) { ?>
                        ...
                        <?php if($get_driver->delivered_by==$driver->id){ echo "selected"; } ?>><?php echo $driver->name; ?></option>
                    <?php } ?>
            ...
            <div class="form-group">
                <?= lang('delivery_money_collection', 'status'); ?>
                <?php
                $collection_status = ['0' => lang('no'), '1' => lang('yes')];
                ?>
                <?= form_dropdown('collection_status', $collection_status, (isset($_POST['collection_status']) ? $_POST['collection_status'] : $delivery->money_collection), 'class="form-control" id="collection_status" required="required" style="width:100%;"'); ?>
            </div>
            <div class="form-group hide">
                <?= lang('collection_amount', 'collection_amount'); ?>
                <?= form_input('collection_amount', (isset($_POST['collection_amount']) ? $_POST['collection_amount'] : $delivery->collection_amount), 'class="form-control" id="collection_amount"'); ?>
            </div>
...
<script type="text/javascript" charset="UTF-8">
    ...
    $(document).ready(function () {
        $('select[name="delivered_by"]').select2(); 
    });
</script>
