...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sales/add_m_payment_loan/" . $loan->id, $attrib); ?>
			...
			<div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
					...
					if (!empty($combine_loan)) {
						...
						//$this->bpas->print_arrays($combine_loan);
						
                        foreach ($combine_loan as $combine_loans) { ?>
                            <tr class="row<?= $combine_loans->id ?>">
                                <td><?= $this->bpas->hrld($combine_loans->dateline); ?></td>
                                <td><?= $combine_loans->reference_no; ?></td>                           
								<td class="balance" val='<?=$combine_loans->payment?>'><?= $this->bpas->formatDecimal(($combine_loans->payment-$combine_loans->paid_amount)); ?></td>
								...
								<td class="col-xs-3">
                                    ...
                                    <input type="text"   name="amount_paid_line[]" class="amount_paid_line form-control" value="<?= $this->bpas->formatDecimal(($combine_loans->payment-$combine_loans->paid_amount)); ?>">
                                </td>
                    ...
                    <tfoot>
                        <tr>
							...
							<td><strong id="total_discount"><?= $this->bpas->formatDecimal(0); ?></strong></td>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="interest-paid" type="text" id="interest"
                                               value="<?= $this->bpas->formatDecimal($total_interest); ?>"
                                               class="pa form-control kb-pad interest" required="required" readonly />
										<input name="interest" type="hidden" value="<?= $this->bpas->formatDecimal($total_interest); ?>" />	   
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="principle"
                                               value="<?= $this->bpas->formatDecimal($total_prin); ?>"
                                               class="pa form-control kb-pad amount" required="required" readonly />
										<input name="principle_amt" id="principle_amt" type="hidden" value="<?=$this->bpas->formatDecimal($total_prin)?>">
