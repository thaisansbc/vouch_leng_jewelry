			...
			<td colspan="2" width="35%" style="virticle-align:middle;">
				<?php if ($logo) { ?>
					<div class="text-center" style="margin-bottom:20px;">
						<img class="img_logo" src="<?= admin_url() . 'assets/uploads/logos/' . $biller->logo; ?>"
			...
			<td colspan="5" width="65%" align="center" style="padding-top:5px;">
				<table width="100%">
					...
					<tr>
						...
						<td width="15%" rowspan="2" style="padding-left:0px; font-size:14px;">: <?= $this->bpas->hrld($inv->date); ?> </td>
					</tr>
					<tr>
					...
					<table class="table print-table order-table">
						...
						?>
							<tr>
								...
								<td style="text-align:right; width:100px;vertical-align:middle;"><?= $row->subtotal!=0?$this->bpas->formatMoney($row->unit_price):$free; ?></td>
								<?php
						...
						<?php //if ($Settings->tax2 && $inv->order_tax != 0) {
							echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px; font-weight:bold;">' . lang("អាករលើតម្លៃបន្ថែម ១០% <br/> VAT(".number_format(10)."%)") . '</td><td style="text-align:right; padding-right:10px; font-weight:bold; padding-top:20px;">' . $this->bpas->formatMoney(($inv->grand_total)*0.1) . '</td></tr>';
						//}
						?>
						...
						<tr>
							...
							<td style="text-align:right; font-weight:bold; padding-top:20px;"><?= $this->bpas->formatMoney(($inv->grand_total) + ($inv->grand_total)*0.1); ?></td>
						</tr>
