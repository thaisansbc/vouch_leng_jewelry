...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('sales/getHouseSale' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
...
<?php if ($Owner) {
	   echo admin_form_open('sales/listSaleRoom_actions', 'id="action-form"');
	}
?>
            ...
            <ul class="btn-tasks">
                ...
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=admin_url('sales/suspend')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                            	foreach ($warehouses as $warehouse) {
                            	        echo '<li><a href="' . admin_url('sales/suspend/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            	    }
                                ?>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo admin_form_open("sales/suspend"); ?>
                    <div class="row">
                        <div class="col-sm-4">
