                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?= base_url(); ?>assets/csv/sample_sale_products.csv" class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File</a>
                                <span class="text-warning"><?php echo $this->lang->line('csv1'); ?></span><br>
                                <?php echo $this->lang->line('csv2'); ?> <span class="text-info">( <?= lang('product_code') . ', ' . lang('net_unit_price') . ', ' . lang('quantity') . ', ' . lang('product_variant') . ', ' . lang('tax_rate_name') . ', ' . lang('discount') . ', ' . lang('serial_no'); ?> )</span> <?php echo $this->lang->line('csv3'); ?><br>
