...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sale_property/edit_payment_commission/" . $payment->id, $attrib); ?>
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-sm-4">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input readonly="readonly" name="amount-paid"
                                               value="<?= $this->bpas->formatDecimal($payment->amount); ?>" type="text"
                            ...
                            <div class="col-sm-4">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input readonly="readonly" name="amount-paid_khm" type="text" id="amount_2"
                                               value="0"
                            ...
                            <div class="col-sm-4">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input readonly="readonly" name="amount-paid_bat" type="text" id="amount_3"
                                               value="0"
                                               class="pa form-control kb-pad amount"/>
                                    </div>
                                </div>
						...
						<div class="row">
                             ...
                             <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang("stl", "stl"); ?>
                                    <input name="amount-stl" type="text" id="stl" value="" class="pa form-control kb-pad amount" required="required"/>
                                </div>
                            </div>
                             <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang("sa", "sa"); ?>
                                    <input name="amount-sa" type="text" id="sa" value="" class="pa form-control kb-pad amount" required="required"/>
                                </div>
                            </div>
                        </div>
                    </div>
