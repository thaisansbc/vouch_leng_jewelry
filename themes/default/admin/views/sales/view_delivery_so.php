...
<?php
	//$this->bpas->print_arrays($delivery);
?>
    ...
    <div class="modal-content">
        <div class="modal-body">
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td width="24%"><?php echo $this->bpas->hrld($delivery->date); ?></td>
                ...
                <table class="table table-hover table-striped" style="font-size:15px;">
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
							...
							<?php } ?>
                            <td style="width: 70px; text-align:center; vertical-align:middle;"><?php echo $this->bpas->formatQuantity($row->quantity_received); ?></td>
            ...
            <div class="btn-group btn-group-justified" id="noprint">
                <!-- <div class="btn-group">
                    <a href="<?= admin_url('sales/add/' . $delivery->id) ?>" class="tip btn btn-primary" title="<?= lang('create_sale') ?>">
                ...
                <div class="btn-group">
                    <a href="<?= admin_url('sale_order/delivery_invoice/' . $delivery->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_delivery_invoice') ?>">
                        <i class="fa fa-print"></i>
                        <span class="hidden-sm hidden-xs"><?= lang('print_delivery_invoice') ?></span>
                    </a>
                </div>
                <div class="btn-group">
                    <a href="<?= admin_url('sale_order/delivery_note/' . $delivery->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_delivery_invoice') ?>">
                        <i class="fa fa-print"></i>
                        <span class="hidden-sm hidden-xs"><?= lang('delivery_note') ?></span>
                    </a>
                </div>
                <div class="btn-group">
                    <a href="<?= admin_url('quotes/edit/' . $delivery->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
