	...
	<div class='container'>
		<div class="col-lg-12">
			...
			<div class='row col-lg-12 font-kh-bt'​ style="line-height:20px;">				
				...
				<p>
					ក្នុងតំលៃ$<b>&nbsp;<?= $row->subtotal!=0?$this->bpas->formatMoney($row->subtotal):$free; 
									$total += $row->subtotal;
									?>&nbsp;</b>
					ជាអក្សរ<b>&nbsp;<?php echo $this->bpas->numberToWordsCur($total,$kh='1',$cur="",$cur_h="");?>&nbsp;</b>
					ដុល្លា។	
				</p>
				<p>
				...
				<p style="padding-left:40px;">
					-  លើកទី ១ ចំនួន$<b>&nbsp;<?= (isset($inv->deposit)?$this->bpas->formatDecimal($inv->deposit):0)?>&nbsp;(<?php echo $this->bpas->numberToWordsCur($inv->deposit,$kh='1');?>)</b>
					នៅថ្ងៃទី<b>&nbsp;<?php $d=explode("-",$inv->date); $dt=explode(" ",$d[2]); echo "$dt[0]";?>&nbsp;</b>
					ខែ<b>&nbsp;<?php echo "$d[1]"?>&nbsp;</b>
					ឆ្នាំ​<b>&nbsp;<?php echo "$d[0]"?>&nbsp;</b>
				</p>
				<p style="padding-left:40px;">
					-  លើកទី ២ ចំនួន$<b>&nbsp;<?= $this->bpas->formatDecimal($inv->down_amount); ?>&nbsp;(<?php echo $this->bpas->numberToWordsCur($inv->down_amount,$kh='1');?>)</b>
				...
				<p style="padding-left:40px;">
					-  លើកទី​ ៣ ចំនួន$<b>&nbsp;<?=$this->bpas->formatMoney($no_interest); ?>&nbsp;(<?php echo $this->bpas->numberToWordsCur($no_interest,$kh='1');?>)</b>
					នៅថ្ងៃទី<b>&nbsp;<?php $dd=explode("-",$inv->date); $dt=explode(" ",$dd[2]); echo "$dt[0]";?>&nbsp;</b>
					ខែ<b>&nbsp;<?php echo "$dd[1]"?>&nbsp;</b>
					ឆ្នាំ​<b>&nbsp;<?php echo "$dd[0]"?>&nbsp;</b>
				</p>
				<p style="padding-left:40px;">
					-  លើកទី ៤ ចំនួន$<b>&nbsp;<?=$this->bpas->formatMoney($have_interest); ?>&nbsp;(<?php echo $this->bpas->numberToWordsCur($have_interest,$kh='1');?>)</b>
