...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('products/edit_payment/' . $payment->id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo $payment->reward_exchange_id; ?>" name="reward_id"/>
            </div>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        <?php 
                                            ...
                                            // }
                                        ?>
                                        <input name="amount-paid" readonly value="<?= $this->bpas->formatDecimal($payment->amount); ?>" type="text" id="amount_1" class="pa form-control kb-pad amount"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                            ...
                            if ($this->Settings->accounting) {
                                ...
                                <div class="col-sm-6">
                                    <label class="checkbox" for="write_off">
                                        <input type="checkbox" name="write_off" value="1" id="write_off" <?= $payment->write_off? 'checked':'';?>/>
                                        <?= lang('write_off') ?>
                                    </label>
                                </div>
                            <?php } ?>
