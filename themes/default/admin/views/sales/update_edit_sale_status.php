...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_sale_request'). " " . $inv->sale_reference_no; ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form'); 
        echo admin_form_open("sales/update_edit_sale_status/". $inv->id, $attrib); ?>
         ...
         <div class="modal-body">
                ...
                <div class="panel-body">
                    <table class="table table-condensed table-striped table-borderless" style="margin-bottom:0;">
                        <tbody>
                            ...
                            <tr>
                                <td><?= lang('noted'); ?></td>
                                <td><?= $this->bpas->decode_html($inv->noted); ?></td>
                            </tr> 
                            <tr>
                                <td><?= lang('attachment'); ?></td>
                                <td><?php if($inv->attachment != null){ ?>
                                        <!-- <img src="<?= 'assets/uploads/' . $inv->attachment; ?> " width="250" height="150" style="background-color: #FDFDFD;" /> -->
            ...
            <div class="form-group">
                <?= lang('status', 'status'); ?>
                <?php
                $opts = ['approved' => lang('approved'), 'rejected' => lang('rejected')]; ?>
