    ...
    <div id="receipt-data">
        <div class="text-center">
			...
			echo '<div class="col-sm-6">';
				...
				echo lang("time_out") . " : " . $this->bpas->hrld($inv->date) . "</p>";
			echo '</div>';
			$total_disc = 0;
			foreach ($rows as $d) {
            ...
            <table class="table table-striped table-condensed receipt">
                ...
                <tr>
					<th></th>
					<th><?= lang("exchange_ratesd"); ?> : <?php echo $exchange_rate_kh_c->rate?number_format($exchange_rate_kh_c->rate):0 ?> ៛ | <?= lang("qty"); ?>= (<?=$this->bpas->formatQuantity($total_quantity)?>)</th>
				...
				if($inv->paid >= $inv->grand_total){
					...
					<?php if((($inv->paid+$amount_kh_to_us) - $inv->grand_total) != 0 && ($this->bpas->formatMoney((($inv->paid+$amount_kh_to_us) - $inv->grand_total)*$exchange_rate->rate )) != 0){ ?>
					<tr>
						...
						<?php
							echo $this->bpas->formatMoney(($inv->paid+$amount_kh_to_us) - $inv->grand_total);
							$total_us_b = $this->bpas->formatMoney(($inv->paid+$amount_kh_to_us) - $inv->grand_total);
				...
				<!--	<tr>
                        ...
                        <th style="border-top:2px dotted #ddd" class="text-right"><?= $this->bpas->formatMoney((($inv->paid+$amount_kh_to_us) - $inv->grand_total)*$exchange_rate_th->rate ); ?></th>
                    </tr> -->
					<?php
					}
				}
