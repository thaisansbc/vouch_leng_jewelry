...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
			...
			'sAjaxSource': '<?= admin_url('sales/getSales_DuePayment/?v=1' .$v) ?>',
...
<?php
	echo admin_form_open('sales/customer_balance_actions/'.$user_id, 'id="action-form"');
?>
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
				<?php echo admin_form_open("sales/view_customer_balance/" . $user_id); ?>
                    <div class="row">
                        <div class="col-sm-4">
		...
		*/
		...
		$('body').on('click', '#combine_pay', function() {
			 if($('.checkbox').is(":checked") === false){
                ...
                $('#myModal').modal({remote: '<?=admin_url('sales/combine_payment_customer');?>?data=' + arrItems + '&idd='+ idd +''});
                $('#myModal').modal('show');
        });
	});
</script>