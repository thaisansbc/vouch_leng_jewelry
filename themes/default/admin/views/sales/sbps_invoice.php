...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12" style="margin-top:10px">
			...
			<div class="col-xs-6">
				...
				<p>កាលបរិច្ឆេទ <?=lang('date')?> <?= $this->bpas->hrld($inv->date); ?></p>
				<p>លេខបញ្ឆាទិញ ៖  PO Number : </p>
				<p>គិតទៅ៖ &nbsp;&nbsp;&nbsp;&nbsp; Bill TO: </p>
	...
	<div class="row">
		<div class="col-xs-12" style="margin-top:10px">
			<table id="SLData" class="table table-hover table-striped" style="width: 100%;">
				...
				foreach ($rows as $row):
					...
					<tr>
						...
						<td style="text-align:center; width:90px;vertical-align:middle;">$<?= $this->bpas->formatMoney($row->real_unit_price); ?></td>
						<td style="text-align:right; vertical-align:middle; width:110px;">$<?= $this->bpas->formatMoney($row->subtotal); ?></td>
					</tr>
					<?php
					$r++;
				endforeach;
				...
				<?php if ($inv->order_discount != 0) {
					echo '<tr class="tr"><td colspan="' . $col . '" style="text-align:right;">បញ្ចុះតម្លៃ ' . lang("discount") . '</td><td style="text-align:right;">' . $this->bpas->formatMoney($inv->order_discount) . '</td></tr>';
				}
				?>
				<?php if ($inv->shipping != 0) {
					echo '<tr class="tr"><td colspan="' . $col . '" style="text-align:right;">ដឹកជញ្ចូន ' . lang("Delivery Charge") . '</td><td style="text-align:right;">' . abs($this->bpas->formatMoney($inv->shipping)) . '</td></tr>';
				}
				?>
				<?php if ($Settings->tax2 && $inv->order_tax != 0) {
					echo '<tr class="tr"><td colspan="' . $col . '" style="text-align:right;">ពន្ឌអាករ ' . lang("VAT") . '</td><td style="text-align:right;">' . $this->bpas->formatMoney($inv->order_tax) . '</td></tr>';
				}
				?>
				<tr class="tr">
					<td colspan="<?= $col; ?>"
