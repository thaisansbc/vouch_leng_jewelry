...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("rental/add_deposit/" . $sale->id, $attrib);
		?>
        <div class="modal-body">
            ...
            <div class="row">
               ...
               <?php if ($Owner || $Admin || $GP['sales-date']) { ?>
                ...
                <input type="hidden" value="<?php echo $sale->id; ?>" name="sale_id"/>
            </div>
                        ...
                        <div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
	                                ...
	                                echo form_dropdown('deposit_account', $bank,$this->accounting_setting->default_sale_deposit, 'class="form-control"');
	                                ?>
	                            </div>
							</div>
							<?php }?>
