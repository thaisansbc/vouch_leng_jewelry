            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td width="70%"><?php echo $this->bpas->hrld(isset($delivery->date)); ?></td>
                    </tr>
                    <tr>
                    ...
                    <?php if (isset($delivery->note)) { ?>
                        <tr>
                            ...
                            <td><?php echo $this->bpas->decode_html(isset($delivery->note)); ?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="vertical-align:middle;"><?php echo isset($row->product_name) . " (" . $row->product_code . ")";
                                ...
                                ?></td>
							<td style="width: 70px; text-align:center; vertical-align:middle;"><?php echo $this->bpas->formatQuantity($row->price); ?></td>
