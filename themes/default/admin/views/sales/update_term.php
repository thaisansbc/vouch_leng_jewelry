...
<div class="modal-dialog" style="width:70%;">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sales/changeLoanTerm/". $sale_id, $attrib); ?>
						...
						<div class="col-md-0">
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input name="total_loan_amount" type="text" id="total_loan_amount" value="<?= $this->bpas->formatDecimal($loaned_amt->loan_amount); ?>" style="pointer-events:none"
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input name="total_paid" type="text" id="total_paid" value="<?= (isset($loaned_amt->paid_amount)?$this->bpas->formatDecimal($loaned_amt->paid_amount):0)?>" style="pointer-events:none"
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									...
									<input name="loan_balance" type="text" id="balance"
										   class="form-control balance" required="required" value="<?=$this->bpas->formatDecimal($loaned_amt->loan_amount-$loaned_amt->paid_amount);?>"
