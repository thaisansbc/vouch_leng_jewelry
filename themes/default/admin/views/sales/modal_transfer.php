<div class="modal-dialog">
    ...
    <div class="modal-content">
		...
		<?php
            ...
            echo admin_form_open_multipart("sales/trasfer_submit/".$id, $attrib);
		?>
					...
					<div class="form-group">
						...
						<?php if ($Owner || $Admin || $GP['customers-add']) { ?><div class="input-group"><?php } ?>
							...
							<div class="input-group-addon no-print" style="padding: 2px 5px;">
								<a href="<?= admin_url('customers/add'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal2"><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a>
							</div>
						</div>
						<?php } ?>
					</div>
								...
								<div class="col-sm-12">
									<div class="payment">
										<div class="form-group">
											...
											<input name="amount-paid" type="text" id="amount_1" amount="<?= $this->bpas->formatDecimal($inv->grand_total - $inv->paid); ?>"
												   value="<?= $this->bpas->formatDecimal($inv->grand_total - $inv->paid); ?>"
