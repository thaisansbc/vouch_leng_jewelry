		...
		<div class="col-xs-12" style="width: 559px;margin-left: -3% !important;" class="con1">
			<div class="row" style="margin-top: 20px !important;">
				...
				<?php if(!empty($biller->logo)) { ?>
					<img src="<?= admin_url() ?>assets/uploads/logos/<?= $biller->logo; ?>" style="width: 135px !important; margin-left: 25px;" id="logo"/>
				<?php } ?>
				</div>
			...
			<div class="row">
				<div class="col-sm-12 col-xs-12">
					<table class="table" style="margin-top: 10px;width: 100%;margin-left:-1px;">
						<tbody style="font-size: 9px;">
							...
							?>
								<tr>
									...
									<?php if ($row->item_tax) {?>
										<td style="vertical-align: middle; text-align: center">
										$<?=$this->bpas->formatMoney($row->item_tax);?></td>
									<?php } ?>
							...
							<tr>
								...
								<td align="right">$<?php echo $this->bpas->formatMoney($invs->paid-$invs->deposit); ?></td>
							</tr>
							<?php } ?>
							<tr>
								...
								<td align="right">$<?= $this->bpas->formatMoney($invs->grand_total - (($invs->paid-$invs->deposit) + $invs->deposit)); ?></td>
							</tr>
						<?php } ?>
