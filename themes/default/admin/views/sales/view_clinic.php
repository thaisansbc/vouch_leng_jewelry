                            ...
                            <td style="width: 60%;">
                                <div>
                                    <div style="text-align: center;">
                                        ...
                                        <hr style="width:40%; height:5px;border-top: none; border-bottom: 1px solid black; display: block; margin-left: 30%;">
                                        <h2 style="line-height: normal; margin-top: -18px;">
                                            ...
                                            <span style="font-family:'Khmer OS Muol Light';">វិក្កយបត្រ </span>/ INVOICE
                                        </h2>
                                    </div>
                                </div>            
                            </td>
                ...
                <div class="table-responsive">
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 20%;">
                                <div>
                                    <span style="width: 20px;height: 20px;border:1px solid #cccccc;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <label for="ch1">អាឡែកស៊ីថ្នាំ</label>
                                </div>
                            </td>
                            <td style="width: 20%;">
                                <div>
                                    <span style="width: 20px;height: 20px;border:1px solid #cccccc;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <label for="ch2">ជម្ងឺបេះដូង</label>
                                </div>
                            </td>
                            <td style="width: 20%;">
                                <div>
                                    <span style="width: 20px;height: 20px;border:1px solid #cccccc;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <label for="ch3">មានផ្ទៃពោះ</label>
                                </div>
                            </td>
                            <td style="width: 20%;">
                                <div>
                                    <span style="width: 20px;height: 20px;border:1px solid #cccccc;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <label for="ch4">ទឹកនោមផ្អែម</label>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <span style="width: 20px;height: 20px;border:1px solid #cccccc;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <label for="ch5">លើសឈាម</label>
                                </div>
                            </td>
                        </tr>
                    </table>
