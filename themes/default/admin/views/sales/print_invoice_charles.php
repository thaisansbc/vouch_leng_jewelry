	...
	<div class="container">
		...
		<div class="row">
				...
				<div class="col-lg-4 col-ms-4 col-xs-4" style="border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 1px solid #000000;height:130px;width:42%;margin-left:7px;padding-top:25px;">
					<table id="tb3">
						...
						<tr>
							<td>Date</td>
							<td>: <?=$this->bpas->hrsd($sale_order->date);?></td>
						</tr>
						<tr>
							<td>Ref DO No</td>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($row->unit_price);?></div>
							</td>
							<?php if($inv->product_discount != 0){ ?>
							<td>
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($inv->product_discount);?></div>
							</td>
							<?php }?>
							<?php if($inv->product_tax != 0){ ?>
							<td>
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($inv->product_tax);?></div>
							</td>
							<?php }?>
							<td>
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($qty*$row->unit_price);?></div>
							</td>
						</tr>
						<?php 
					...
					<tfoot>
						<tr>
							...
							<td style="text-align: right; vertical-align: top">
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($sub_total);?></div>
							</td>
						</tr>
						...
						<tr>
							...
							<td style="text-align: right; vertical-align: top">
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($inv->order_discount);?></div>
							</td>
						</tr>
						<?php }?>
						...
						<tr>
							...
							<td style="text-align: right; vertical-align: top">
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($inv->order_tax);?></div>
							</td>
						</tr>
						<?php }?>
						...
						<tr>
							...
							<td style="text-align: right; vertical-align: top">
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney($inv->shipping);?></div>
							</td>
						</tr>
						<?php }?>
						<tr>
							<td colspan="2" style="text-align: center; vertical-align: top"><?=$this->bpas->decode_html(strip_tags($deposit->note));?></td>
							<td></td>
							<td></td>
							<td></td>
							<?php if($inv->product_discount != 0){ ?>
							...
							<td style="text-align: right; vertical-align: top">
								<div class="col-xs-1" style="text-align: left; vertical-align: top;">$</div>
								<div style="text-align: right; vertical-align: top"><?=$this->bpas->formatMoney(($inv->paid - $discount) - abs($deposit->amount));?></div>
							</td>
						</tr>
						<tr>
		...
		<div class="row" style="margin-left:5px;">
			<div id='footer' class="col-lg-10 col-lg-offset-1">
				<p><b>Total Amount in word:  <?=$this->bpas->numberToWordsCur(($inv->paid - $discount) - abs($deposit->amount),"");?></b></p>
