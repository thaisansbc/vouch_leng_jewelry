            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-7 text-right">
                        ...
                        <img src="<?= admin_url() ?>assets/uploads/barcode<?= $this->session->userdata('user_id') ?>.png" alt="<?= $inv->reference_no ?>"/>
                        <?php $this->bpas->qrcode('link', urlencode(admin_url('sales/view/' . $inv->id)), 2); ?>
                        <img src="<?= admin_url() ?>assets/uploads/qrcode<?= $this->session->userdata('user_id') ?>.png" alt="<?= $inv->reference_no ?>"/>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped print-table order-table">
                    ...
                    <?php if ($return_sale && $return_sale->surcharge != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("return_surcharge") . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;">' . $this->bpas->formatMoney($return_sale->surcharge) . '</td></tr>';
                    }
                    ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= $this->bpas->formatMoney($detail->total); ?></td>
                    </tr>                    
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('pos/index/' . $detail->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
                                <i class="fa fa-edit"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('edit') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a hrefs="<?= admin_url('pos/delete_suspend/' . $detail->id) ?>" class="tip btn btn-danger clear_suspend" title="<b><?= $this->lang->line("delete_sale") ?></b>"
