<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sales/add_salesman_clear/" . $inv->id, $attrib); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1" amount="<?= $this->bpas->formatDecimal((($inv->grand_total - $inv->paid) - $return->returned) + $return->refunded); ?>"
                                               value="<?= $this->bpas->formatDecimal((($inv->grand_total - $inv->paid) - $return->returned) + $return->refunded); ?>"
