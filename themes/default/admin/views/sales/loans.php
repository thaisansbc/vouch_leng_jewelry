...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('sales/getLoans' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
...
<?php if ($Owner) {
	    echo admin_form_open('sales/loan_actions', 'id="action-form"');
	}
?>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo admin_form_open("sales/sales_loans"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script>
	$(document).ready(function(){
		...
		$("#excel").click(function(e){
			e.preventDefault();
			window.location.href = "<?=admin_url('Sales/getLoansAll/0/xls/')?>";
			return false;
		});
		$('#pdf').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('Sales/getLoansAll/pdf/?v=1'.$v)?>";
            return false;
        });
		*/
	});
