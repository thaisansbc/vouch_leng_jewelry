 		...
 		<div class="row">
 			<div class="col-md-12 col-xs-12">
 				<div class="col-md-4 col-xs-4">
 					<?php if($biller->logo){?>
						<img src="<?= admin_url() . 'assets/uploads/logos/' . $biller->logo; ?>" alt="<?= $biller->company; ?>" style="width: 87%;">
 		...
 		<div class="row">
 			...
 			<table style="font-size: 13px;">
 				<tr>
 					...
 					<td style="border:1px solid #CCC; width: 206; vertical-align: middle; font-size: 10px;">
 						<?= lang("ប្រាក់ដុល្លារ");?> / USD &nbsp; <?=$this->bpas->formatMoney($payment->amount);?>
 					</td>
 				</tr>
 				<tr>
 					<td>
 					...
 					<td style="border:1px solid #CCC; width: 206; vertical-align: middle; font-size: 10px;">
 						<?= lang("ប្រាក់រៀល");?> / RIEL &nbsp; <?=$this->bpas->formatMoney($payment->amount* $exchange_rate_kh_c->rate);?>
 					</td>
 				</tr>
 			</table>
 			<br>
 			<table class="table" style="font-size: 13px;">
 				<tr>
 					...
 					<td style="text-align: left;"><?=$this->bpas->convert_number_to_words($payment->amount);?>
 					</td>
 				</tr>
 				<tr>
 					<td style="text-align: left;"><?=$this->bpas->convert_number_to_words($payment->amount* $exchange_rate_kh_c->rate);?></td>
 				</tr>
 			</table>
 			<table class="table" style="font-size: 13px;">
 				<thead>
