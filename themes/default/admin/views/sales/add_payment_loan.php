...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sales/add_payment_loan/" . $loan->id, $attrib); ?>
					...
					if (!empty($combine_loan)) {
                        ...
                        foreach ($combine_loan as $combine_loans) { ?>
                            <tr class="row<?= $combine_loans->id ?>">
								...
								<td class="balance" val='<?=$combine_loans->payment?>'><?= $this->bpas->formatDecimal($combine_loans->payment); ?></td>
								...
								<td class="col-xs-3">
                                    ...
                                    <input type="text"   name="amount_paid_line[]" class="amount_paid_line form-control" value="<?= $this->bpas->formatDecimal($combine_loans->payment); ?>">
                                </td>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="interest-paid" type="text" id="interest"
                                               value="<?= $this->bpas->formatDecimal($interest); ?>"
                                               class="pa form-control kb-pad interest" required="required" readonly />
										<input name="interest" type="hidden" value="<?= $this->bpas->formatDecimal($interest); ?>" />	   
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="principle"
                                               value="<?= $this->bpas->formatDecimal($total_payment); ?>"
                                               class="pa form-control kb-pad amount" required="required" readonly />
										<input name="principle_amt" id="principle_amt" type="hidden" value="<?=$this->bpas->formatDecimal($total_payment)?>">
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="total_payment" type="text" id="total_payment"
                                               value="<?= $this->bpas->formatDecimal(($interest+$total_payment)-($loan_data->paid_amount+$loan_data->discount)); ?>"
