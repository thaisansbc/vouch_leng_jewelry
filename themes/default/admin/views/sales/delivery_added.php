    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("sales/add_new_delivery/", $attrib)
                ?>
											...
											<?php
												...
												foreach($delivery_items as $delivery){
													...
													echo   '<input type="hidden" value="'.$delivery['id'].'" name="delivery_id[]" id="delivery_id" style="width: 150px; height: 30px;text-align:center;">
															...
															<td id="quantity" style="text-align:center;">'.$this->bpas->formatDecimal($qty).'</td>
															...
															<input type="hidden" value="'.($unit_qty!=""?$this->bpas->formatDecimal($delivery['quantity_received']*$unit_qty->qty_unit):$this->bpas->formatDecimal($delivery['quantity_received'])).'" name="rquantity[]" id="rquantity">
															<input type="hidden" value="'.$this->bpas->formatDecimal($real_qty).'" name="real_qty" id="real_qty">
															<td>
																<input type="text" class="piece" value ="'.$this->bpas->formatDecimal($delivery['piece'] - ($delivery['quantity_received']/$delivery['wpiece'])).'"name="piece[]" style="width: 150px; height: 30px;text-align:center;">
																<input type="hidden" class="cur_piece" value ="'.$this->bpas->formatDecimal($delivery['piece'] - ($delivery['quantity_received']/$delivery['wpiece'])).'"name="cur_piece[]" style="width: 150px; height: 30px;text-align:center;">
															</td>
															<td>
																<input type="text" class="wpiece" value ="'.$this->bpas->formatDecimal($delivery['wpiece']).'"name="wpiece[]" style="width: 150px; height: 30px;text-align:center; pointer-events: none;">
															</td>
															<td>
																<input type="text" class="quantity_received" value ="'.$this->bpas->formatDecimal($bqty).'"name="quantity_received[]" id="quantity_received" style="width: 150px; height: 30px;text-align:center;">
																<input type="hidden" class="cur_quantity_received" value ="'.$this->bpas->formatDecimal($bqty).'"name="cur_quantity_received[]" id="cur_quantity_received" style="width: 150px; height: 30px;text-align:center;">
															</td>
