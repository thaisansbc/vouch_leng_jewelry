		...
		<div class="col-lg-12">
			...
			<div class='row col-lg-12 font-kh-bt'​ style="line-height:20px;">				
				...
				<p style="padding-left:40px;">
					...
					ទៅអោយភាគី​ "ខ" ក្នុងតំលៃសរុបចំនួន<b>&nbsp;<?= $row->subtotal!=0?$this->bpas->formatMoney($row->subtotal):$free; 
									$total += $row->subtotal;
									?>(<?php echo $this->bpas->numberToWordsCur($total,$kh='1');?>)&nbsp;</b>។
				</p>
				<?php
					$r++;
						endforeach;
                                ...
                                foreach($loan as $pt){
									//$this->bpas->print_arrays($pt);
										...
										if($status==0){
											if($pt->interest > 0)
											{  
												$dates=$this->bpas->hrsd($pt->dateline);
												$status=1;
											} 
				...
				<p style="padding-left:40px;">
					-  លើកទី ១ ចំនួន$<b>&nbsp;<?= $this->bpas->formatMoney($total1=$inv->deposit+$inv->down_amount+$no_interest);?>&nbsp;(&nbsp;<?php echo $this->bpas->numberToWordsCur($total1,$kh='1');?>&nbsp;)</b>
					នៅថ្ងៃទី<b><?php echo $this->bpas->hrsd($inv->date)?></b>
					។
				</p>
				<p style="padding-left:40px;">
					- ប្រាក់នៅសល់ចំនួន$<b>&nbsp;<?=$this->bpas->formatMoney($totalrest=$inv->grand_total - ($inv->deposit+$order_down->down_amount+$order_down->principle_amount)) ?>&nbsp;(&nbsp;<?php echo $this->bpas->numberToWordsCur($totalrest,$kh='1');?>&nbsp;)</b>
				</p>
				<p style="padding-left:40px;">
					...
					ខែ មានចំនួនUS $<b>&nbsp;<?= $this->bpas->formatMoney($have_interest);?>&nbsp;(&nbsp;<?php echo $this->bpas->numberToWordsCur($have_interest,$kh='1');?>&nbsp;)</b>
