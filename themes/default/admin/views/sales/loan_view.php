<script>
    $(document).ready(function (e) {
		...
		var oTable = $('#Loan_List').dataTable({
			...
			'bFilter': false,
            'sAjaxSource': '<?=admin_url('sales/list_loan_data/'.$sale_id)?>',
                ...
                <table class="table table-hover table-striped print-table order-table">
					...
					?>
                        <tr>
                            ...
                            <td style="text-align:right; width:100px;"><?=$this->bpas->formatMoney($item->unit_price)?></td>
                            <td style="text-align:right; width:120px;"><?=$this->bpas->formatQuantity($item->quantity)?></td>
							<td style="text-align:right; width:120px;"><?=$this->bpas->formatMoney(($item->quantity * $item->unit_price))?></td>
                        </tr>
                    <?php
                        $n++;
                    endforeach;
                    ...
                    ?>
						<tr>
							...
							<td style="vertical-alignA:middle; text-align:right; font-weight:bold;"><?=$this->bpas->formatMoney($total_amount)?></td>
						</tr>
						<tr>
							<td colspan="5" style="vertical-align:middle; text-align:right; font-weight:bold;"><?=lang("deposit")?></td>
							<td style="vertical-alignA:middle; text-align:right; font-weight:bold;"><?=$this->bpas->formatMoney($deposit)?></td>
						</tr>
						<tr>
							<td colspan="5" style="vertical-align:middle; text-align:right; font-weight:bold;"><?=lang("down_payment")?></td>
							<td style="vertical-alignA:middle; text-align:right; font-weight:bold;"><?=$this->bpas->formatMoney($down_payment)?></td>
						</tr>
					<?php } ?>
						<tr>
							<td colspan="5" style="vertical-align:middle; text-align:right; font-weight:bold;"><?=lang("loan_amount")?></td>
							<td style="vertical-alignA:middle; text-align:right; font-weight:bold;"><?=$this->bpas->formatMoney($loan_amount)?></td>
						</tr>
						<tr>
							<td colspan="5" style="vertical-align:middle; text-align:right; font-weight:bold;"><?=lang("interest_rate_per_month")?></td>
							<td style="vertical-alignA:middle; text-align:right; font-weight:bold;"><?=$this->bpas->formatMoney(($current_interest->interest))?></td>
						</tr>
                    </tbody>
                    <tfoot>
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
						...
						<!-- Add Payment -->
						<div class="btn-group">
							<a href="#" data-toggle="modal" data-backdrop="static" data-target="#myModal2" class="add_payment_list tip btn btn-primary pay" title="<?= lang('add_payment') ?>">
...
$(document).ready( function() {
	...
	$(".add_payment_list").bind('click',function(){
		...
		if($(".bb .checkbox:checked").length > 0){
			...
			$(this).attr('href', "<?= admin_url('sales/add_payment_loan') ?>/"+total_payment+"/"+id+"/"+paid_amount+"/"+principle+"/"+sale_id);
