...
<script>
    $(document).ready(function () {
        var oTable = $('#DOData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getSales_items').'/'.(isset($start_date)?$start_date:"").'/'.(isset($end_date)?$end_date:"") ?>',
		...
		var oTable = $('#Sale_Order').dataTable({
            ...
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= admin_url('sales/getSaleOrderitems').'/'.(isset($start_date)?$start_date:"").'/'.(isset($end_date)?$end_date: "") ?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                aoData.push({
                    "name": "<?= $this->security->get_csrf_token_name() ?>",
                    "value": "<?= $this->security->get_csrf_hash() ?>"
