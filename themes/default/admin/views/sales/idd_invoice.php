		...
		<div class="col-xs-12" style="width: 794px;">
			...
			<div class="col-sm-3 col-xs-3">
				<?php if(!empty($biller->logo)) { ?>
					<img src="<?= admin_url() ?>assets/uploads/logos/<?= $biller->logo; ?>" style="width: 165px; margin-left: 25px;" />
				<?php } ?>
			</div>
						...
						<tbody style="font-size: 13px;">
							...
							?>
								<tr>
									...
									<td style="vertical-align: middle; text-align: right">$<?= $this->bpas->formatQuantity($row->subtotal);?>
									</td>
								</tr>
							...
							<tr>
								...
								<td align="right" colspan="2">$<?=$this->bpas->formatMoney($invs->total); ?></td>
							</tr>
							<?php } ?>
							...
							<tr>
								...
								<td align="right" colspan="2">$<?php echo $this->bpas->formatQuantity($invs->order_discount); ?></td>
							</tr>
							<?php endif; ?>
							<?php if ($invs->shipping != 0) : ?>
							<tr>
								<td colspan="5" style="text-align: right; font-weight: bold;">ដឹកជញ្ជូន / <?= strtoupper(lang('shipping')) ?></td>
								<td align="right" colspan="2">$<?php echo $this->bpas->formatQuantity($invs->shipping); ?></td>
							</tr>
							<?php endif; ?>
							...
							<tr>
								...
								<td align="right" colspan="2">$<?= $this->bpas->formatQuantity($invs->order_tax); ?></td>
							</tr>
							<?php endif; ?>
							...
							<tr>
								...
								<td align="right" colspan="2" style="font-size: 16px;"><b>$<?= $this->bpas->formatMoney($invs->grand_total); ?></b></td>
							</tr>
							<?php }else{ ?>
							<tr style="background: #C0673D !important;">
								...
								<td align="right" colspan="2" style="text-align: right;font-size: 16px;" id="total"><b>$<?= $this->bpas->formatMoney($invs->grand_total); ?></b></td>
							</tr>
							<?php } ?>
							<?php if($invs->paid != 0 || $invs->deposit != 0){ ?>
								<?php if($invs->deposit != 0) { ?>
									<tr>
										...
										<td align="right" colspan="2">$<?php echo $this->bpas->formatMoney($invs->deposit); ?></td>
									</tr>
								<?php } ?>
								<?php if($invs->paid != 0) { ?>
									<tr>
										...
										<td align="right" colspan="2">$<?php echo $this->bpas->formatMoney($invs->paid-$invs->deposit); ?></td>
									</tr>
								<?php } ?>
								<tr style="background: #C0673D !important;">
									...
									<td align="right" colspan="2" style="font-size: 15px;text-align: right;" id="total"><b>$<?= $this->bpas->formatMoney($invs->grand_total - (($invs->paid-$invs->deposit) + $invs->deposit)); ?></b></td>
								</tr>
						<?php } ?>
						<?php if($invs->note){ ?>
							<tr>
