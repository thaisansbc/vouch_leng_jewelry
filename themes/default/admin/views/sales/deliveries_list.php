<script>
	$(document).ready(function () {
        CURI = '<?= admin_url('sales/deliveries'); ?>';
    });
</script>
...
<script>
    $(document).ready(function () {
        var oTable = $('#DOData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getDeliveryList').'/'.$start_date.'/'.$end_date ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<?= admin_url('sales') ?>"><i class="fa fa-heart"></i> <?= lang('list_sale') ?></a>
                        </li>
						<?php if ($Owner || $Admin) { ?>
