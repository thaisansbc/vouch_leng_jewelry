...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang('value', 'value'); ?>
                <?php echo form_input('value', $this->bpas->formatDecimal($gift_card->value), 'class="form-control" id="value" required="required"'); ?>
            </div>
            <div class="form-group">
                <?= lang('discount', 'discount'); ?>%
                <?php echo form_input('discount', $this->bpas->formatDecimal($gift_card->discount), 'class="form-control" id="discount"'); ?>
            </div>
            <div class="form-group">
