												...
												<div class="col-md-3">
													<div class="form-group" id="print_" style="display:none">
														...
														<!--<span class="pull-right col-xs-12">
															<a href="<?=admin_url()?>pos/depreciation_report/<?=$amount?>" target="_blank" id="depreciation_print" class="btn btn-block btn-primary" ><i class="fa fa-print"></i> <?= lang("print"); ?></a>
														</span>-->
													</div>
												 </div>
											</div>
...
<script type="text/javascript">
	...
	function billerChange(){
		...
		function PopupPayments() {
			...
			mywindow.document.write('<table border="2px" class="table table-condensed table_shape" style="width:95%; font-family:Verdana,Geneva,sans-serif; font-size:12px; border-collapse:collapse;">'+
										'<thead>'+
											 '<tr>'+
