                ...
                <table class="table table-hover table-striped print-table order-table">
                    ...
                    ?>
                        <tr>
							...
							<td style="text-align:right; width:100px;"><?= $row->subtotal!=0?$this->bpas->formatMoney($row->net_unit_price):$free; ?></td>
                            <?php
                            if ($Settings->tax1) {
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
						...
						<!--
						<div class="btn-group">
                            <a href="<?= admin_url('sales/print_hch/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('Print_HCH_Invoice') ?>">
                                <i class="fa fa-print"></i>
						...
						-->
						<div class="btn-group">
                            <a href="<?= admin_url('sales/invoice/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('invoice') ?>">
                                <i class="fa fa-print"></i>
                        ...
                        <!--
						<div class="btn-group">
							<a href="<?=admin_url()?>sales/cabon_print/<?=$inv->id?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_cabon') ?>">
								<i class="fa fa-print"></i>
