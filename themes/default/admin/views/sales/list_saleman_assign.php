...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('sales/getSalesman' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v ?>',
        ...
        $('body').on('click', '#combine_pay', function(e) {
            ...
            var i = 0;
                ...
                if(b == true){
                    ...
                    $('#myModal').modal({remote: '<?=admin_url('sales/combine_payment');?>?data=' + arrItems + ''});
                    $('#myModal').modal('show');
                    return false;
                }
...
<?php
	...
	echo admin_form_open('sales/sale_actions/'.($warehouse ? $warehouse_id : ''), 'id="action-form"');
?>
            ...
            <?php if ($Owner || $Admin || $GP['sales-payments'] || $GP['sales-add'] || $GP['sales-export'] || $GP['sales-import'] || $GP['sales-combine_pdf']) { ?>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						...
						<?php if($Owner || $Admin || $GP['sales-payments']) { ?>
							<li>
								<a href="<?= admin_url('sales/payment_by_csv'); ?>">
									<i class="fa fa-plus-circle"></i>
