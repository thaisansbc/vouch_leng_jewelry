...
<script>
    $(document).ready(function () {
        oTable = $('#CSMData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getConsignments/'.($warehouse ? $warehouse->id : 0).'/'.($biller ? $biller->id : '').'?v=1'.$v );?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('sales/add_consignment') ?>"><i class="fa fa-plus-circle"></i> <?= lang('add_consignment') ?>
                            </a>
                        </li>
                        <li>
