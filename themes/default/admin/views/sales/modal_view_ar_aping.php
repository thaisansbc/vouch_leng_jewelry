    ...
    <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="table-responsive">
                <table id="SLData" class="table table-condensed table-hover table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        if(count($ar_aping) > 0):
                            foreach ($ar_aping as $rws) {
                                ...
                                echo '<td>' . $this->bpas->formatMoney($rws->grand_total) . '</td>';
                                echo '<td>' . $this->bpas->formatMoney($rws->paid) . '</td>';
                                echo '<td>' . $this->bpas->formatMoney($rws->balance) . '</td>';
...
<script type="text/javascript">
    $(document).ready( function() {
        ...
        $('.link_ar_to').on('click', function(){
            var id = $(this).attr('id');
            window.open('<?=admin_url()?>account/list_ac_recevable?id=' + id, '_blank');
        });
    });
</script>
