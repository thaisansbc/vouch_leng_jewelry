...
*/
            ...
            <div class="row">
                <div class="col-sm-6">
					...
					<p><b><?= lang("date_invoice"); ?></b>: <?= $this->bpas->hrld($inv->date); ?></p>
					<p><b><?= lang("date_received"); ?></b>: <?= $this->bpas->hrld($payment->date); ?></p>
                </div>
            ...
            <div class="well">
				<table class="table receipt">
					...
					<tfoot>
						<tr>
							<th colspan="2"><?= lang("rate"); ?> : <?php echo $exchange_rate_kh_c->rate?number_format($exchange_rate_kh_c->rate):0 ?> ៛ | <?= lang("qty"); ?>= (<?=$this->bpas->formatQuantity($total_quantity)?>)</th>
							...
							<table class="table table-striped">
								...
								<tbody>
									<tr>
										...
										<td><strong><?php echo '$ '. $this->bpas->formatMoney($curr_balance); ?></strong></td>
									</tr>
									...
									<tr>
										...
										<td><strong><?php echo '$ '. $this->bpas->formatMoney(($payment->amount-$payment->extra_paid)); ?></strong></td>
									</tr>
									<tr>
										<td class="text-left" width="25%">
											<strong><?= lang("extra_paid"); ?></strong>
										</td>
										<td><strong><?php echo '$ '. $this->bpas->formatMoney($payment->extra_paid); ?></strong></td>
									</tr>
									<?php } ?>
									<tr>
										<td class="text-left" width="25%">
										...
										<td>
											<strong>
												<?php echo '$ '. $this->bpas->formatMoney($payment->amount) .'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ( '. $this->bpas->convert_number_to_words(($this->bpas->fraction($payment->amount) > 0)? $this->bpas->formatMoney($payment->amount) : number_format($payment->amount)) .' dolar )'; ?>
											</strong>
										</td>
									</tr>
									...
									<tr>
										...
										<td><strong><?php echo '$ '. $this->bpas->formatMoney($curr_balance - ($payment->amount - $payment->extra_paid)); ?></strong></td>
									</tr>
								</tbody>
			...
			<p class="alert text-center"><?= $this->bpas->decode_html($biller->invoice_footer); ?></p>
