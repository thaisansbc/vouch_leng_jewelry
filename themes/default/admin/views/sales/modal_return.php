            ...
            <div class="well well-sm">
                <div class="row bold" style="font-size:12px;">
                    ...
                    <div class="col-xs-7 text-right">
                        ...
                        <img height="45px" src="<?= admin_url() ?>assets/uploads/barcode<?= $this->session->userdata('user_id') ?>.png"
                             alt="<?= $inv->reference_no ?>"/>
                        <?php $this->bpas->qrcode('link', urlencode(admin_url('sales/view/' . $inv->id)), 2); ?>
                        <img height="45px" src="<?= admin_url() ?>assets/uploads/qrcode<?= $this->session->userdata('user_id') ?>.png"
                             alt="<?= $inv->reference_no ?>"/>
                    </div>
                ...
                <table class="table table-hover table-striped print-table order-table">
					...
					<?php if($inv->surcharge != 0){ ?>
                        <tr>
                            ...
                            <td style="text-align:right; font-weight:bold;"><?= $this->bpas->formatMoney($inv->surcharge); ?></td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td></td>
            ...
            <?php if (!$Supplier || !$Customer) { ?>
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
						<div class="btn-group">
                            <a href="<?= admin_url('sales/invoice_return_chea_kheng/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('Return_Chea_Kheng') ?>">
                                <i class="fa fa-angle-double-left"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('Return_Chea_Kheng') ?></span>
                            </a>
                        </div>
						<div class="btn-group">
                            <a href="<?= admin_url('sales/creadit_note/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('Return_Chea_Kheng') ?>">
                                <i class="fa fa-angle-double-left"></i>
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/view_return/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('view') ?>">
