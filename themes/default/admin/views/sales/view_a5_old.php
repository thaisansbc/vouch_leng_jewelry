...
<div class="modal-dialog modal-lg no-modal-header" id="printa5">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <button type="button" class="btn btn-xs btn-default no-print pull-right" style="margin-right:15px;" onclick="printDiv('printableArea')">
                ...
                <div class="row bold">
                    <div class="col-xs-5">
                        <p class="bold">
                            ...
                            if ($inv->return_id) {
                                echo ' <a data-target="#myModal2" data-toggle="modal" href="' . admin_url('sales/view_a5/' . $inv->return_id) . '"><i class="fa fa-external-link no-print"></i></a><br>';
                            } else {
                                echo '<br>';
                            }
                            } ?>
                    ...
                    <div class="col-xs-7 text-right order_barcodes" id="order_barcodes">
