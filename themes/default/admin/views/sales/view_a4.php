...
<div class="modal-dialog modal-lg no-modal-header" id="popup1">
                ...
                <div class="row bold">
                    <div class="col-xs-5">
                        <p class="bold">
                            ...
                            echo '<br>' . lang('due_date') . ': ' . $this->bpas->hrsd($inv->due_date);
                            } ?>
                        </p>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped print-table order-table">
                    ...
                    <tr>
                        ...
                        <th>ថ្លៃឯកតា <br><?= lang('unit_price'); ?></th>
                        <?php
                        if ($Settings->tax1 && $inv->product_tax > 0) {
                            echo '<th>' . lang('tax') . '</th>';
                        }
                        ...
                        ?>
                        <th>តម្លៃសរុប <br><?= lang('subtotal'); ?></th>
                    </tr>
            ...
            <?php if (!$Supplier || !$Customer) {
                ...
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/view_a5/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('view_a5') ?>" data-toggle="modal" data-target="#printa5">
...
<div class="modal-dialog modal-lg no-modal-header" id="printa5">
    <div class="modal-content">
        <div class="modal-body">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                <i class="fa fa-2x">&times;</i>
                ...
                <div class="row bold">
                    <div class="col-xs-5">
                        <p class="bold">
                            ...
                            echo lang('return_ref') . ': ' . $inv->return_sale_ref;
                            if ($inv->return_id) {
                                echo ' <a data-target="#printa5" data-toggle="modal" href="' . admin_url('sales/view_a5/' . $inv->return_id) . '"><i class="fa fa-external-link no-print"></i></a><br>';
                            } else {
                                echo '<br>';
                            }
                            } ?>
            ...
            <div class="row" style="margin-bottom:15px;">
                ...
                <div class="col-xs-6" id="to">
                    <?php echo $this->lang->line('to'); ?>:<br/>
                    
                    <h2 style="margin-top:1px;"><?= $customer->company && $customer->company != '-' ? $customer->company : $customer->name; ?></h2>
                    <?= $customer->company                              && $customer->company != '-' ? '' : 'Attn: ' . $customer->name ?>
                ...
                <div class="col-xs-6" id="info">
                    ...
                    <h2 style="margin-top: 1px;"><?= $biller->company && $biller->company != '-' ? $biller->company : $biller->name; ?></h2>
                    <?= $biller->company ? '' : 'Attn: ' . $biller->name ?>
                ...
                <table class="table table-hover table-striped print-table order-table">
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <td style="width: 80px; text-align:center; vertical-align:middle;"><?= $this->bpas->formatQuantity($row->unit_quantity) . ' ' . ($inv->sale_status == 'returned' ? $row->base_unit_code : $row->product_unit_code); ?></td>
                            <td style="text-align:right; width:100px;">
                                <?= $row->unit_price != $row->real_unit_price && $row->item_discount > 0 ? '<del>' . $this->bpas->formatMoney($row->real_unit_price) . '</del>' : ''; ?>
                                <?= $this->bpas->formatMoney($row->unit_price); ?>
                            </td>
