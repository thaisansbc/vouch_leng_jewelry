...
<script>$(document).ready(function () {
        CURI = '<?= admin_url('sales/deliveries_alerts/'.$v); ?>';
    });</script>
...
<script>
    $(document).ready(function () {
        var oTable = $('#DOData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getDeliveriesAlert').'/'.$v . '/' .$start_date.'/'.$end_date ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<?= admin_url('sales/deliveries') ?>"><i class="fa fa-heart"></i> <?= lang('list_deliveries') ?></a>
                        </li>
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
            ...
            $('body').on('click', '#deliveries_combine', function() {
                ...
                $('#myModal').modal({remote: '<?=admin_url('sales/view_delivery_combine');?>?data=' + arrItems + ''});
                $('#myModal').modal('show');
            });
        });
    </script>
