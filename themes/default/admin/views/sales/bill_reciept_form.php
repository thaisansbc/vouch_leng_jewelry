...
<div id="wrap" style="width:794px;margin: 0 auto;padding:10px;height:700px;">
    <div class="row">
		<div>
			<span>
				<img style="width:175px;height:45px;" src="<?= admin_url() . 'assets/uploads/logos/' . $Settings->logo2; ?>" alt="<?= $Settings->site_name; ?>">
			</span>
		...
		<div style="font-family: Khmer Siemreap">
			...
			<table  style="width:95%">
				...
				<tr>
					...
					<td style="text-align:right; color:#8B0000;"><strong><?= $this->bpas->hrsd($payment->date); ?></strong></td>
				</tr>
			</table>
			...
			<table style="width:100%;font-weight:bold;">
				<tr>
					<?php
						...
						$payment_ = $this->bpas->formatMoney($payments);
					?>
				...
				<tr>
					...
					<td colspan="7" style="color:#8B0000;height:45px;padding-left:80px;font-family:Calibri;"><b style="font-size: 15px"><?php echo $this->bpas->numberToWordsCur($payment->amount,"kh","ដុល្លា");?></b></td>
				...
				<tr>
					...
					<td>ប្រាក់ដើម </td>
					<td style="padding-top:25px;color:#8B0000;text-align:center;font-family:Calibri;"><b style="font-size: 15px"><?php echo $this->bpas->formatMoney($payment->principle);?></b></td>
					<td>ការប្រាក់</td>
					<td style="width:10%;padding-top:25px;color:#8B0000;text-align:center;font-family:Calibri;"><b style="font-size: 15px"><?php echo $this->bpas->formatMoney($payment->interest);?></b></td>
				</tr>
				<tr>
					<td>Pay:</td>
					<td ><?php echo "..........................................................................."?></td>
