        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("sales/add_receive_payment", $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
                                ...
                                <div class="panel-body" style="padding: 5px;">
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<?php
												...
												echo form_dropdown('type', $opt_type, (isset($_POST['rtype']) ? $_POST['rtype'] : ''), 'id="rtype" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("type") . '"  class="form-control input-tip select"');
											?>
										</div>
									</div>
									<div class="col-md-2">
									...
									<div class="col-sm-2">
										<div class="form-group">
											...
											<select name="paid_by[]" id="rppaid_by" multiple class="form-control rppaid_by">
												<?= $this->bpas->paid_opts(); ?>
											</select>
										</div>
									</div>
