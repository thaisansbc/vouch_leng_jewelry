                    ...
                    <tbody style="font-size:11px">
								...
								<td colspan="7" rowspan="<?= $rows; ?>" style="border-left: 1px solid #FFF !important;​border-bottom: 1px solid #FFF !important">
									...
									if ($inv->invoice_footer || $inv->invoice_footer != "") { ?>
										<div style="font-size:11px;">
											...
											<div><?= $this->bpas->decode_html(nl2br($inv->invoice_footer)); ?></div>
										</div>
									<?php
									}
									?>
							...
							<?php }else{?>
								<td colspan="6" rowspan="<?= $rows; ?>" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important">
									...
									if ($inv->invoice_footer || $inv->invoice_footer != "") { ?>
										<div style="font-size:11px;">
											<p><b><?= lang("note_kh"); ?>:</b></p>
											<div><?= $this->bpas->decode_html($inv->invoice_footer); ?></div>
										</div>
									<?php
									}
									?>
						...
						<?php if($inv->order_discount != 0){ ?>
							<tr>
								...
								<td style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->bpas->formatMoney($inv->order_discount); ?></td>
							</tr>
						<?php } ?>
                        <tr>
                            <td style="text-align:right; font-weight:bold;"><?= lang("totalpaid_kh"); ?>
                            </td>
                            <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->bpas->formatMoney($grand_total-$inv->total_discount); ?></td>
                        </tr>
                        <tr>
                            <td style="text-align:right; font-weight:bold;"><?= lang("deposit_kh"); ?>
                            </td>
                            <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->bpas->formatMoney($inv->paid); ?></td>
                        </tr>
                        <tr>
                            <td style="text-align:right; font-weight:bold;"><?= lang("balance_kh"); ?>
                            </td>
                            <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= "$ ".$this->bpas->formatMoney(($grand_total-$inv->total_discount)-$inv->paid); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<div style="margin-top: -235px;" class="no-print">
	<div class="col-xs-4" id="hide" >
		<a href="<?= admin_url('pos/sales'); ?>"><button class="btn btn-warning " ><?= lang("Back to List POS Sale"); ?></button></a>&nbsp;&nbsp;&nbsp;
