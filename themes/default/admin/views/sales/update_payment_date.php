<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sales/changePaymentDate", $attrib); ?>
                    ...
                    <tbody>
						<?php foreach($loans as $loan) { ?>
							<tr>
								...
								<td class="text-center"> <input type="text" name="payment_date[]" class="form-control payment_date date" value="<?= $this->bpas->hrsd($loan->dateline) ?>" /> </td>
							</tr>
						<?php } ?>
					</tbody>
