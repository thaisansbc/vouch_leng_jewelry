...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('sales/add_payment/'. $inv->id . (isset($down_payment_id) ? ('/' . $down_payment_id) : ''), $attrib); ?>
        <div class="modal-body">
            ...
            <div id="payments">
                <?php 
                $datediff = time() - strtotime($inv->date);
                ...
                $down_payment ? $down_payment->amount:0

                ?>

                <input type="hidden" name="payment_term"      value="<?php echo $payment_term; ?>"/>
                <input type="hidden" name="down_payment_id" value="<?= $down_payment ? $down_payment->id:0;?>" data="0" />
                    ...
                    <div class="col-sm-12">
                        <div class="payment">
                            <div class="form-group">
                                ...
                                <input type="text" name="amount-paid" readonly="readonly" class="pa form-control kb-pad amount" id="amount_1" value="<?= $down_payment ? $down_payment->amount:0;?>" data="0"  required="required"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            foreach($currencies as $currency){ 
                                ...
                                $base_amount = $this->bpas->formatDecimal(($inv->grand_total - $inv->paid - $discount) / $base_currency->rate);
