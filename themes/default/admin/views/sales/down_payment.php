...
<?php foreach($order_loans as $order_loan) {
	    $total_sched = $this->bpas->formatMoney($order_loan->interest)+$this->bpas->formatMoney($order_loan->principle);
        ...
        <div class="tab-content">
			...
			<div id="avatar" class="tab-pane fade">
			   <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
                                echo admin_form_open('sales/down_payment/'.$inv->id ,$attrib);
							...
							<div class="col-md-0">
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="deposit" type="text" id="deposit" value="<?= (isset($inv->paid)?$this->bpas->formatDecimal($inv->paid):0)?>" style="pointer-events:none"
							...
							<div class="col-md-0">
							   <div class="col-md-4">
									...
									<div class="form-group">
										...
										<input name="loan_amount" type="text" id="loan_amount" value="<?= $this->bpas->formatDecimal($inv->grand_total - ($inv->paid+$order_down->principle_amount+$order_down->down_amount)); ?>" style="pointer-events:none" class="form-control loan_amount" placeholder="<?= lang('loan_amount') ?>"/>
									</div>
								</div>
							</div>
						</div>
				...
				mywindow.document.write('<div class="col-lg-12 col-xs-12"><br>');
					...
					mywindow.document.write('<table class="table" style="width: 95%;margin: 0 auto;">');
						...
						mywindow.document.write('<tr>');
							...
							mywindow.document.write('<td><p style="margin-top:8px;"><?php echo $this->bpas->formatMoney($deposit->amount*100/$rows->unit_price); ?>%</p></td>');
							mywindow.document.write('<td><p style="margin-top:8px;">$<?php echo $this->bpas->formatMoney($deposit->amount); ?></p></td>');
						mywindow.document.write('</tr>');
						mywindow.document.write('<tr>');
