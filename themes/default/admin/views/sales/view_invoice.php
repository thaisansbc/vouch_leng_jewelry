...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $this->config->admin_url(); ?>assets/img/favicon.ico">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="<?php echo $this->config->admin_url(); ?>assets/css/<?php echo THEME; ?>.css" rel="stylesheet">
    <script type="text/javascript" src="<?php echo $this->config->admin_url(); ?>assets/js/jquery.js"></script>
</head>

<body>
<!--<img src="<?php echo $this->config->admin_url(); ?>assets/img/<?php echo $inv->status; ?>.png" alt="<?php echo $inv->status; ?>" style="float: right; position: absolute; top:0; right: 0;"/>-->
<div id="wrap">
    <img src="<?php echo $this->config->admin_url(); ?>assets/uploads/logos/<?php echo $biller->logo; ?>"
         alt="SITE_NAME"/>
    ...
    <table class="table table-hover table-striped" style="margin-bottom: 5px;">
        ...
        foreach ($rows as $row): ?>
            <tr>
                ...
                <td style="width: 70px; text-align:center; vertical-align:middle;"><?php echo $this->bpas->formatQuantity($row->quantity); ?></td>
...
<div id="payment_buttons">
    <?php if ($paypal->active == "1" && $inv->grand_total != "0.00") {
        ...
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
            ...
            <input type="hidden" name="image_url" value="<?php echo admin_url() ?>assets/img/<?php echo LOGO2; ?>">
            ...
            <input type="hidden" name="return"
                   value="<?php echo admin_url('module=sales&view=view_invoice&id=' . $inv->id); ?>">
            <input type="hidden" name="cancel_return"
                   value="<?php echo admin_url('module=sales&view=view_invoice&id=' . $inv->id); ?>">
            <input type="hidden" name="notify_url" value="<?php echo admin_url('module=paypalipn'); ?>"/>
