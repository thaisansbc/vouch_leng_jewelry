...
box-shadow: 0px 4px 5px 0px rgba(0,0,0,0.75);
	...
	<button id="print" onclick="window.print()">
		<img src="<?= admin_url() . 'assets/uploads/printer.png'; ?>">
	</button>
...
color: rgba(0, 0, 0, 0.3);
	...
	border: 1px solid #000000;height:110px;width:42%;margin-left:10px;padding-top:25px;" class="col-xs-4">
					<table id="tb3">
						...
						<tr>
							<td>Date</td>
							<td>: <?=$this->bpas->hrsd($invs->date);?></td>
						</tr>
						<tr>
							<td>Ref DO No</td>
			...
			<table id="tb" style="border-collapse: collapse;text-align:center;" border="1" >
				...
				<tr>
					...
					<td style="text-align: center; vertical-align: top"><?=$this->bpas->formatDecimal($qty);?></td>
					<td style="text-align: right; vertical-align: top">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($row->unit_price);?></div>
						</div>
					</td>
					<?php if($invs->product_discount != 0){ ?>
						<td style="text-align: right; vertical-align: top">
							<div class="row">
								<div class="col-sm-6 col-xs-6 text-left">$</div>
								<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($invs->product_discount)?></div>
							</div>
						</td>
					<?php } ?>
					<td style="text-align: right; vertical-align: top">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($qty*$row->unit_price-$invs->product_discount)?></div>
						</div>
					</td>
				...
				<tr>
					...
					<td  style="text-align:right;">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($stotal);?></div>
						</div>
					</td>
				...
				<tr>
					...
					<td style="text-align:right;">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($invs->order_discount);?></div>
						</div>
					</td>
				...
				<tr>
					...
					<td style="text-align:right;">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($invs->order_tax);?></div>
						</div>
					</td>
				...
				<tr>
					...
					<td style="text-align:right;">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($invs->shipping);?></div>
						</div>
					</td>
				...
				<tr>
					...
					<td   style="text-align:right;" >
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($stotal-$invs->order_discount+$invs->shipping+$invs->order_tax);?></div>
						</div>
					</td>
				</tr>
				<?php } ?>
				<tr>
					...
					<td colspan="2" ​ style="text-align:center;"><?= $this->bpas->decode_html(strip_tags($invs->sale_note));?></td>
					<td></td>
					<td></td>
					<td></td>
					<?php if($invs->product_discount != 0){ ?>
				...
				<tr>
					...
					<td style="text-align:right;">
						<div class="row">
							<div class="col-sm-6 col-xs-6 text-left">$</div>
							<div class="col-sm-6 col-xs-6"><?=$this->bpas->formatMoney($dp->paid);?></div>
						</div>
					</td>
			...
			<p><b>Total Amount in word: <?=$this->bpas->convert_number_to_words($invs->total_amount);?></b></p>
