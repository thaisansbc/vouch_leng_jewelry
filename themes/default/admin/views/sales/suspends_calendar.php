<script>
    $(document).ready(function () {
        ...
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getSuspends_calendar') ?>',
...
<?php if ($Owner) {
    echo admin_form_open('sales/suppend_actions', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks"> 
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
							<a href="<?= admin_url('system_settings/addSuppend'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal" id="add">
							<i class="fa fa-plus-circle"></i> <?= lang("add_suppend"); ?></a>
						</li>
						<?php if ($Owner || $Admin) { ?>
							<li>
								<a href="<?= admin_url('system_settings/import_chart_csv'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
