...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#fcbiller").change(biller); biller();
		function biller(){
			var biller = $("#fcbiller").val();
			var project = "<?= $fuel_customer->project_id ?>";
			$.ajax({
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("sales/edit_fuel_customer/".$id, $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['sales-fuel_sale-date']) { ?>
