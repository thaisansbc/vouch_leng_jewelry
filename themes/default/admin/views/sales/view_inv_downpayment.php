    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12 no-print">
                <a href="<?= admin_url('sales/index'); ?>"><button class="btn btn-warning " ><i class="fa fa-backward "></i>&nbsp;<?= lang("back"); ?></button></a>
            </div>
            <div class="col-lg-12">
                    ...
                    <table class="border1">
                        ...
                        <?php 
                            if($down_payment){
                                ...
                                <tr>
                                    <td colspan="<?= $col; ?>" style="text-align:right; font-weight:bold;"><?= $downpayment->description; ?></td>
                                    <td style="text-align:right; font-weight:bold;"><?= $this->bpas->formatMoney($downpayment->amount ? $downpayment->amount : ''); ?></td>
                                </tr> <?php
