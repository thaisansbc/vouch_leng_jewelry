        ...
        <div class="col-lg-12 col-xs-12">
            ...
            <table class="table" style="width: 95%;margin: 0 auto;">
                ...
                <tr>
                    ...
                    <td colspan="2"><p><b>: US$ <?php echo $this->bpas->formatMoney($rows->unit_price); ?></b></p></td>
                </tr>
                <tr>
                    <td><p style="font-family: 'Moul', cursive;margin-top:8px;">ទឹកប្រាក់កក់</p></td>
                    <td><p style="margin-top:8px;"><?php echo $this->bpas->formatMoney($payments->amount*100/$rows->unit_price); ?>%</p></td>
                    <td><p style="margin-top:8px;">$<?php echo $this->bpas->formatMoney($payments->amount); ?></p></td>
                </tr>
                <tr>
                    <td style="width: 20%;">
                    ...
                    <td style="width: 12%;">
                        <p style="margin-top:8px;"><span>
                            <?php if($frequency->principle_type == 0){
                                ...
                                echo "$     ".$this->bpas->formatMoney($total_prin);
                                } ?>
                        </span></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2"><p style="margin-top:8px;"><span>$</span >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><?php echo $this->bpas->formatMoney($total_balance); ?></span></p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><p style="margin-top:8px;">
                        <?php if($frequency->principle_type == 0){
                                ...
                                echo "$     ".$this->bpas->formatMoney($grandtotal_prin);
                                } ?>
                    </p></td>
                </tr>
                <tr>
                    <td><p style="font-family: 'Moul', cursive;margin-top:8px;">កាលបរិច្ឆេទ</p></td>
                    <td colspan="2"><p style="margin-top:8px;">: <?php echo $this->bpas->hrsd($date); ?></p></td>
                    <td style="border-bottom-color:white !important;"></td>
                            ...
                            if(array($loan)) {
								...
								//$this->bpas->print_arrays($pt);
                                    ...
                                    echo '<tr class="row-data" '.(($pt->paid_amount > 0)? 'style="pointer-events:none;" disabled="disabled"':'').'>
                                        ...
                                        <td class="t_c" style="padding-left:5px; padding-right:5px;text-align:center;">'. $this->bpas->hrsd($pt->dateline) .'</td>';
                                        ...
                                        $balances = (($pt->balance > 0)? $pt->balance : 0);
                                    echo '<td class="t_r" style="padding-left:5px;padding-right:5px;text-align:center;">'. $this->bpas->formatMoney($payment) .'</td>
									<td class="t_r" style="padding-left:5px; padding-right:5px;text-align:center;">'. $interests .'</td>
									 <td class="t_r" style="padding-left:5px; padding-right:5px;text-align:center;">'. $Principles .'</td>
                                          ...
                                          <td class="t_r" style="padding-left:5px;padding-right:5px;text-align:center;">'. $this->bpas->formatMoney($balances) .'</td><td></td><td></td><td></td>
                                         '; 
