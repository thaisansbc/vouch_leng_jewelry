<script>
    $(document).ready(function () {
        var oTable = $('#RESLData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getProductSerial'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
...
<?php if ($Owner) {
   // echo admin_form_open('sales/return_actions', 'id="action-form"');
} ?>
<div class="box">
                ...
                <?php if (!empty($warehouses)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('sales/product_serial') ?>">
								<i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a>
							</li>
                            <li class="divider"></li>
                            <?php
                            foreach ($warehouses as $warehouse) {
                                echo '<li><a href="' . admin_url('sales/product_serial/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
