...
<div class="row">
	<div class="col-md-12">
		...
		if ($inv->payment_status == 'paid') {
			...
			echo '<div class="alert alert-warning">' . lang('payment_status_not_paid') . ' ' . lang('payment_status') . ': <strong>' . $inv->payment_status . '</strong> & ' . lang('paid_amount') . ' <strong>' . $this->bpas->formatMoney($inv->deposit + $inv->paid) . '</strong></div>';
		}
		?>
	</div>
</div>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("sales/edit_return/" . $inv->id, $attrib)
                ?>
