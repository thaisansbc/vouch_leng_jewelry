				...
				<br>
					<table style="font-size: 14px;line-height:25px;margin-left:10px;">
						...
						<tr>
							<td>អ្នកលក់</td>
							<td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
							<td><b><?=$invs->saleman_by?></b></td>
						</tr>	
					</table>
				</div>
				<?php //$this->bpas->print_arrays($rates); ?>
				...
				<div class="col-sm-12 col-xs-12">
					<table class="table" style="margin-top: 10px;">
						<tbody style="font-size: 14px;">
							...
							<tr>
								<td colspan="3" rowspan="<?= $row; ?>" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important">អត្រាប្រាក់​ 1$ =<b>&nbsp;&nbsp;</b><br>
								<?php
									//$this->bpas->print_arrays($invs);
									if ($invs->note || $invs->note != "") { ?>
										<div style="font-size:10px; line-height:25px;">
											<div><?= $this->bpas->decode_html($invs->note); ?></div>
										</div>
									<?php
									}
									?>
