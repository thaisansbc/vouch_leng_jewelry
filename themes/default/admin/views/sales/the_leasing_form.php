			...
			<table style="width:95%;margin: 0 auto;">
				 <?php foreach($loan as $lo){
					...
					<tr>
						...
						?>
						<td class="tnew" style="width:10%;font-size:11px;">&nbsp;: $&nbsp;&nbsp;&nbsp;<?php echo $this->bpas->formatMoney($payment);?></td>
					</tr>
					...
					<tr>
						...
						<td class="tnew" style="width:10%;font-size:11px;">&nbsp;: $&nbsp;&nbsp;&nbsp;<?=$this->bpas->formatDecimal($inv->grand_total - ($inv->deposit+$order_down->down_amount+$order_down->principle_amount)) ?></td>
						<td class="tnew" style="width:10%;font-size:11px;">ប្រាក់ត្រូវបង់សរុប</td>
						<td class="tnew" style="width:10%;font-size:11px;">&nbsp;: $&nbsp;&nbsp;&nbsp;<?php echo $this->bpas->formatMoney($totalpayment);?></td>
					</tr>
                            ...
                            if(array($loan)) {
                                foreach($loan as $pt){
                                    ...
                                    echo '<tr class="row-data" '.(($pt->paid_amount > 0)? 'style="pointer-events:none;" disabled="disabled"':'').'>
                                        ...
                                        <td></td>
                                        <td class="t_r" style="padding-left:5px; padding-right:5px;text-align:center;">'. $this->bpas->formatMoney($payment) .'</td>';
                                        ...
                                        $balances = (($pt->balance > 0)? $pt->balance : 0);
                                    echo '<td class="t_r" style="padding-left:5px;padding-right:5px;text-align:center;">'. $this->bpas->formatMoney($interests) .'</td>
                                          <td></td><td class="t_r" style="padding-left:5px;padding-right:5px;text-align:center;">'. $this->bpas->formatMoney($balances) .'</td>
										  <td></td>
										  <td></td>
										  <td></td>
										  <td></td>
