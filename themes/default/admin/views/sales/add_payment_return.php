...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("sales/add_payment_return/" . $inv->id, $attrib); ?>
        <div class="modal-body">
			...
			<?php
				...
				if($Settings->module_installment==1){
					...
					$credit_interest = $this->bpas->formatDecimal($credit_interest - $return_interest - $inv->surcharge_interest);
				}
				$credit_amount = $this->bpas->formatDecimal(abs($inv->grand_total) - abs($inv->paid));
			?>
                    ...
                    <div class="col-md-12">
                        <div class="row">
							...
							foreach($currencies as $currency){ 
								$base_amount = $this->bpas->formatDecimal(($credit_amount + $credit_interest)/$base_currency->rate);
