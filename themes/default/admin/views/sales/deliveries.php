...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#DOData').dataTable({
            ...
            {column_number: 5, filter_default_label: "[<?=lang('deliveries');?>]", filter_type: "text", data: []},
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" id="print_multi_deliveries" data-action="print_multi_deliveries"><i class="fa fa-file-excel-o"></i> <?= lang('Print_sticker_delivery') ?></a>
                        </li>
                        <li>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <table id="DOData" class="table table-hover table-striped table-condensed">
                    <thead>
                    <tr>
                        ...
                        <th><?= lang('customer'); ?></th>
                        <th style="width:100px; text-align:center;"><?= lang('delivery_by'); ?></th>
                        <th><?= lang('address'); ?></th>
                        <th style="width:30px; text-align:center;"><?= lang('status'); ?></th>
                        <th style="width:30px; text-align:center;"><?= lang('money_collection'); ?></th>
...
<?php if ($Owner || $GP['bulk_actions']) {
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
            ...
            $(document).on('click', '#print_multi_deliveries', function(e) {
                e.preventDefault();
                var arrItems = [];
                var k = 0;
                ...
                window.location.replace('<?= site_url("admin/sales/print_multi_deliver");?>?data=' + arrItems + '');
            });
        });
    </script>
<?php
