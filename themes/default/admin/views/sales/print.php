...
<div id="wrap" style="width: 90%; margin: 0 auto;">
    <div class="row">
        <div class="col-lg-12">
            <?php
                if ($Settings->system_management == 'project') { ?>
                    <div class="text-center" style="margin-bottom:20px;">
                        <img src="<?= admin_url() . 'assets/uploads/logos/' . $Settings->logo2; ?>"
            ...
            <div class="row padding10">
                ...
                <div class="col-xs-5" style="float: right;">
                    <div class="bold">
                        ...
                        <div class="clearfix"></div>
                        <?php $this->bpas->qrcode('link', urlencode(admin_url('saless/views/' . $inv->id)), 1); ?>
                ...
                <table class="table table-hover table-striped" style="width: 100%;">
                    ...
                    foreach ($rows as $row):
                        ...
                        <tr>
                            ...
                            ?>
                            <td style="text-align:right; vertical-align:middle; width:90px;"><?= $this->bpas->formatMoney($row->real_unit_price); ?></td>
                            <?php
                            if ($Settings->product_discount) {
                    ...
                    <?php if ($inv->grand_total != $inv->total) { ?>
                        <tr>
                            ...
                            ?>
                            <td style="text-align:right;"><?= $this->bpas->formatMoney($inv->total); ?></td>
                        </tr>
                    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; font-weight:bold;"><?= $this->bpas->formatMoney($inv->grand_total - ($inv->deposit+($inv->paid-$inv->deposit))); ?></td>
                    </tr>
                    <?php }?>
                    </tfoot>
                </table>
            ...
            <a class="btn btn-warning" href="<?= admin_url('sales'); ?>">
                <i class="fa fa-hand-o-left" aria-hidden="true"></i>&nbsp;<?= lang("back"); ?>
            </a>
			<!--
            <a target="_blank" class="btn btn-primary" href="<?= admin_url('sales/print_invoice/' . $sid); ?>"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("print_invoice"); ?></a>

            <a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/tax_invoice/'. $sid); ?>"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("tax_invoice"); ?></a>

            <a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/tax_invoice2/'. $sid); ?>"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("tax_invoice_2"); ?></a>

			<a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/tax_invoice3/'. $sid); ?>"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("tax_invoice_ck"); ?></a>
		
            <a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/print_rks/' . $sid); ?>">
                <i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("rks_invoice"); ?>
            </a>
			<a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/invoice_landscap_a5/' . $sid); ?>">
                <i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("yon_wang_invoice"); ?>
            </a>
			</a>
			<a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/invoice_a5/' . $sid); ?>">
                <i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("Tea_Try_II"); ?>
            </a>
			<a  target="_blank" class="btn btn-primary" href="<?= admin_url('sales/sales_invoice/' . $sid); ?>">
        ...
        <div class="col-lg-12">
            ...
            <div class="-table-responsive">
                <table class="table table-hover table-striped" style="width: 100%;">
                    ...
                    ?>
					<?php if ($inv->shipping != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("shipping") . ' (' . $default_currency->code . ')</td><td style="text-align:right;">' . abs($this->bpas->formatMoney($inv->shipping)) . '</td></tr>';
                    }
                    ?>
                    <?php if ($Settings->tax2 && $inv->order_tax != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("order_tax") . ' (' . $default_currency->code . ')</td><td style="text-align:right;">' . $this->bpas->formatMoney($inv->order_tax) . '</td></tr>';
