    ...
    <div class="row">
        <div class="col-lg-12">
			...
			<div class="col-md-4 col-sm-4" style="float:left;">
				<p>ថ្ងៃទី​ / Date: <?= $this->bpas->hrld($inv->date); ?><br></p>
			</div>
            ...
            <div class="-table-responsive">
                <table class="table " style="width: 100%;">
                    ...
                    <tbody style="font-size: 13px;">
						...
						if($setting->show_code == 0) {
							...
							<tr style="border-top:none !important;border-bottom:none !important;">
								...
								<td style="width: 14%; text-align:center; vertical-align:middle;border-top:none !important;border-bottom:none !important;"><?= $this->bpas->formatQuantity($row->quantity); ?> <?=$product_unit?></td>

								<td style="text-align:center; width:15%;vertical-align:middle;border-top:none !important;border-bottom:none !important;"><?= $row->subtotal!=0?$this->bpas->formatMoney($row->unit_price):$free; ?></td>
								
								<td style="vertical-align:middle; text-align:right; width:20%;border-top:none !important;border-bottom:none !important;"><?= $row->subtotal!=0?$this->bpas->formatMoney($row->subtotal):$free;
									$total += $row->subtotal;
									?></td>
							</tr>
							<?php
                    ...
                    <?php if ($inv->order_discount != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:left; font-weight:bold;font-size:11px;" class="kh-moul">' . lang("ចុះថ្លៃ") . ' </td><td style="text-align:right; font-weight:bold;"><span class="pull-left">'.($discount_percentage?"(" . $discount_percentage . ")" : '').'</span>' . $this->bpas->formatMoney($inv->order_discount) . '</td></tr>';
                    }
                    ?>
...
<!--	<a href="<?=admin_url()?>sales/print_jewwel/<?=$sid?>" target="_blank"><button class="btn btn-primary no-print" ><i class="fa fa-print"></i>&nbsp;<?= lang("print_jewwel_apartment_invoice"); ?></button></a>&nbsp;&nbsp;
	...
	<a href="<?= admin_url('sales'); ?>"><button class="btn btn-warning no-print" ><i class="fa fa-heart"></i>&nbsp;<?= lang("back_to_sale"); ?></button></a>
