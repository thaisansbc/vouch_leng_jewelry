...
<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales/getCustomerBalance/'.($warehouse_id ? $warehouse_id : '')).'/?v=1'.$v ?>',
...
<?php 
   echo admin_form_open('reports/customers_actions/'.($warehouse_id ? $warehouse_id : ''), 'id="action-form"');
?>
<div class="box">
            ...
            <div class="col-lg-12">
				<p class="introtext"><?= lang('list_results'); ?></p>
				 <div id="form">
                            ...
                            <?php echo admin_form_open("sales/customer_balance"); ?>
                            <div class="row">                            
								<div class="col-sm-4">
