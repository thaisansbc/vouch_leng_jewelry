                ...
                <table id="border" border="1" width="100%" >
                    ...
                    <tbody> 
                       ...
                       <tr height="30px">
                             ...
                             <td class="text-center"><?= $this->bpas->formatQuantity($row->quantity) ?></td>
                             <td class="text-center"><?= $this->bpas->formatMoney($row->unit_cost * $row->quantity) ?></td>
                             <td class="text-center"><?= $this->bpas->formatMoney($row->unit_price * $row->quantity) ?></td>
							 <td class="text-center"><?= $this->bpas->formatMoney(($row->unit_price - $row->unit_cost) * $row->quantity) ?></td>
                       </tr> 
					    <?php
                            ...
                            $r++; 
                            // $this->bpas->print_arrays($this->bpas->formatMoney($total_cost));
                        }
                        ?>
                    </tbody>
                    <tfoot> 
					   <tr height="30">
                            ...
                            <td class="text-center"><b><?= $this->bpas->formatQuantity($total_qty) ?></b></td>
                            <td class="text-center"><b><?= $this->bpas->formatMoney($total_cost) ?></b></td>
                            <td class="text-center"><b><?= $this->bpas->formatMoney($total_price) ?></b></td>
							<td class="text-center"><b><?= $this->bpas->formatMoney($profit) ?></b></td>
					   </tr>
                    </tfoot>
                </table>
            </div>
