...
$iss_date=$this->bpas->hrsd($inv->date);

$head='<div class="title"><center style="display:block;"><p style=" font-weight:bold;font-size:50px;margin-top: 0;"><span style="border-bottom:2px solid black;">H . C . H</span></p><p style="font-weight:bold;font-size:20px;"><span style="">RECEIPT</span></p><p style="margin-top:-13px;"><img class="img-b" src="'.admin_url().'assets/images/border-b.PNG"><p></center></div>
...
$table='<table width="100%">
			...
			*/
					...
					*/
					$qty=$row->subtotal!=0?$this->bpas->formatMoney($row->unit_price):$free;
					$amount=$row->subtotal!=0?$this->bpas->formatMoney($row->subtotal):$free;
					...
					$total=$this->bpas->formatMoney($inv->total);	
					$discount=$this->bpas->formatMoney($inv->total_discount);
					$deposit=$this->bpas->formatMoney($inv->total - $inv->paid);
					$paid = $inv->paid ? $this->bpas->formatMoney($inv->paid): 0;
					$sub_total=$this->bpas->formatMoney($inv->grand_total);
...
$tablebtm.='	<tr>
				...
				<tr>
					...
					<td colspan="2" style="text-align:left;border:solid 1px black;height:25px !important;"><b>ប៉ុងចាស់ ' . ($old_invoice_balance_date ? "(" . $this->bpas->hrsd($old_invoice_balance_date) . ")" : "") . '</b></td>
					<td style="border:solid 1px black;text-align:right;height:25px !important;"><b style="font-size:12pt;font-family:Arial;">'. $this->bpas->formatMoney($customer_balance) .' &nbsp;</b></td>
				</tr>
				-->
				<!--
				<tr>
					<td colspan="3" style="border:0 !important;height:25px !important;"></td>
					<td  colspan="2" style="text-align:left;border:solid 1px black;height:25px !important;"><b>ប្រាក់កក់ ' . ($inv->old_paid_date ? "(" . $this->bpas->hrsd($inv->old_paid_date) . ")" : "" ) . '</b></td>
					<td style="border:solid 1px black;text-align:right;height:25px !important;"><b style="font-size:12pt;font-family:Arial;">'.$paid.' &nbsp;</b></td>
				</tr>
				-->
				<!--
				<tr>
					<td colspan="3" style="border:0 !important;height:25px !important;"></td>
					<td  colspan="2" style="text-align:left;border:solid 1px black;height:25px !important;"><b>ទឹកប្រាក់សរុប </b></td>
					<td style="border:solid 1px black;text-align:right;height:25px !important;"><b style="font-size:12pt;font-family:Arial;">'.$this->bpas->formatMoney($grand_total).' &nbsp;</b></td>
				</tr>
				-->
			'	;			
$tablebtmnone='	<tr>
