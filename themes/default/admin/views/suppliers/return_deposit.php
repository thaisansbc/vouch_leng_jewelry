<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open("suppliers/return_deposit/" . $deposit->id, $attrib); ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('amount', set_value('amount', $this->bpas->formatDecimal($deposit->amount)), 'class="form-control" id="amount" required="required"'); ?>
                        </div>
                    </div>
					<div class="form-group">
