<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open("suppliers/edit_deposit/" . $deposit->id, $attrib); ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('date', set_value('date', $this->bpas->hrld($deposit->date)), 'class="form-control datetime" required="required"'); ?>
                        </div>
                    </div>
                    <?php } ?>
