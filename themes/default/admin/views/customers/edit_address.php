    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang('name', 'name'); ?>
                <?= form_input('name', $address->name, 'class="form-control" id="name" required="required"'); ?>
            </div>
            <div class="form-group">
                <?= lang('line1', 'line1'); ?>
            ...
            <div class="form-group">
                <?= lang('phone', 'phone'); ?>
                <?= form_input('phone', $address->phone, 'class="form-control" id="phone" required="required"'); ?>
            </div>
            <div class="form-group">
                <?= lang('city', 'city'); ?>
            ...
            <div class="form-group">
                <?= lang('state', 'state'); ?>
                <?= form_input('state', $address->state, 'class="form-control" id="state"'); ?>
            </div>
            <div class="form-group">
                <?= lang('country', 'country'); ?>
                <?= form_input('country', $address->country, 'class="form-control" id="country"'); ?>
            </div>
            <div class="form-group">
                <?= lang('kilometer', 'kilometer'); ?>
                <?= form_input('kilometer', $address->kilometer, 'class="form-control" id="kilometer"'); ?>
            </div>
        </div>
