...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('customers/import_csv_new', $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>

            <div class="well well-small">
                <a href="<?php echo base_url(); ?>assets/csv/excel_sample002.csv" class="btn btn-primary pull-right"><i
