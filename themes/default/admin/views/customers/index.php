...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            {column_number: 11, filter_default_label: "[<?=lang('zone');?>]", filter_type: "text", data: []},
        ], "footer");
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('customers/add'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal" id="add">
                        ...
                        <li>
                            <a href="<?= admin_url('customers/import_csv_new'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-hover table-striped w-auto">
                        <thead>
                        <tr class="primary">
                            ...
                            <th><?= lang('zone'); ?></th>
                            <th style="min-width:145px !important;"><?= lang('actions'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                        ...
                        <tr class="active">
                            ...
                            <th style="min-width:145px !important;" class="text-center"><?= lang('actions'); ?></th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
