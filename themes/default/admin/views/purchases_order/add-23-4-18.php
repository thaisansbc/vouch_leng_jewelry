    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("purchases_order/add/" . $inv->id, $attrib)
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', $ponumber, 'class="form-control input-tip" required="required"'); ?>
								<input type="hidden" name="reference_purchase_no" value="<?php echo (isset($_POST['reference_no']) ? $_POST['reference_no'] : $purchase->reference_no);?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4" style="display: none;">
                            <div class="form-group">
                                ...
                                echo form_dropdown('status', $post, (isset($_POST['status']) ? $_POST['status'] : $purchase->status), 'class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("status") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
