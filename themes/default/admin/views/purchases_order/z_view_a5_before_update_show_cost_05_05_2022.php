                                ...
                                <thead>
                                    <tr>
                                        ...
                                        if ($Settings->tax1 && $inv->product_tax > 0) {
                                            echo '<th style="text-align: right; vertical-align: middle;">' . lang("tax") . '</th>';
                                        }
                                        if ($Settings->product_discount != 0 && $inv->product_discount != 0) {
                                            echo '<th style="text-align: right; vertical-align: middle;">' . lang("discount") . '</th>';
                                        }
                                        ?>
                                        <th style="text-align: right;"><?= lang("total_usd"); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
