    ...
    <div class="row">
        <div class="col-lg-12">
           ...
           <?php
            ...
            <h2 align="center"><strong>PURCHASE</strong></h2>
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                        <div style="text-align: right; padding-right: 60px;"><strong><?php echo $this->lang->line("purchases_no"); ?> : </strong> 
                                    <?= $inv->reference_no; ?>
                        </div>
                        <div style="text-align: right; padding-right: 60px;">   <strong><?php echo $this->lang->line("date"); ?> : </strong> 
                                    <?= $inv->date; ?>
                        </div>
                </div>
            </div><br/>
            <!-- <div class="row">
                <div class="col-xs-6">
                    <table>
                        <tr>
                            <td style="text-align: center;"><?php echo lang('vendor'); ?></td>
                        </tr>
                        <tr>
                            <td>
                                    <strong><?php echo $this->lang->line("name"); ?> : </strong><?= $supplier->company ? $supplier->company : $supplier->company; ?><br/>
                                    <strong><?php echo $this->lang->line("Attn"); ?> : </strong> <?= $supplier->name ? $supplier->name : $supplier->name; ?><br/>
                                    <strong><?php echo $this->lang->line("address"); ?> : </strong><?= $supplier->address; ?><br/>
                                    <strong><?php echo $this->lang->line("city"); ?> : </strong> <?= $supplier->city; ?><br/>
                                    <strong><?php echo $this->lang->line("phone"); ?> : </strong><?= $warehouse->phone; ?>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-6">
                    <table>
                        <tr>
                            <td style="text-align: center;"><?php echo lang('ship_to'); ?></td>
                        </tr>
                        <tr>
                            <td>
                                    <strong><?php echo $this->lang->line("name"); ?> : </strong><?= $warehouse->name; ?><br/>
                                    <strong><?php echo $this->lang->line("Attn"); ?> : </strong><br/>
                                    <strong><?php echo $this->lang->line("address"); ?> : </strong><?php echo strip_tags($warehouse->address); ?><br/>
                                    <strong><?php echo $this->lang->line("city"); ?> : </strong><br/>
                                    <strong><?php echo $this->lang->line("phone"); ?> : </strong><?= $supplier->phone; ?>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <!-- <div class="col-xs-4 order-right">
