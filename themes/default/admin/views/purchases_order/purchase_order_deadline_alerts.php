...
<script>
    $(document).ready(function() {
        oTable = $('#POData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('purchases_order/purchase_order_deadline_alert/' . ($warehouse_id ? '/' . $warehouse_id : '')) . '/?v=1' . $v ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('purchase_order') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            ...
                            <?php
                                foreach ($warehouses as $warehouse) {
                                    echo '<li ' . ($warehouse_id && $warehouse_id == $warehouse->id ? 'class="active"' : '') . '><a href="' . admin_url('purchases_order/index/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                }
                                ?>
                        </ul>
                    </li>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php
                    echo admin_form_open("purchases_order/purchase_order_alerts");
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                foreach ($projects as $project) {
                                    $bl[$project->project_id] = $project->project_code != '-' ? $project->project_code : $project->project_code;
                                }
