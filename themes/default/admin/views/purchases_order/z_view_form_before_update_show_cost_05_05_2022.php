            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">    
                        ...
                        <li>
                            <a href="<?= admin_url('purchases_order/excel_export/' . $inv->id) ?>">
        ...
        <div class="row">
         ...
         <div class="row" style="font-weight: bold;">
            ...
            <div class="col-lg-4">
                <table width="100%">
                    <tr>
                        <td><?php echo $this->lang->line("refer"); ?></td>
            ...
            <div class="col-lg-12">
                <div class="well-sm">
                    ...
                    <table style="border-radius: 10px; border: 2px solid #000000; border-collapse: separate !important; width: 48%; font-weight: bold;">
                        ...
                        <tr>
                            <td style="width: 25%; padding-left: 5px;"><?= lang('name'); ?></td>
                            <td style="width: 75%;">: <?= $this->Settings->site_name; ?></td>
                        </tr>
                        <tr>
                            <td style="width: 25%; padding-left: 5px;"><?= lang('Attn'); ?></td>
                        ...
                        <tr>
                            <td style="width: 25%; padding-left: 5px;"><?= lang('address'); ?></td>
                            <td style="width: 75%;">: <?= $this->bpas->remove_tags($warehouse->address); ?></td>
                        </tr>
                        <tr>
                            <td style="width: 25%; padding-left: 5px;"><?= lang('phone'); ?></td>
                            <td style="width: 75%;">: <?= $warehouse->phone; ?></td>
                        </tr>
                    </table>                    
                </div>
