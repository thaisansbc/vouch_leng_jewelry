				...
				foreach($kitchen_note as $note_order){
					...
					echo '<div class="table_display">';
						echo '<div class="'.$class.' sus_sale" room="'.$note_order->note_id.'" room_name="'.$note_order->name.'"	sid="'.$note_order->id.'" price="'.$note_order->price.'" discount="'.$note_order->amount.'">';
							...
							if($note_order->suspend_note){
								if($note_order->type =="room"){
                                    echo '<img alt="" src="'.base_url().'assets/uploads/table/room_close.png">';
								}elseif($note_order->type =="table"){
                                    echo '<img alt="" src="'.base_url().'assets/uploads/table/table_close.png">';
                                }else{
									echo '<img alt="" src="'.base_url().'assets/uploads/table/bungalow-close.png">';
								}
							}else{
                                if($note_order->type =="room"){
                                    ...
                                    echo '<img alt="" src="'.base_url().'assets/uploads/table/table.png">';
                                }else{
                                    echo '<img alt="" src="'.base_url().'assets/uploads/table/bungalow.png">';
                                }
							}
					echo '</div>';
						if($note_order->suspend_note){
