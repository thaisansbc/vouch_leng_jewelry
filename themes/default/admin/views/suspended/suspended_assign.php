...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#STData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('table/getSuspendedAssign'.($warehouse_id ? '/index/'.$warehouse_id : '')) ?>',
        ...
        <ul class="btn-tasks">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                    <li><a href="<?= admin_url('table/add_assign'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_assign') ?></a></li>
