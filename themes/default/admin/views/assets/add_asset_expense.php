    ...
    $(document).ready(function() {
        ...
        $("#add_item").autocomplete({
            ...
            source: function(request, response) {
                $.ajax({
                    type: 'get',
                    url: '<?= admin_url('purchases/AssetSuggestions'); ?>',
                    dataType: "json",
                    data: {
                        term: request.term,
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_expense_asset'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($orderid)) {
                    echo admin_form_open_multipart("purchases/add_asset_expense/" . $orderid, $attrib);
                } else {
                    echo admin_form_open_multipart("purchases/add_asset_expense", $attrib);
                }
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                $pst = ['due' => lang('due')];
                                echo form_dropdown('expenses_type', $pst, '', 'class="form-control input-tip" required="required" id="slpayment_status"'); ?>

                            </div>
                        </div>
                        <div class="col-md-4" id="payments" style="display: none;">
                            <div class="form-group bank_pay">
