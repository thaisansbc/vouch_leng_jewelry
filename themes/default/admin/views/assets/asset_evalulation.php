...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?= lang('add_depreciation'); ?></h4>
        </div>
        <?php echo admin_form_open('assets/add_depreciation/' . $product->id); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
        			<div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('date', date('d/m/Y'), 'id="date" class="form-control date" required="required"'); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('cost', $product->grand_total, 'id="cost" readonly="readonly" class="form-control" required="required"'); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php 
        					$created_date = date("Y", strtotime($product->date));

                            // depreciation 1/year = (cost - residual_value) / useful_life;

                            $current_cost1 =  $this->bpas->formatDecimal((($product->grand_total - $product->residual_value) / $product->useful_life)/12);
                ...
                <div class="col-md-6 hide">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('created_date', $product->date, 'id="created_date" readonly="readonly" class="form-control" required="required"'); ?>
                        </div>
                    </div>
               </div>
                ...
                <div class="col-sm-6" id="bank_acc1">
                    <div class="form-group">
                        <?= lang("Depreciation Expense", "bank_charge"); ?>
                        <?php
