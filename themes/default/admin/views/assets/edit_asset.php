...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_asset'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('assets/edit/' . $product->id, $attrib);
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        <?= lang('serial', 'barcode') ?>
                            <?= form_input('barcode', (isset($_POST['barcode']) ? $_POST['barcode'] : ($product ? $serial_numver : '')), 'class="form-control" id="barcode" ') ?>
                    </div>
                    ...
                    <div class="form-group standard">
                        ...
                        <div
                            class="input-group"> <?= form_input('alert_quantity', (isset($_POST['alert_quantity']) ? $_POST['alert_quantity'] : ($product ? $this->bpas->formatDecimal($product->alert_quantity) : '')), 'class="form-control tip" id="alert_quantity"') ?>
                ...
                <div class="col-md-6 col-md-offset-1 hide">
                    <div class="standard">
                        <div>
                            <?php
                    ...
                    <div class="combo" style="display:none;">
                        ...
                        <div class="form-group">
                            <?= lang('add_asset', 'add_item') . ' (' . lang('not_with_variants') . ')'; ?>
                        ...
                        <div class="control-group table-group">
                            <label class="table-label" for="combo"><?= lang('combo_asset'); ?></label>
                            <!--<div class="row"><div class="ccol-md-10 col-sm-10 col-xs-10"><label class="table-label" for="combo"><?= lang('combo_asset'); ?></label></div>
                            ...
                            <div class="controls table-controls">
                                <table id="prTable"
                                    ...
                                    <thead>
                                    <tr>
                                        <th class="col-md-5 col-sm-5 col-xs-5"><?= lang('asset') . ' (' . lang('code') . ' - ' . lang('name') . ')'; ?></th>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <?php echo form_submit('edit_asset', $this->lang->line('edit_asset'), 'class="btn btn-primary"'); ?>
                    </div>
        ...
        $("#add_item").autocomplete({
            ...
            response: function (event, ui) {
                if ($(this).val().length >= 16 && ui.content[0].id == 0) {
                    //audio_error.play();
                    bootbox.alert('<?= lang('no_asset_found') ?>', function () {
                        $('#add_item').focus();
                    });
                    $(this).val('');
                }
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                    ...
                    //audio_error.play();
                    bootbox.alert('<?= lang('no_asset_found') ?>');
                }
            }
        });
        $('#add_item').removeAttr('required');
