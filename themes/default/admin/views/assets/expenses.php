...
<script>
    $(document).ready(function() {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('assets/getExpenses'); ?>',
            ...
            {
                column_number: 5,
                filter_default_label: "[<?= lang('amount'); ?>]",
                filter_type: "text",
                data: []
            },
            {
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('assets/add_expense') ?>">
                    ...
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped">
                        <thead>
                            <tr class="active">
                                ...
                                <th class="col-xs-2"><?= lang('asset'); ?></th>
                                <th class="col-xs-2"><?= lang('depreciation_expense'); ?></th>
                                <th class="col-xs-2"><?= lang('accumulate'); ?></th>
