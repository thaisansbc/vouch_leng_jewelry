...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('assets/asset_expense/' . $inv->id, $attrib); ?>
                ...
                ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?= lang('date', 'date'); ?>
                            <?= form_input('date',$this->bpas->hrld($inv->evaluation_date), 'class="form-control datetime" required="required"'); ?>
                        </div>
                    </div>
                <?php
                //} 
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="bank_acc">
                                <div class="form-group">
                                    <?= lang("depreciation_expense", "depreciation"); ?>
                                    <?php
                                   // $bankAccounts =  $this->site->getAllBankAccounts();
                                        ...
                                        echo form_dropdown('expense_account', $bank1, $inv->dp_account, 'id="bank_account_1" class="ba form-control kb-pad bank_account" required="required" data-bv-notempty="true"');
                                    ?>
                                </div>
                            </div>
                            <div class="col-sm-6" id="bank_acc1">
                                <div class="form-group">
                                    ...
                                    <?php
                                        ...
                                        echo form_dropdown('asset_account', $bank, $inv->acc_account, 'id="bank_charge" class="ba form-control kb-pad" required="required" data-bv-notempty="true"');
