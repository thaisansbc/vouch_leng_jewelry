...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#add_item").autocomplete({
            source: '<?= admin_url('purchases/AssetSuggestions'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 250,
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_expense_asset'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('purchases/edit_asset_expense/' . $inv->id, $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('biller', $bl, (isset($purchase->biller_id) ? $purchase->biller_id : $this->Settings->default_biller), 'class="form-control" id="posbiller" required="required"');
                                ?>
                            </div>
                        </div>
                        <?php /*} else {
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input('useful',$purchase->useful_life, 'id="useful" class="form-control" required="required"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input('residual_value',$purchase->residual_value, 'id="residual_value" class="form-control" required="required"'); ?>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="col-md-4">
                            <div class="form-group bank_pay" style="margin:0px;">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('bank_account', $bank,$purchase->bank_account, 'id="bank_account_1" class="ba form-control kb-pad bank_account" data-bv-notempty="true"');
                                    ?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang('expenses_type', 'expenses_type'); ?>
                                <?php 
                                //$pst = ['due' => lang('due'),'paid' => lang('paid')];
                                $pst = ['due' => lang('due')];
                                echo form_dropdown('expenses_type', $pst, $purchase->expenses_type, 'class="form-control input-tip" required="required" id="slpayment_status"'); ?>

                            </div>
                        </div>
                        <div class="col-md-4" id="payments" <?= ($purchase->expenses_type == "paid") ? ' ':'style="display: none;"';  ?> ?>
                            <div class="form-group bank_pay" style="margin:0 5px;">
                                ...
                                echo form_dropdown('paid_by', $acc_section, $purchase->bank_code, 'id="paid_by"  class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("paid_by") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
