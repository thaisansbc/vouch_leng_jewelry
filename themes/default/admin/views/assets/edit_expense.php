...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i>
            <?php echo lang('edit_expense_asset'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('assets/edit_expense/'.$expense->id, $attrib)
                ?>
                    <?php if ($Owner || $Admin) {
                    ?>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <?= lang('date', 'date'); ?>
                            <?= form_input('date', $this->bpas->hrld($expense->date), 'class="form-control datetime" required="required"'); ?>
                        </div>
                    </div>
                    <?php
                    } ?>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <?= form_input('reference',$expense->reference , 'class="form-control tip" id="reference"'); ?>
                        </div>
                    </div>
                    <?php if ($Owner || $Admin) { ?>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            echo form_dropdown('biller', $bl,$expense->biller_id , 'class="form-control" id="posbiller" required="required"');
                            ?>
                        </div>
                    </div>
                    <?php } else {
                        ...
                        <div class="col-sm-4 hide">
                            <div class="form-group">
                                ...
                                <div class="input-group" style="width:100%">
                                    ...
                                    echo form_dropdown('warehouse', $wh, $expense->warehouse_id, 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . lang('select') . ' ' . lang('warehouse') . '" required="required" style="width:100%;" '); ?>
                                </div>
                            </div>
                        </div>
                    <?php } else {
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <?php echo form_input('useful',$expense->useful_life, 'id="useful" class="form-control" required="required"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <?php echo form_input('residual_value',$expense->residual_value, 'id="residual_value" class="form-control" required="required"'); ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group bank_pay" style="margin:0 5px;">
                                        ...
                                        echo form_dropdown('asset_name', $asset1, $expense->product_id, 'id="asset_name" class="ba form-control kb-pad bank_account"');
                                        ?>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group bank_pay" style="margin:0 5px;">
                                        ...
                                        <input name="quantity" type="text" id="quantity" value="<?= $expense->qty;?>" class="form-control kb-pad amount" required="required" />
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group bank_pay" style="margin:0 5px;">
                                        <?= lang('cost', 'purchase_cost'); ?>
                                        <input name="amount" type="text" id="amount" value="<?= $expense->cost;?>" class="form-control kb-pad amount" required="required" />
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group bank_pay" style="margin:0px;">
                                        ...
                                        <?php
                                            ...
                                            echo form_dropdown('bank_account', $bank,$expense->bank_account, 'id="bank_account_1" class="ba form-control kb-pad bank_account" data-bv-notempty="true"');
                                            ?>
                                    </div>
                                </td>
                                <td>
                ...
                <div class="col-md-12">
                    <div class="from-group"><?php echo form_submit('edit_expense', $this->lang->line('submit'), 'id="edit_expense" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
