...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('import_products_by_excel'); ?></h2>
</div>
<div class="box">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('products/import_excel', $attrib)
                ?>
                <div class="row">
                    <div class="col-md-12">

                        <div class="well well-small">
                            <a href="<?php echo base_url(); ?>assets/excel/sample_products.xlsx"
                               class="btn btn-primary pull-right"><i
                                    class="fa fa-download"></i> <?= lang('download_sample_file') ?></a>
                            <p>
                                <span class="text-warning"><?= lang('csv1'); ?></span><br/><?= lang('csv2'); ?> <span
                                class="text-info">(<?= lang('name') . ', ' . lang('code') . ', '.lang('seriel'). ', '.lang('max_serial'). ', '. lang('barcode_symbology') . ', ' . lang('brand') . ', ' . lang('category_code') . ', ' . lang('unit_code') . ', ' . lang('sale') . ' ' . lang('unit_code') . ', ' . lang('purchase') . ' ' . lang('unit_code') . ', ' . lang('cost') . ', ' . lang('price') . ', ' . lang('alert_quantity') . ', ' . lang('tax') . ', ' . lang('tax_method') . ', ' . lang('image') . ', ' . lang('subcategory_code') . ', ' . lang('product_variants_sep_by') . ', ' . lang('pcf1') . ', ' . lang('pcf2') . ', ' . lang('pcf3') . ', ' . lang('pcf4') . ', ' . lang('pcf5') . ', ' . lang('pcf6') . ', ' . lang('hsn_code') . ', ' . lang('second_name'); ?>
                                )</span> <?= lang('csv3'); ?>
                            </p>
