...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('reward_ring_money'); ?></h2>
</div>
<div class="box">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="control-group table-group">
                                <label class="table-label"><?= lang('ring'); ?> *</label>
                                    ...
                                    <table id="qaTable" class="table items table-striped table-bordered table-condensed table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php } ?> 
                                                <th class="col-md-2"><?= lang('interest'); ?></th>
                                                <th class="col-md-2"><?= lang('type'); ?></th>
                                                <th class="col-md-1"><?= lang('money'); ?></th>
                                                <?php
