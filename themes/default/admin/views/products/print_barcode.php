                        ...
                        if (!empty($barcodes)) {
                            ...
                            foreach ($barcodes as $item) {
                                for ($r = 1; $r <= $item['quantity']; $r++) {
                                    echo '<div class="item size30 style' . $style . '" ' .
                                    ...
                                    if ($item['category']) {
                                        echo '<span class="barcode_category" style="font-size:10px">' . lang('category') . ': ' . $item['category'] . '</span> ';
                                    }
                                    if ($item['variants']) {
                                    ...
                                    if ($style == 50) {
                                        echo '<span class="barcode_image"><img src="' . admin_url('products/barcode/' . $item['barcode'] . '/' . $item['bcs'] . '/' . $item['bcis']) . '" alt="' . $item['barcode'] . '" class="bcimg" style="width:' . $this->input->post('cf_width') . 'in;height:' .     $this->input->post('cf_height') . 'in;"/></span>';
                                    } else {
