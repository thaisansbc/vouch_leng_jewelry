                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang('date', 'qadate'); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->bpas->hrld($adjustment->date)), 'class="form-control input-tip datetime" id="qadate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-4">
                        ...
                        <?php if (($Admin || $Owner) || empty($user_billers)) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $adjustment->biller_id), 'class="form-control" id="qabiller" required="required"');
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="clearfix"></div>
                            ...
                            <div class="clearfix"></div>
                            <div class="col-md-12">
                            <div class="fprom-group"><?php echo form_submit('edit_adjustment', lang('submit'), 'id="edit_adjustment" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
