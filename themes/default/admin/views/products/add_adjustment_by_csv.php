                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="well well-small">
                                <?php $file = ($Settings->product_expiry ? 'sample_adjustments_expiry.csv' : 'sample_adjustments.csv'); ?>
                                <a href="<?php echo base_url() . 'assets/csv/' . $file; ?>" class="btn btn-primary pull-right">
