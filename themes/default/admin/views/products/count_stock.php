    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php $user_warehouses = explode(',', $this->session->userdata('warehouse_id')); ?>
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang('date', 'date'); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->bpas->hrld(date('Y-m-d H:i:s'))), 'class="form-control input-tip" id="date" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-4">
