...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_adjustment_by_excel'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('products/add_adjustment_by_excel', $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                        ...
                        <div class="col-md-12">
                            <div class="well well-small">
                                ...
                                <?php $file = ($Settings->product_expiry ? 'sample__adjustments.xlsx' : 'sample_adjustments.xlsx'); ?>
                                <a href="<?php echo base_url() . 'assets/excel/' . $file; ?>" class="btn btn-primary pull-right">
                                    <i class="fa fa-download"></i> <?= lang('download_sample_file') ?>
                                </a>
                                <span class="text-warning"><?= lang('csv1'); ?></span><br/><?= lang('csv2'); ?> 
                                <span class="text-info">(<?= lang('product_code') . ', ' . lang('quantity') . ', ' . lang('variant'); ?>)</span> <?= lang('csv3'); ?><br>
                                <strong><?= lang('quantity_colum_tip'); ?></strong>
                            </div>
                            <div class="form-group">
                                <label for="userfile"><?= lang('upload_file'); ?></label>
                                <input type="file" data-browse-label="<?= lang('browse'); ?>" name="userfile" class="form-control file" data-show-upload="false" data-show-preview="false" id="userfile" required="required"/>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                            <div class="col-md-12">
