    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("products/add_consignment", $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                                    ...
                                    <div class="input-group wide-tip">
                                        ...
                                        <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                                            <a href="#" id="addManually" class="tip"
                                               title="<?= lang('add_product_manually') ?>"><i class="fa fa-2x fa-plus-circle addIcon" id="addIcon"></i></a></div>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                        ...
                        <div class="col-sm-12">
                            <div class="fprom-group"><?php echo form_submit('add_consignment', $this->lang->line("submit"), 'id="add_consignment" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
