...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_prescription'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('sales_order/add_prescription', $attrib);
                if ($quote_id) {
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('diagnosis',$field, (isset($_POST['diagnosis']) ? $_POST['diagnosis'] : ''), 'class="form-control select" id="diagnosis"'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
