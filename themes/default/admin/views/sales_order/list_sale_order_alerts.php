...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sales_order/getSaleOrderAlerts' . ($warehouse_id ? '/' . $warehouse_id : '')) . '/?v=1' . $v ?>',
			"bAutoWidth": false,
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.className = "invoice_order_link re" + aData[12];
...
<?php
    echo form_open('sales_order/sale_order_actions' . ($warehouse_id ? '/'.$warehouse_id : ''), 'id="action-form"');
?>
<div class="box">
    <div class="box-header">
        ...
        <?php } else { ?>
            <h2 class="blue">
                <i class="fa-fw fa fa-barcode"></i>
                <?= lang('list_sale_order_alerts') . ' (' . lang('all_warehouses') . ')'; ?>
            </h2>
        <?php } ?>
		<div class="box-icon">
            <ul class="btn-tasks">
                ...
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('sales_order/sale_order_alerts')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                                foreach ($warehouses as $warehouse) {
                                    echo '<li><a href="' . admin_url('sales_order/sale_order_alerts/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                }
                            ?>
                        </ul>
                    </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						<?php if ($Owner || $Admin || $GP['sale_order-add']) { ?>
							<li>
								<a href="<?= admin_url('sales_order/add_sale_order')?>">
									<i class="fa fa-plus-circle"></i> <?=lang('add_sale_order')?>
								</a>
							</li>
						<?php } ?>
						<?php if ($Owner || $Admin || $GP['sales_order-export']) { ?>
							<li>
						...
						<?php } ?>
						<!-- <?php if($Owner || $Admin || $GP['sales_order-import']) { ?>
							<li>
								<a href="<?= admin_url('sales_order/sale_by_csv'); ?>">
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    <?php echo form_open("admin/sales_order/sale_order_alerts"); ?>
                    <div class="row">
						<div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th style="width: 10%;"><?php echo $this->lang->line("reference_no"); ?></th>
                            <th style="width: 10%;"><?php echo $this->lang->line("project"); ?></th>
                            <th style="width: 10%;"><?php echo $this->lang->line("customer"); ?></th>
							<th style="width: 10%;"><?php echo $this->lang->line("saleman"); ?></th>
							<th style="width: 10%; text-align: center !important;"><?php echo $this->lang->line("sale_status"); ?></th>
                            <th style="width: 10%; text-align: right !important;"><?php echo $this->lang->line("grand_total"); ?></th>
                            <th style="width: 10%; text-align: right !important;"><?php echo $this->lang->line("deposit"); ?></th>
                            <th style="width: 10%; text-align: right !important;"><?php echo $this->lang->line("balance"); ?></th>
                            <th style="width: 10%; text-align: center !important;"><?php echo $this->lang->line("order_status"); ?></th>
