...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('slsaleman_by', '<?= $inv->saleman_by ?>');
        localStorage.setItem('srref', '<?= $inv->reference_no ?>');
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('sales_order/edit_prescription/' . $inv->id, $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['change_date']) { ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="srref" required="required"'); ?>
                            </div>
                        </div>
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                if ($this->session->userdata('group_id') == $Settings->group_saleman_id){
                                                    ...
                                                    echo form_dropdown('saleman_by', $sm, (($inv->saleman_by != "")? $inv->saleman_by : ''), 'id="slsaleman_by" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("saleman") . '" style="width:100%;" ');
                                                } else {
                                                    $sm[''] = '';
                                                    if (!empty($salemans)) {
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('diagnosis',$field,$inv->diagnosis_id, 'class="form-control select" id="diagnosis"'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="controls table-controls">
                                    <table id="slTable"
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                echo '<th class="col-md-2">' . lang('dosage') . '</th>';
                                                echo '<th class="col-md-2">' . lang('duration') . '</th>';
                                            ?>
                                            <th class="col-md-2"><?= lang('description'); ?></th>
                                     
                                            <th style="min-width: 30px !important;max-width: 30px !important; text-align: center;">
                        ...
                        <div class="col-sm-4" style="display: none;">
                            <div class="form-group">
                                ...
                                <?php $sst = ['order' => lang('order'),'pending' => lang('pending'), 'completed' => lang('completed')];
