                ...
                <div class="col-xs-5">
                    <div class="bold">
                        ...
                        <div class="order_barcodes barcode">
                            ...
                            <?php /*echo $this->bpas->qrcode('link', urlencode(admin_url('sales/view/' . $inv->id)), 2);*/ ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
            ...
            <div class="table-responsive">
                ...
                ?>
                    ...
                    foreach ($rows as $row):
                         ...
                         if ($row->sub_qty) {
                             echo '<tr class="active"><td colspan="2" class="text-right">Sub Qty</td><td class="text-center">' . $this->bpas->formatQuantity($qty) . '</td><td colspan="' . ($tcol - 1) . '"></td></tr>';
                             $qty = 0;
                         }
                        endforeach;
                        if ($return_rows) {
                    ...
                    <?php if ($inv->shipping != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang('shipping') . ' (' . $default_currency->code . ')</td><td style="text-align:right;">' . $this->bpas->formatMoney($inv->shipping - ($return_sale && $return_sale->shipping ? $return_sale->shipping : 0)) . '</td></tr>';
                    }
                    ?>
                    <tr>
                        <td colspan="<?= $col; ?>"
