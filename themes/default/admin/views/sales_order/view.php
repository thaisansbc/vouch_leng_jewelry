            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <?php } ?>
                        <li>
                            <a href="<?= admin_url('sales_order/edit/' . $inv->id) ?>" class="sledit">
                        ...
                        <li>
                            <a href="<?= admin_url('deliveries/add/' . $inv->id) ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="text-center"><h1>
                    <?php echo lang('sale_order')?></h1></div>
                    ...
                    <table class="table table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="width: 80px;text-align: center;"> <?= ($inv->sale_status == 'returned' ? $row->base_unit_code : $row->product_unit_name); ?></td>
                  ...
                  <div style="width: 100%;font-size:10.5px;margin-top:-10px;">
                        <table width="100%" style="font-family:khmer os siemreap;">
                            ...
                            foreach($getSignbox as $key => $val){
                                ...
                                $ml = explode('_by', $key);
                                $nl = $ml[0];
                                $getApproved = $this->site->getApprovedByuser('so',$inv->id,$nl,$val);
                                $approved_by = $nl.'_by';
