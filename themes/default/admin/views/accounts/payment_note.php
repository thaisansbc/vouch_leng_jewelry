...
*/
            ...
            <div class="row">
                <div class="col-sm-5" style="float:left;">
					...
					<p><b><?= lang("date"); ?></b>: <?= $this->bpas->hrsd($payment->date); ?></p>
				...
				<table class="table receipt">
					...
					<tbody>
						...
						foreach($rowpay as $row){
							...
							echo '<td class="text-right">' . ($this->bpas->formatMoney($row->amount)) . '</td>';
							$no++;
							$payments += $row->amount;
						}
						?>
					...
					<tfoot>
						<tr>
							...
							<th class="text-right"><?=  $this->bpas->formatMoney($payments); ?></th>
						</tr>
			...
			<p>Amount In Word: <?=$this->bpas->convert_number_to_words($payments)?> US Dollar Only</p>
            ...
            <div class="clearfix"></div>
			 <div class="buttons">
                <div class="btn-group">
					<a href="<?= admin_url('account/bill_reciept_form/' . $payment->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('invoice') ?>">
						<i class="fa fa-print"></i>
						<span class="hidden-sm hidden-xs"><?= lang('invoice') ?></span>
					</a>
				</div>
				<div class="btn-group">
					<a href="<?= admin_url('account/bill_reciept_tps/' . $payment->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('invoice') ?>">
						<i class="fa fa-print"></i>
