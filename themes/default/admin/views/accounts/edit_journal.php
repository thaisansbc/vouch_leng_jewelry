...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("account/updateJournal", $attrib); ?>
			...
			<div class="col-md-12">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<?php 
						 if ($Owner || $Admin) { 
							echo form_input('reference_no', $journal1->reference_no, 'class="form-control" id="reference_no" '); 
						}else{
							echo form_input('reference_no', $journal1->reference_no, 'class="form-control" readonly="readonly" id="reference_no" '); 
						}
						?>
					...
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="form-group">
								...
								// $type_l["payment"] = "Payment Voucher";
								// $type_l["receipt"] = "Receipt Voucher";
						...
						<div class="col-md-4">
								...
								<?php if ($Owner || $Admin) { ?><div class="input-group"><?php } ?>
									...
									<div class="input-group-addon no-print" style="padding: 2px 5px;"><a
											href="<?= admin_url('system_settings/add_subcategory'); ?>" id="add-supplier"
			...
			<div class="col-md-12">
				<div class="col-md-12">
					<div class="form-group">
						...
						<?= form_textarea('description', strip_tags($journal1->note), 'class="form-control" id="description" '); ?>
					</div>
				</div>
			...
			?>
				...
				<div class="col-md-12 journal-list">
					...
					<div class="col-md-3">
						<div class="form-group margin-b-5">	
							<?php echo form_input('note[]', ($description != '' ? $description : $journal->description), 'class="form-control note'. $n .'" id="note"'); ?>
						</div>
					</div>
					
					<div class="col-md-2">
						<div class="form-group margin-b-5">	
							<?php echo form_input('debit[]', $this->bpas->formatDecimal($journal->debit), 'class="form-control debit'. $n .' number_only" id="debit"'); ?>
						</div>
					</div>
					
					<div class="col-md-2">
						<div class="form-group margin-b-5">
							<?php echo form_input('credit[]', $this->bpas->formatDecimal($journal->credit), 'class="form-control credit'.$n .' number_only" id="credit"'); ?>
						</div>
					</div>
					<div class="col-md-1">
						<div class="form-group margin-b-5">
				...
				<div class="col-md-6">
					<div class="col-md-offset-9">
						<div class="form-group">
							<label id="calDebit"><?=$this->bpas->formatMoney($debit)?></label>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="col-md-offset-4">
						<div class="form-group">
							<label id="calCredit" style="margin-left:18px !important"><?=$this->bpas->formatMoney($credit)?></label>
						</div>
					</div>
				</div>
	 ...
	 var v = $(this).val();
            ...
            if (v) {
                $.ajax({
                    type: "get",
                    async: false,
                    url: "<?= admin_url('account/getpeoplebytype') ?>/" + v,
                    dataType: "json",
	 ...
	 var v = $(this).val();
            ...
            if (v) {
                $.ajax({
                    type: "get",
                    async: false,
                    url: "<?= admin_url('account/getCustomerInvoices') ?>/" + v,
                    dataType: "json",
                    success: function (scdata) {
