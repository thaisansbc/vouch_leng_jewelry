...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('account/getBillPaymentReport/?v=1' . $v) ?>',
...
<?php if ($Owner) {
    echo admin_form_open('reports/bill_payable_actions', 'id="action-form"');
} ?>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("account/billPayable"); ?>
                    <div class="row">
                        <div class="col-sm-4">
