    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#DepData').dataTable({
                ...
                'sAjaxSource': '<?= admin_url('account/getDeposits/') ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
    echo admin_form_open('account/deposits_action', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('quotes/add_deposit'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal" id="add">
