...
<head>
    <meta charset="UTF-8">
    <title><?= lang("ap_aging_form") ?></title>
...
<body>
                                    ...
                                    <table class="table" style="width: 100%; margin-top: 5px;">
                                        <thead style="border: 1px solid #000000 !important; font-size: 12px;">
                                            <tr style="border: 1px solid #000000 !important; background-color: #5DADE2 !important;">
                                                <th colspan="100%" style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important; font-size: 14px;"><?= lang('account_payable'); ?></th>
                                            </tr>
                                            <tr style="border: 1px solid #000000 !important; background-color: #5DADE2 !important;">
                                                <th style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important; width: 10px;"><?= lang('no'); ?></th>
                                                <th style="text-align: left !important; border: 1px solid #000000 !important; line-height: 12px !important; width: 20%;"><?= lang('supplier_name'); ?></th>
                                        ...
                                        <tbody style="font-size: 12px;" class="content-print">
                                            ...
                                            $total_91_over = 0;
                                            $total_balance = 0;
                                            foreach ($ap_aging as $key => $supplier) { 
                                                $total_current += $supplier->balance_current;
                                                $total_1_30    += $supplier->balance_1_30;
                                                $total_31_60   += $supplier->balance_31_60;
                                                $total_61_90   += $supplier->balance_61_90;
                                                $total_91_over += $supplier->balance_91_over;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: left !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $supplier->supplier_name; ?></td>
                                                    <td style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $this->bpas->formatMoney($supplier->balance_current); ?></td>
                                                    <td style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $this->bpas->formatMoney($supplier->balance_1_30); ?></td>
                                                    <td style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $this->bpas->formatMoney($supplier->balance_31_60); ?></td>
                                                    <td style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $this->bpas->formatMoney($supplier->balance_61_90); ?></td>
                                                    <td style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $this->bpas->formatMoney($supplier->balance_91_over); ?></td>
                                                    <td style="text-align: center !important; border: 1px solid #000000 !important; line-height: 12px !important;"><?= $this->bpas->formatMoney($supplier->total_balance); ?></td>
                                                </tr>
                                            <?php } ?>
    ...
    <div style="width: 821px; margin: 15px auto;">
        <a class="btn btn-warning no-print" href="<?= admin_url('account/list_ap_aging'); ?>">
