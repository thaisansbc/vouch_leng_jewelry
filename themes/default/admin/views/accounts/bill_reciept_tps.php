			...
			<div class="row">
				...
				<div class="col-lg-5 col-sm-5 col-xs-5">
					<table width="100%">
						...
						<td style="text-align:right; color:#8B0000; font-size:12px"><strong><?= $this->bpas->hrsd($payment->date); ?></strong></td>
						</tr>
					</table>
				</div>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><?= $this->bpas->formatMoney($row->amount) ?></td>
						</tr>
						<?php
							$no++;
							$totalRows++;
						...
						<tr style="border-top:4px double #000">
							<td colspan="3">
								...
								<p style="line-height: 1 !important"><?=  ucwords($this->bpas->convert_number_to_words($payments)); ?> US Dollar Only</p>
							</td>
							<th class="text-center"><?= lang("total"); ?></th>
							<th class="text-center">$<?=  $this->bpas->formatMoney($payments); ?></th>
						</tr>
					</tbody>
				</table>
				</div>
