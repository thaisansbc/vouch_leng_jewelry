...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem("jndate", "<?= $this->bpas->hrld($enter_journal->date); ?>");
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("account/edit_enter_journal/".$enter_journal->id, $attrib);
                ?>
                        ...
                        <?php if ($Owner || $Admin || $GP['accountings-enter_journals-date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "jndate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->bpas->hrld($enter_journal->date)), 'class="form-control input-tip datetime" id="jndate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
...
<script type="text/javascript">
	$(function(){
		...
		function biller(){
			...
			$.ajax({
				url : "<?= admin_url("account/get_project") ?>",
				type : "GET",
				dataType : "JSON",
