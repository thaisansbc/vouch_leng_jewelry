<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-th-large"></i><?= lang('balance_sheet_by_period'); ?>
			<?php
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/balance_sheet_by_period"); ?>
                    ...
                    <div class="row">
						...
						<div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : date('01/m/Y')), 'class="form-control date" id="start_date"'); ?>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
