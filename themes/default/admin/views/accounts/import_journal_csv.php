<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("account/import_journal_csv", $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?> </p>

            <div class="well well-small">
                <a href="<?php echo admin_url(); ?>assets/csv/sample_journal.csv" class="btn btn-primary pull-right"><i
