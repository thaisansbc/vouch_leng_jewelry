        ...
        <div class="modal-body">
            ...
            <div class="relative">
                <header>
                    ...
                    <div>
                        <img class="barcodes"
                            src="<?= admin_url('misc/barcode/' . $this->bpas->base64url_encode($inv->reference_no) . '/code128/74/0/1'); ?>"
                ...
                <div class="info" style="display: flex; justify-content: space-between;">
                    <div style="width: 40%;  padding-left: 10px;">
                        <strong style=" padding: 0 ; margin: 0;"><?= lang('supplier_info') ?></strong>
                        <table style="margin-left:0px;   font-family: 'Khmer OS Siemreap', sans-serif;">
                          ...
                          max-width: 250px;
                          display: inline-block; "><strong><?= $supplier->name ?></strong></td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap;
                                          vertical-align: top;
                                ...
                                <td style="
                                        ...
                                        if (
                                            // empty($supplier->no) &&
                                            empty($supplier->street_no) &&
                                            empty($supplier->village) &&
                                            empty($supplier->commune) &&
                                            empty($supplier->district) &&
                                            empty($supplier->city)
                                        ) {
                                            echo strip_tags($supplier->cf6);
                                        } else {
                                            echo $supplier->no . ', ' .
                                                $supplier->street_no . ', ' .
                                                $supplier->village . ', ' .
                    ...
                    <div style="width: 40%; ">
                        ...
                        <table style="margin-left:0px;   font-family: 'Khmer OS Siemreap', sans-serif;">
                            <tr>
                                <td style="white-space: nowrap;vertical-align: top;"><?= lang('debit_note_no') ?>:</td>
                                <td style="word-wrap: break-word;max-width: 250px;display: inline-block; ">
                                    <strong><?= $inv->reference_no?></strong></td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap;
                                      vertical-align: top;
                                      "><?= lang('debit_note_date') ?>:</td>
                                <td style="
                                          word-wrap: break-word; 
                                          max-width: 250px;
                                          display: inline-block; "><strong>
                                        <?= date("d-M-Y", strtotime($inv->date)) ?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td><?= lang('subject')?>:</td>
                ...
                <table class="table table-hover table-striped dataTable">
                    ...
                    <tbody>
                        <?php $no = 1; $erow = 1; $totalRow = 0; $unit_cost = 0 ;
                        ...
                        ?>
                            ...
                            <td><?= $this->bpas->formatMoney($row->unit_cost); ?></td>
                        </tr>
                ...
                <div class="position">
                    ...
                    <div class="hide">
                        <fieldset style="  border: 2px solid #0855a1 ; border-radius: 10px; ">
                            ...
                            <?php 
                                // if ($inv->bank_info) {
                                //     $documents = html_entity_decode($inv->bank_infor);

                                //     // Optional: allow safe tags (keep div, strong, b, br, span)
                                //     $allowed_tags = '<p><div><strong><b><br><span>';
                                //     $documents = strip_tags($documents, $allowed_tags);

                                //     // Replace <p> tags with <div>
                                //     $documents = str_replace(['<p>', '</p>'], ['<div>', '</div>'], $documents);

                                //     // Output with clean margins
                                //     echo '<div style="margin:0; padding:0; line-height:1.4;">' . trim($documents) . '</div>';
                                // }
                                ?>
