...
<table id="example" class="table table-bordered table-hover table-striped dataTable" cellspacing="0" width="100%">
 ...
 <thead>
		...
		foreach($condition_tax as $ct){
			...
			<td>
			<center>
			<a data-target="#myModal2" data-toggle="modal" title="" class="tip" href="'.admin_url().'account/edit_condition_tax/'.$ct->id.'" data-original-title="Edit Exchange Rate"><i class="fa fa-edit"></i></a> 
