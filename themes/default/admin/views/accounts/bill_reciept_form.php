	    ...
	    <div style="font-family: Kh Siemreap">
			<table style="width:100%;font-weight:bold;">
				...
				<tr>
					...
					<td colspan="7" style="color:#8B0000;height:45px;padding-left:80px;font-family:Calibri;"><b style="font-size: 15px"><?php echo $this->bpas->numberToWordsCur($payments,"kh","");?></b></td>
				...
				<tr>
					...
					<td>ប្រាក់ដើម </td>
					<td style="padding-top:25px;color:#8B0000;text-align:center;font-family:Calibri;"><b style="font-size: 15px"><?php echo $this->bpas->formatMoney($jl_data->principle);?></b></td>
					<td>ការប្រាក់</td>
					<td style="width:10%;padding-top:25px;color:#8B0000;text-align:center;font-family:Calibri;"><b style="font-size: 15px"><?php echo $this->bpas->formatMoney($jl_data->interest);?></b></td>
				</tr>
				<tr>
					<td>Pay:</td>
					<td ><?php echo "..........................................................................."?></td>
