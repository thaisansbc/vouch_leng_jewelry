<script>
    ...
    $(document).ready(function () {
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('account/getChartAccount') ?>',
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                    <?php if ($Owner || $Admin || $GP['accounts-add']) { ?>
                        <li><a href="<?= admin_url('account/add'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal"
                           id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_chart_account"); ?></a></li>
                    <?php } ?>
                    <?php if ($Owner || $Admin) { ?>
                        <li><a href="<?= admin_url('account/import_chart_csv'); ?>" data-toggle="modal"
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="width:20%;"><?= lang("bank"); ?></th>
