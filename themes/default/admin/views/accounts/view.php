            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-6 pull-right text-right">
                        <?php $br = $this->bpas->save_barcode($transfer->transfer_no, 'code39', 35, false); ?>
                        <img src="<?= admin_url() ?>assets/uploads/barcode<?= $this->session->userdata('user_id') ?>.png"
                             alt="<?= $transfer->transfer_no ?>"/>
                        <?php $this->bpas->qrcode('link', urlencode(admin_url('transfers/view/' . $transfer->id)), 1); ?>
                ...
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="text-align:center; width:80px; "><?= $this->bpas->formatQuantity($row->quantity); ?></td>
                            <td style="width: 100px; text-align:right; padding-right:10px; vertical-align:middle;"><?= $this->bpas->formatMoney($row->net_unit_cost); ?></td>
                            <?php if ($this->Settings->tax1) {
                            ...
                            <td style="width: 100px; text-align:right; padding-right:10px; vertical-align:middle;"><?= $this->bpas->formatMoney($row->subtotal); ?></td>
                        </tr>
                        <?php $r++;
                    endforeach; ?>
                    </tbody>
                    ...
                    if ($this->Settings->tax1) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; padding-right:10px;"><?= $this->bpas->formatMoney($transfer->total_tax); ?>
                            <td style="text-align:right; padding-right:10px;"><?= $this->bpas->formatMoney($transfer->total+$transfer->total_tax); ?></td>
                        </tr>
                    <tr>
                        <td colspan="<?= $col+1; ?>"
                        ...
                        <td style="text-align:right; padding-right:10px; font-weight:bold;"><?= $this->bpas->formatMoney($transfer->grand_total); ?></td>
                    </tr>
                    </tfoot>
                </table>
            </div>
