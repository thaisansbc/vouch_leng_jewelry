<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("account/add", $attrib); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group hide">
                        ...
                        <div class="controls">
                            ...
                            echo form_dropdown('type', $opt_cal, '', 'class="form-control tip" required="required" id="cashflow" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function () {
		$("#account_code").live('change', function(){
			...
			$.ajax({
				url: '<?php echo admin_url(); ?>account/checkAccount',
				data: {code:code},
