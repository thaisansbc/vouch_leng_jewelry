...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('account/getBillReciept/?v=1' . $v) ?>',
...
<?php
    echo admin_form_open('account/reciept_actions', 'id="action-form"');
?>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("account/billReceipt"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getBillReciept/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getBillReciept/0/xls/?v=1'.$v)?>";
            return false;
        });
		*/
