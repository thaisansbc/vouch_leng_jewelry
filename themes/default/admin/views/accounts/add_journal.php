...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("account/save_journal", $attrib); ?>
                ...
                <div class="col-md-4">
						...
						<?php if ($Owner || $Admin) { ?><div class="input-group"><?php } ?>
							...
							<div class="input-group-addon no-print" style="padding: 2px 5px;">
								<a href="#" id="clickMe" class="external" data-toggle="modal" data-backdrop="static" data-target="#myModal2">
			...
			<div class="col-md-12">
				<div class="col-md-12">
					<div class="form-group">
						...
						<?= form_textarea('description', '', 'rows="5" class="form-control" id="details" '); ?>
					</div>
				</div>
...
<script type="text/javascript">
		...
		$('#type').change(function() {
			...
			if (type ==4) {
				$('#clickMe').click(function() {
					$(this).attr('href', "<?= admin_url('customers/add/cjournal') ?>");
				});
			} else if (type == 5) {
				$('#clickMe').click(function() {
					$(this).attr('href', "<?= admin_url('suppliers/add') ?>");
				});
			} else {
				$('#clickMe').click(function() {
					$(this).attr('href', "<?= admin_url('suppliers/add') ?>");
	...
	$(document).ready(function () {
		...
		$('#biller').change(function(){
			var id = $(this).val();
			$.ajax({
				url: '<?= admin_url() ?>sales/getReferenceByProject/jr/'+id,
				dataType: 'json',
