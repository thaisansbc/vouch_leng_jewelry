            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="email_address" value="<?= $biller->email ?>"/>
                    </div>
                    <div class="form-group">
                        <?= lang('phone', 'phone'); ?>
                        <input type="tel" name="phone" class="form-control" id="phone" value="<?= $biller->phone ?>"/>
                    </div>
                    <div class="form-group">
                        <?= lang('address', 'address'); ?>
                        <?php //echo form_input('address', $biller->address, 'class="form-control" id="address" required="required"'); ?>
                        <?php echo form_textarea('address', $biller->address, 'class="form-control" id="address" style="height:50px;"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('city', 'city'); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?= lang('code', 'code'); ?>
                        <?php echo form_input('code', $biller->code, 'class="form-control" id="code"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('default_warehouse', 'warehouse'); ?>
                        <?php
                        $wh[''] = lang('select') . ' ' . lang('warehouse');
                        foreach ($warehouses as $warehouse) {
                            $wh[$warehouse->id] = $warehouse->name;
                        }
                        echo form_dropdown('warehouse', $wh, set_value('warehouse', $biller->warehouse_id), 'id="warehouse" class="form-control input-tip select" style="width:100%;"');
                        ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('latitude', $biller->latitude, 'class="form-control" id="latitude" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('longitude', 'longitude'); ?>
                        <?php echo form_input('longitude', $biller->longitude, 'class="form-control" id="longitude" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang('radius', 'radius'); ?>
                        <?php echo form_input('radius', $biller->radius, 'class="form-control" id="radius" required="required"'); ?>
