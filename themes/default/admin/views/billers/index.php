...
<?php if ($Owner || $Store || $GP['bulk_actions']) {
                ...
                <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                    <?php if ($Admin || $Owner) { ?>
                        <?php if($this->Settings->multi_biller){ ?>
                            <li><a href="<?= admin_url('billers/add'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal" id="add"><i class="fa fa-plus-circle"></i> <?= lang('add_biller'); ?></a></li>
                        <?php } ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-hover table-striped">
                        <thead>
                            <tr class="primary">
