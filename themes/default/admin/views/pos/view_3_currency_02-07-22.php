                    ...
                    <tbody>
                        ...
                        foreach ($rows as $row) {
                            ...
                            echo '<tr>
                                    ...
                                    <td class="border-bottom-">'.product_name($row->product_name, ($printer ? $printer->char_per_line : null)) . ($row->variant ? ' (' . $row->variant . ')' : '') . ( ($row->category_name == null) ? ' ' : '('.$row->category_name.')').'</td>'; /*'<span class="pull-right">' . ($row->tax_code ? '*'.$row->tax_code : '') . '</span></td>';*/
                                        if($row->product_code == "Time"){
