                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        foreach ($stock_types as $stock_type) {
                            $stopts[$stock_type->id] = $stock_type->name;
                        }
                        ?>
                        <?= form_dropdown('stock_type', $stopts,  $printer->stock_type, 'class="form-control select2" id="stock_type" required="required" style="width:100%;"'); ?>
                    </div>
                    <div class="form-group">
