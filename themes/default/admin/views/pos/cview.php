    ...
    ?>-->
                ...
                foreach ($rows as $row) : ?>
                    <tr>
                        ...
                        <td style="text-align:left; width:180px;"><?php echo $row->product_name;
                                                                    ...
                                                                    ?></td>
                        <td style="text-align:center; width:50px;"><?php echo $this->bpas->formatQuantity($row->quantity); ?></td>
        ...
        <table class="totals" cellspacing="0" border="0">
            <tbody>
                ...
                <tr>
                    <td colspan="2" style="text-align:left; font-weight:bold; border-top:1px solid #000; padding-top:10px;"><?php echo $this->lang->line('total_payable'); ?></td>
                    <td colspan="2" style="border-top:1px solid #000; padding-top:10px; text-align:right; font-weight:bold;"><?php echo $this->ion_auth->formatMoney($inv->total); ?></td>
                </tr>
