    ...
    <div id="wrapper">
        <div id="receiptData">
            ...
            <div id="receipt-data">
				...
				<?= $biller->invoice_footer ? '<div class="text-center"><font style="font-size:11px;">Developed By <a href="http://sbcsolution.biz/">SBC Solutions | sbcsolution.biz</a></font></div>' : ''; ?>
				<div class="text-center">
