                            ...
                            <div class="col-sm-12">
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1" value="<?= $this->bpas->formatDecimal($inv->grand_total - $inv->paid) ?>" class="pa form-control kb-pad amount" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
