...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if (!localStorage.getItem('qref')) {
            localStorage.setItem('qref', '<?= $qunumber ?>');
        }
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('quotes/quotes_by_csv', $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) {
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('reference_no', 'qref'); ?>
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $qunumber), 'class="form-control input-tip" id="qref"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    ?>
                                    <div class="input-group-addon no-print" style="padding: 2px 5px;"><a href="<?= admin_url('customers/add'); ?>" id="add-customer" class="external" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                <a href="<?= base_url(); ?>assets/csv/sample_qoutes.csv" class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample
                                    File</a>
                                <span class="text-warning"><?php echo $this->lang->line('csv1'); ?></span><br>
                                <?php echo $this->lang->line('csv2'); ?> <span class="text-info">( <?= lang('product_code') . ', ' . lang('net_unit_price') . ', ' . lang('quantity') . ', ' . lang('product_variant') . ', ' . lang('tax_rate_name') . ', ' . lang('discount'); ?> )</span> <?php echo $this->lang->line('csv3'); ?><br>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="csv_file" type="file" data-browse-label="<?= lang('browse'); ?>" name="userfile" required="required" data-show-upload="false" data-show-preview="false" class="form-control file">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('valid_day', '', 'class="form-control input-tip date" id="valid_day"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
