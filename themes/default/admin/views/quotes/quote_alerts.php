...
<script>
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
			...
			'sAjaxSource': '<?= admin_url('quotes/getQuoteAlerts' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1' . $v ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <?php } else { ?>
            <h2 class="blue">
                <i class="fa-fw fa fa-barcode"></i>
                <?= lang('list_quote_alerts') . ' (' . lang('all_warehouses') . ')'; ?>
            </h2>
        <?php } ?>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <?php if (!empty($warehouses)) {
                    ?>
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon fa fa-building-o tip" data-placement="left" title="<?=lang("warehouse")?>"></i></a>
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=admin_url('quotes/quote_alerts')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                            	foreach ($warehouses as $warehouse) {
                                    echo '<li><a href="' . admin_url('quotes/quote_alerts/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                }
                            ?>
                        </ul>
                    </li>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    <?php echo admin_form_open("quotes/quote_alerts"); ?>
                    <div class="row">
						<div class="col-sm-4">
                    ...
                    <table id="QUData" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr class="active">
                                ...
                                <th style="text-align: right !important;"><?php echo $this->lang->line("total"); ?></th>
