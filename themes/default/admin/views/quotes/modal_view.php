...
<style type="text/css">
 ...
 /*   .letter_head{
        background-image: url("<?= base_url('assets/images/'); ?>/letter_head.png") !important;
...
<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content letter_head">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xs-5 col-ms-5">
                        <table style="font-size: 12px;">
                            ...
                            <tr>
                                ...
                                <td style="width: 5%;">:</td>
                                <td style="width: 25%;"><?= $inv->valid_day ? $inv->valid_day : ''; ?></td>
                            </tr>
                            <?php }?>
                        </table>
                    </div>
                        ...
                        <table class="table_pro" style="margin-top: 10px;">
                            <div class="thead" style="font-size: 11px;">
                                <tr style="color: #FFF !important; background-color: #444 !important;">
                                    ...
                                    <th style="width: 15% !important;">តម្លៃសរុបតាមមុខទំនិញ<br><?= strtoupper(lang('subtotal')) ?></th>
                                </tr>
                            </div>
                            <div class="tbody">
                                ...
                                <?php $no = 1; $erow = 1; $totalRow = 0;
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; text-align: right; width: 80px; padding-right: 10px;">
                            ...
                            <div class="tfoot">
                                ...
                                <tr>
                                    <td rowspan = "<?= $row; ?>" colspan="4" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;">
                                        <?php if (!empty($inv->invoice_footer)) { ?>
                                            ...
                                            <p style="margin-top:-5px !important; line-height: 2"></p>
                                        <?php } ?>
                                    </td>
                                ...
                                <?php if ($inv->shipping != 0) {
                                  ...
                                  <?php if ($inv->shipping !=0 || $inv->order_tax  !=0 || $inv->order_discount !=0 || $inv->product_tax !=0){ ?>
                                    <tr>
                                ...
                                <?php }else{ ?>
                                    <tr>
                                        <td colspan="4" style="border-left: 1px solid #FFF !important; border-bottom: 1px solid #FFF !important;"></td>
                                        <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold; padding-right: 10px;">តម្លៃសរុបរួម / <?= strtoupper(lang('total_amount')) ?>
                                            (<?= $default_currency->code; ?>)
                                        </td>
                                        <td align="right" style="padding-right: 10px;"><?= $detault_currency.$this->bpas->formatMoney($inv->grand_total); ?></td>
                ...
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <a href="<?= admin_url('sales/add/0/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('create_sale') ?>">
                                <i class="fa fa-heart"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('create_sale') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a href="<?= admin_url('purchases/add/0/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('create_purchase') ?>">
