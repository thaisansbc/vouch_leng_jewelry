                        ...
                        <?php if (($Owner || $Admin) || empty($user_billers)) { ?>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $inv->biller_id), 'id="qubiller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <?php if($Settings->sale_man){ ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?php echo lang("salesman ", "salesman"); ?>
                                                <?php
                                    ...
                                    <div class="col-md-4 hide">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('service', (isset($_POST['service']) ? $_POST['service'] : $inv->service), 'class="form-control input-tip"'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('valid_day', $this->bpas->hrsd($inv->valid_day), 'class="form-control input-tip date" id="valid_day"'); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_textarea('payment_note', (isset($_POST['payment_note']) ? $_POST['payment_note'] : $this->bpas->decode_html($inv->payment_note)), 'class="form-control" id="payment_note" style="margin-top: 10px; height: 100px;"'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
