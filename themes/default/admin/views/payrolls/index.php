...
<script>
    $(document).ready(function () {
        oTable = $('#salaryData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getSalaries/'.($biller ? $biller->id : '')); ?>',
...
<div class="box">
    <div class="box-header">
		<h2 class="blue"><i class="fa-fw fa fa-heart-o"></i><?= lang('salaries').' ('.($biller ? $biller->name : lang('all_billers')).')' ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('payrolls/add_salary') ?>"><i class="fa fa-plus-circle"></i> <?= lang('add_salary') ?>
                            </a>
                        </li>
                        <li>
