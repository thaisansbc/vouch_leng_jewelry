						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:20%">
										<?= $this->bpas->qrcode('link', urlencode(admin_url('payrolls/modal_view_bank/' . $salary->id)), 2); ?>
									</td>
								</tr>
							</table>
						</th>
						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:15%"><span style="font-size:<?= $font_size+5 ?>px"><b><i><?= lang('bank_list') ?></i></b></span></td>
				...
				<tbody>
					<?php
						...
						foreach ($salary_items as $salary_item){
							$total_net_pay += $salary_item->net_pay;
							$tbody .='<tr>
											<td class="text_center">'.$i.'</td>
											<td class="text_center">'.$salary_item->bank_account.'</td>
											<td class="text_center">'.$salary_item->account_no.'</td>
											<td class="text_left">'.$salary_item->account_name.'</td>
						...
						$tfooter = '<tr>
										'.$footer_note.'
										<td class="text_right"><b>'.$this->bpas->formatMoney($total_net_pay).'</b></td>
									</tr>';
					?>
					<tr>
						<td>
