						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:15%"><span style="font-size:<?= $font_size+5 ?>px"><b><i><?= lang('salary') ?></i></b></span></td>
					...
					<?php
						...
						foreach ($salary_items as $salary_item){
							$tbody .='<tr>
											...
											<td class="text_right">'.$this->bpas->formatMoney($salary_item->addition_amount).'</td>
											<td class="text_right">'.$this->bpas->formatMoney($salary_item->deduction_amount).'</td>
							...
							$i++;
							$total_deduction += $salary_item->deduction_amount;
						}
						...
						$tfooter = '<tr>
										...
										<td class="text_right"><b>'.$this->bpas->formatMoney($salary->total_overtime).'</b></td>
										<td class="text_right"><b>'.$this->bpas->formatMoney($salary->total_addition).'</b></td>
										<td class="text_right"><b>'.
											$this->bpas->formatMoney($total_deduction).'</b></td>
