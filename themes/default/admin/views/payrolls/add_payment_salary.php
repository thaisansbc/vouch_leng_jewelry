        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("payrolls/add_payment_salary/".$salary->id, $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
						<div class="panel panel-warning">
							...
							<div class="panel-body" style="padding: 5px;">
								...
								<div class="col-md-4">
									<div class="form-group">
										<?= lang("month", "month"); ?>
										<?php echo form_input('month', (isset($_POST['month']) ? $_POST['month'] : (isset($salary) && $salary ? $salary->month.'/'.$salary->year : date("m/Y"))), 'class="form-control month" required="required" id="month"'); ?>
									</div>
								</div>
								<div class="col-md-4">
									<?= lang("biller", "biller"); ?>
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <?php
	                                            ...
	                                            $bank = array('' => '-- Select Bank Account --');
	                                                ...
	                                                echo form_dropdown('paying_from', $bank, '', 'id="paying_from" class="form-control bank_account" data-bv-notempty="true"');
                                        ...
                                        <tbody id="dataEmp">
											<?php if(isset($salary_items) && $salary_items){
												...
												foreach($salary_items as $salary_item){
													...
													$net_salary = $this->bpas->formatDecimal($salary_item->net_pay - $salary_item->salary_paid);
													$dataEmp .= "<tr>
																	...
																	<td class='text-right'><input class='tax_payment' value='".$tax_payment."' type='hidden'/>".$tax_payment."</td>
																	<td class='text-right'><input class='net_salary' value='".$net_salary."' type='hidden'/>".$net_salary."</td>
																	<td class='text-center'><input class='form-control text-right pay_tax' name='pay_tax[]' value='".$tax_payment."' type='text'/></td>
																	<td class='text-center'><input class='form-control text-right pay_salary' name='pay_salary[]' value='".$net_salary."' type='text'/></td>
