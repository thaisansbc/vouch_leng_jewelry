						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:20%">
										<?= $this->bpas->qrcode('link', urlencode(admin_url('payrolls/modal_view_salary_employee_13/' . $salary_item->id)), 2); ?>
									</td>
								</tr>
							</table>
						</th>
						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:15%"><span style="font-size:<?= $font_size+5 ?>px"><b><i><?= lang('salary_13') ?></i></b></span></td>
										...
										<fieldset>
											...
											<table>
												...
												<tr>
													...
													<td> : <strong><?= $salary->year ?></strong></td>
												</tr>
												<tr>
				...
				<tbody>
					<?php
						...
						$tbody .='<tr>
										...
										<td class="text_right">'.($salary_item->annual_leave).'</td>
										<td class="text_right">'.$this->bpas->formatMoney($salary_item->al_rate).'</td>
										<td class="text_right">'.$this->bpas->formatMoney($salary_item->al_amount).'</td>
										<td class="text_right">'.$this->bpas->formatMoney($salary_item->subtotal).'</td>
									</tr>';		
						...
						$tfooter = '<tr>
										'.$footer_note.'
										<td class="text_right"><b>'.$this->bpas->formatMoney($salary_item->subtotal).'</b></td>
									</tr>';
					?>
					<tr>
						<td>
							<table class="table_item_main">
								<thead>
									...
									<tr style="background:#428BCA !important; color:#FFFFFF !important; text-align:center; font-weight:bold;">
										<td style="color: #FFFFFF !important; border-bottom:1px solid black !important; border-right:1px solid black !important;"><?= lang("AL") ?></td>
										<td style="color: #FFFFFF !important; border-bottom:1px solid black !important; border-right:1px solid black !important;"><?= lang("rate") ?></td>
										<td style="color: #FFFFFF !important; border-bottom:1px solid black !important; border-right:1px solid black !important;"><?= lang("amount") ?></td>
									</tr>
								</thead>
								<tbody id="tbody">
									<?= $tbody ?>
