...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_salary_13'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("payrolls/edit_salary_13/".$salary->id, $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
						<div class="panel panel-warning">
							...
							<div class="panel-body" style="padding: 5px;">
								...
								<div class="col-md-4">
									<div class="form-group">
										<?= lang("year", "year"); ?>
										<?php echo form_input('year', (isset($_POST['year']) ? $_POST['year'] : $salary->year), 'class="form-control year" required="required" id="year"'); ?>
									</div>
								</div>
								<div class="col-md-4">
									<?= lang("biller", "biller"); ?>
                    ...
                    <div class="col-lg-12">
												...
												if($salary_items){
													foreach($salary_items as $salary_item){
														$dataEmp .= "<tr>
																		...
																		<td><input class='form-control net_salary' style='text-align:right' type='text' name='net_salary[]' value='".$this->bpas->formatDecimal($salary_item->net_salary)."'/></td>
																		<td><input class='form-control annual_leave' style='text-align:right' type='text' name='annual_leave[]' value='".$this->bpas->formatDecimal($salary_item->annual_leave)."'/></td>
																		<td><input class='form-control al_rate' style='text-align:right' type='text' name='al_rate[]' value='".$this->bpas->formatDecimal($salary_item->al_rate)."'/></td>
																		<td class='text-right annual_amount'>".$this->bpas->formatMoney($salary_item->al_amount)."</td>
																		<td class='text-right net_amount'>".$this->bpas->formatMoney($salary_item->subtotal)."</td>
                        ...
                        <div class="col-sm-12">
                            <div class="fprom-group">
								<?php echo form_submit('edit_salary_13', $this->lang->line("submit"), 'id="edit_salary_13" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
							</div>
                        </div>
                    </div>
                </div>
