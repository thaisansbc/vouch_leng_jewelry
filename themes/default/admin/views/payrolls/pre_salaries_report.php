...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#RSL').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getPreSalaryReport/?v=1' . $v); ?>',
            ...
            "aoColumns": [{"mRender": fld},null,null, null,{"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": decode_html},{"mRender": row_status},{"mRender": pay_status},{"bSortable": false,"mRender": attachment}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('pre_salaries_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("payrolls/pre_salaries_report"); ?>
                    <div class="row">
						<div class="col-md-4">
                ...
                <div class="table-responsive">
                    <table id="RSL" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                        <thead>
							<tr class="active">
								<th><?= lang("date"); ?></th>	
								<th><?= lang("biller"); ?></th>	
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=admin_url('payrolls/getPreSalaryReport/xls/?v=1'.$v)?>";
            return false;
        });
    });
</script>
