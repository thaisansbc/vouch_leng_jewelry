					...
					<div class="col-md-12">
						<div class="panel panel-warning">
							...
							<div class="panel-body" style="padding: 5px;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?= lang("baht_rate", "baht_rate"); ?>
                                        <div class="input-group">
                                            <?php
                                            $data = $this->site->getCurrencyByCode('BAHT');
                                            $baht_rate = $data->rate;
                                            echo form_input('baht_rate',$baht_rate, 'id="baht_rate" required="required" class="form-control" readonly');
                                            ?>
                                            <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                            	<a href="<?= admin_url('system_settings/edit_currency/'.$data->id); ?>" id="add-customer"
                                                    class="external" data-toggle="modal" data-target="#myModal"><i
                                ...
                                <table id="expTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                   <thead style="font-size: 12px;">
										<tr>
											...
											<th rowspan="2" width="80"><?= lang("basic_salary") ?><br>ប្រាក់គោល</th>
