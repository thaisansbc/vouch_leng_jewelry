...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#RSLD').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getSalary13DetailsReport/?v=1' . $v); ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[17];
                nRow.className = "salary_employee_13_link";
                return nRow;
            },
			"aoColumns": [{"mRender": fld},null,null,null,null,null,null,null,null,null,{"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender" : row_status},{"mRender" : pay_status}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var salary_13 = 0; annual_amount = 0, net_amount = 0, paid = 0, balance = 0;
                for (var i = 0; i < aaData.length; i++) {
                    salary_13 += parseFloat(aaData[aiDisplay[i]][10]);
					annual_amount += parseFloat(aaData[aiDisplay[i]][11]);
					net_amount += parseFloat(aaData[aiDisplay[i]][12]);
					paid += parseFloat(aaData[aiDisplay[i]][13]);
					balance += parseFloat(aaData[aiDisplay[i]][14]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[10].innerHTML = currencyFormat(salary_13);
				nCells[11].innerHTML = currencyFormat(annual_amount);
				nCells[12].innerHTML = currencyFormat(net_amount);
				nCells[13].innerHTML = currencyFormat(paid);
				nCells[14].innerHTML = currencyFormat(balance);
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('salary_13_details_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("payrolls/salary_13_details_report"); ?>
                    <div class="row">
						<div class="col-md-4">
...
<script type="text/javascript">
    $(document).ready(function () {
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('payrolls/getSalary13DetailsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('payrolls/getSalary13DetailsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
