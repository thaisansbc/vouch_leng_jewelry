                                    ...
                                    <table id="expTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                        <thead>
											<tr>
												...
												<th colspan="2"><?= lang("severance") ?><br>ប្រាក់បំណាច់កិច្ចសន្យា</th>
												<th colspan="2"><?= lang("indemnity") ?><br>ប្រាក់សំណង</th>
												...
												if($salary_items){
													foreach($salary_items as $salary_item){
														...
														$dataEmp .= "
															...
															<td class='text-right'><input name='severance_riel[]' value='".$salary_item->severance_riel."' type='hidden'/>".$this->bpas->formatMoney($salary_item->severance_riel)."</td>
															...
															<td class='text-right'><input name='indemnity_riel[]' value='".$salary_item->indemnity_riel."' type='hidden'/>".$this->bpas->formatMoney($salary_item->indemnity_riel)."</td>
					...
					if (data != false) {
						$.each(data, function () {
							...
							dataEmp += "<tr>";
								...
								dataEmp += "<td class='text-right'><input name='severance_riel[]' value='"+this.severance_riel+"' type='hidden'/>"+(this.severance_riel > 0 ? formatMoney(this.severance_riel) : "-")+"</td>";
								...
								dataEmp += "<td class='text-right'><input name='indemnity_riel[]' value='"+this.indemnity_riel+"' type='hidden'/>"+(this.indemnity_riel > 0 ? formatMoney(this.indemnity_riel) : "-")+"</td>";
