...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_benefit'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo admin_form_open_multipart("payrolls/add_benefit", $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12">
                            <div class="fprom-group">
								<?php echo form_submit('add_benefit', $this->lang->line("submit"), 'id="add_benefit" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
							</div>
                        </div>
                    </div>
                </div>
					...
					if (data != false) {
						$.each(data, function () {
							...
							dataEmp += "<tr>";
								...
								dataEmp += "<td><input value='"+this.cash_advanced+"' type='hidden' class='base_cash_advanced'/><input name='cash_advanced[]' value='"+this.cash_advanced+"' type='text' class='form-control text-right cash_advanced'/></td>";
