...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#RSLD').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getSalaryBanksReport/?v=1' . $v); ?>',
			...
			"aoColumns": [{"mRender": fld},null,null,null,null,null,null,null,null,null,{"mRender": currencyFormat}],
			...
			{column_number: 7, filter_default_label: "[<?=lang('bank_name');?>]", filter_type: "text", data: []},
			{column_number: 8, filter_default_label: "[<?=lang('account_no');?>]", filter_type: "text", data: []},
			{column_number: 9, filter_default_label: "[<?=lang('account_name');?>]", filter_type: "text", data: []}
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('salary_banks_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("payrolls/salary_banks_report"); ?>
                    <div class="row">
						<div class="col-md-4">
...
<script type="text/javascript">
    $(document).ready(function () {
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('payrolls/getSalaryBanksReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('payrolls/getSalaryBanksReport/0/xls/?v=1'.$v)?>";
            return false;
        });
