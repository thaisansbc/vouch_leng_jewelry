...
<script>
    $(document).ready(function () {
        oTable = $('#RSLD').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getALCompensateDetailsReport/?v=1' . $v); ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[24];
                nRow.className = "pay_al_compensate_link";
                return nRow;
            },
			"aoColumns": [
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var al_amount = 0, total_usd = 0, total_khr = 0, usd_100 = 0, usd_50 = 0, usd_20 = 0, usd_10 = 0, khr_20000 = 0, khr_10000 = 0, khr_5000 = 0, khr_2000 = 0, khr_1000 = 0, khr_500 = 0, khr_100 = 0;
                for (var i = 0; i < aaData.length; i++) {
					al_amount += parseFloat(aaData[aiDisplay[i]][10]);
					total_usd += parseFloat(aaData[aiDisplay[i]][11]);
					total_khr += parseFloat(aaData[aiDisplay[i]][12]);
					usd_100 += parseFloat(aaData[aiDisplay[i]][13]);
					usd_50 += parseFloat(aaData[aiDisplay[i]][14]);
					usd_20 += parseFloat(aaData[aiDisplay[i]][15]);
					usd_10 += parseFloat(aaData[aiDisplay[i]][16]);
					khr_20000 += parseFloat(aaData[aiDisplay[i]][17]);
					khr_10000 += parseFloat(aaData[aiDisplay[i]][18]);
					khr_5000 += parseFloat(aaData[aiDisplay[i]][19]);
					khr_2000 += parseFloat(aaData[aiDisplay[i]][20]);
					khr_1000 += parseFloat(aaData[aiDisplay[i]][21]);
					khr_500 += parseFloat(aaData[aiDisplay[i]][22]);
					khr_100 += parseFloat(aaData[aiDisplay[i]][23]);
                }
                var nCells = nRow.getElementsByTagName('th');
				
				nCells[10].innerHTML = currencyFormat(al_amount);
				nCells[11].innerHTML = currencyFormat(total_usd);
				nCells[12].innerHTML = currencyFormatKH(total_khr);
				nCells[13].innerHTML = (usd_100);
				nCells[14].innerHTML = (usd_50);
				nCells[15].innerHTML = (usd_20);
				nCells[16].innerHTML = (usd_10);
				nCells[17].innerHTML = (khr_20000);
				nCells[18].innerHTML = (khr_10000);
				nCells[19].innerHTML = (khr_5000);
				nCells[20].innerHTML = (khr_2000);
				nCells[21].innerHTML = (khr_1000);
				nCells[22].innerHTML = (khr_500);
				nCells[23].innerHTML = (khr_100);
            }
			...
			{column_number: 7, filter_default_label: "[<?=lang('employee_date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
			{column_number: 8, filter_default_label: "[<?=lang('basic_salary');?>]", filter_type: "text", data: []},
			{column_number: 9, filter_default_label: "[<?=lang('al_day');?>]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('al_compensate_details_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("payrolls/al_compensate_details_report"); ?>
                    <div class="row">
						<div class="col-md-4">
                    ...
                    <table id="RSLD" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                        <thead>
							<tr class="active">
								...
								<th rowspan="2"><?= lang("employee_date"); ?></th>
								<th rowspan="2"><?= lang("basic_salary"); ?></th>
								<th rowspan="2"><?= lang("al_day"); ?></th>
								<th rowspan="2"><?= lang("al_amount"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=site_url('payrolls/getALCompensateDetailsReport/xls/?v=1'.$v)?>";
            return false;
        });
