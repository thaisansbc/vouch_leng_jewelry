...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#RPMD').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getContribution_paymentReport/?v=1' . $v); ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('contribution_payment_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("payrolls/contribution_payment_report"); ?>
                    <div class="row">
						<div class="col-md-4">
...
<script type="text/javascript">
    $(document).ready(function () {
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('payrolls/getContribution_paymentReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('payrolls/getContribution_paymentReport/0/xls/?v=1'.$v)?>";
            return false;
        });
