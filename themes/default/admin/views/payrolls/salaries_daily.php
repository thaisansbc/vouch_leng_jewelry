...
<script>
    $(document).ready(function () {
        oTable = $('#salaryData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('payrolls/getDailySalaries/'.($biller ? $biller->id : '')); ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				if(aData[15] == 'pending'){
					...
					action.find('.nssf_payment').remove();
				}else if(aData[15] == 'approved'){
            ...
            "aoColumns": [{"mRender": checkbox},{"mRender": fld}, null,null, {"mRender": currencyFormat},
...
<div class="breadcrumb-header">
	<h2 class="blue"><i class="fa-fw fa fa-heart-o"></i><?= lang('salaries_daily').' ('.($biller ? $biller->name : lang('all_billers')).')' ?></h2>
    <div class="box-icon">
        <ul class="btn-tasks">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                    <li>
                        <a href="<?= admin_url('payrolls/add_salary_daily') ?>"><i class="fa fa-plus-circle"></i> <?= lang('add_salary_daily') ?>
                        </a>
                    </li>
                    <li>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="salaryData" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
							<tr>
								<td colspan="19" class="dataTables_empty"><?= lang("loading_data"); ?></td>
							</tr>
                        </tbody>
