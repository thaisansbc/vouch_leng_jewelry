        ...
        <div class="modal-body">
           ...
           <div class="row">
            ...
            <div class="col-lg-12">
                    ...
                    <table class="print_table table-bordered table-hover table-striped print-table order-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center; width: 18% !important;"><?= lang("បរិយាយ"); ?></th>
                                    <th style="text-align:center; width: 18% !important;"><?= lang("មូលហេតុស្នើសុំ"); ?></th>
                                    ...
                                    <?php } ?>
                                    <th style="text-align:center; width: 7% !important;"><?= lang("ចំនួន"); ?></th>
                                    <?php
                                        if ($inv->status == 'partial') {
                                            echo '<th>'.lang("received").'</th>';
                                        }
                                    ?>
                                    <th style="padding-right:5px;text-align:center; width: 7% !important;"><?= lang("ឯកតា "); ?></th>
                            ...
                            if($rows){
                                foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td style="vertical-align:middle; width: 100px"><?= $this->bpas->hrsd($inv->date); ?></td>
                            ...
                            <tr>    
                                ...
                                <tr>
                                    <td colspan="<?= $col; ?>" style="text-align:right; font-weight:bold;"><?= lang("សរុប "); ?>(<?= $default_currency->code; ?>) :</td>
                ...
                <?php if ($no > 11) { echo '<div class="page_"></div>'; } ?>
                <div width="100%">
                    ...
                    <div style="width: 100%;font-size:10.5px;margin-top:-10px;">
                        <table width="100%" style="font-family:khmer os siemreap;">
                            <tr>
                            <?php
                            foreach($getSignbox as $key => $val){
                                if($val){
                                $ml = explode('_by', $key);
                                $nl = $ml[0];
                                $getApproved = $this->site->getApprovedByuser('pr',$inv->id,$nl,$val);
                                $approved_by = $nl.'_by';
                                $approved_status = $nl.'_status';
                                $approved_date = $nl.'_date';
                                $user = $this->site->getUser($val);
                            ?>
                            <td style="border: 1px solid #000000;">
                                <div class="approve_form">
                                    ...
                                    if ($getApproved) {
                                        if ($user->signature) {  
                                            echo '<div><img alt="signature" src="'.base_url().'assets/uploads/avatars/'.$user->signature.'" class="" style="width:80px;height:50px;"></div>';
                                        }
                                    } else {
                                        echo '<div style="height:50px;">&nbsp;</div>';
                                    } ?>
                                    <?= lang("ឈ្មោះ"); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;៖ <?= $getApproved ? 
                                            ($user->first_name . ' ' . $user->last_name):'--------------'; ?><br/>
                                    <?= lang("កាលបរិច្ឆេទ "); ?>៖ <?= $getApproved ? $this->bpas->hrld($getApproved->$approved_date):'--------------'; ?>
                                </div>
                            </td>
                            <?php
                                }
