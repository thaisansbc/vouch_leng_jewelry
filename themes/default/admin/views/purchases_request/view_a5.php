...
<div class="box">
        ...
        <div class="col-xs-12" style="width: 794px;">
            <div class="row" style="margin-top: 20px !important;">
                ...
                <div class="well-sm">
                    ...
                    <h3 align="center"><strong style="margin-top: -20px; display: block;">EXPENDITURE REQUISITION FORM</strong></h3>
                    <h4 align="center"><strong>(CAPITAL / OPERATION)</strong></h4>
                </div>
                <div class="well-sm" style="border: 1px solid #282b2e; margin-bottom: 10px;">
                    <div class="col-xs-6 border-right">
                        <table>
                            <tr>
                                <td style="width: 55%;"><strong><?php echo $this->lang->line("request_department"); ?></strong></td>
                                <td style="width: 4%;">:</td>
                                <td></td>
                            </tr>
                            <tr>
    ...
    <div style="width: 821px; margin: 10px auto;">
		<a class="btn btn-warning no-print" href="<?= site_url('admin/purchases_request'); ?>">
