    ...
    function loadItems() {
        if (localStorage.getItem('poitems')) {
            ...
            $.each(sortedItems, function () {
                ...
                tr_html += '<td><input class="form-control text-center" type="text" value="' + (item.row.on_first_open == 1 ? formatDecimal(added_stock_qty) : formatDecimal(unit_qty_received)) + '" data-id="' + row_no + '" data-item="' + item_id + '" id="received_' + row_no + '" onClick="this.select();" readonly></td>';
