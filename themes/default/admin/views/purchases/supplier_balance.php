...
<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('purchases/getSupplierBalance').'/?v=1'.$v ?>',
...
<?php 
    echo admin_form_open('purchases/supplier_balance_actions', 'id="action-form"');
?>
<div class="box">
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                   <?php echo admin_form_open("purchases/supplier_balance"); ?>
                            <div class="row">
									<div class="col-sm-4">
