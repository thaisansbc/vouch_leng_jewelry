			...
			<td>
				<table width="100%">
					<tr>
						...
						<td width="30%" style="padding-left:0px; text-align:right;"> <?= $this->bpas->hrld($inv->date); ?> </td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td colspan="2" width="65%" align="center" style="padding-top:5px;">
				<table width="100%">
					<tr style="height:40px;">
						...
						<td width="15%" style="padding-left:0px; text-align:right; border-bottom:1px solid black;"> <?php echo '$ '. $this->bpas->formatMoney($payment->amount); ?> </td>
					</tr>
					<tr style="height:40px;">
			...
			<td colspan="2" width="65%" align="center" style="padding-top:5px;">
				<table width="100%">
					<tr style="height:40px;">
						...
						<td width="30%" colspan="3" align="right" style="border-bottom:1px solid black; padding-right:10px;"> <?php echo '$ '. $this->bpas->formatMoney($curr_balance); ?> </td>
					...
					<tr style="height:40px;">
						...
						<td width="30%" colspan="3" align="right" style="border-bottom:1px solid black; padding-right:10px;"> <?php echo '$ '. $this->bpas->formatMoney($payment->amount); ?> </td>
						<td width="25%" style="text-align:left;"></td>
						<td width="25%" style="padding-left:0px; text-align:right;"></td>
					</tr>
					<tr style="height:40px;">
						<td width="20%" style="font-family:'Khmer OS'; font-size:16px;"> <?= lang('balance_due');?> : </td>
						<td width="30%" colspan="3" align="right" style="border-bottom:1px solid black; padding-right:10px;"> <?php echo '$ '. $this->bpas->formatMoney($curr_balance - $payment->amount); ?> </td>
						<td width="25%" style="text-align:left;"></td>
						<td width="25%" style="padding-left:0px; text-align:right;"></td>
					</tr>
				</table>
