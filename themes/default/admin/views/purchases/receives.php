...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EXPData1').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('purchases/getReceives/'.($biller ? $biller->id : '')); ?>',
...
<?php if ($Owner) {
    echo admin_form_open('purchases/receive_actions', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
							<a href="<?=admin_url('purchases/add_receive')?>">
				...
				<?php if (!empty($billers) && $this->config->item('one_biller')==false) { ?>
					<li class="dropdown">
						...
						<ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
							<li><a href="<?= admin_url('purchases/receives') ?>"><i class="fa fa-industry"></i> <?= lang('all_billers') ?></a></li>
							<li class="divider"></li>
							<?php
							foreach ($billers as $biller) {
								echo '<li><a href="' . admin_url('purchases/receives/'.$biller->id) . '"><i class="fa fa-home"></i>' . $biller->name . '</a></li>';
							}
							?>
						</ul>
					</liv>
