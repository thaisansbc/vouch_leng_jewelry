                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                       ...
                       <?php if ($Owner || $Admin || $GP['purchases_order-edit']) { ?>
                        <li>
                            <a href="<?= admin_url('purchases/edit_purchase_order/' . $inv->id) ?>">
                       ...
                       <!-- <?php if ($Owner || $Admin || $GP['purchases-email']) { ?>
                        ...
                        <li>
                            <a href="<?= admin_url('purchases/pdf_order/' . $inv->id) ?>">
            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-4 border-left">
                        ...
                        <div class="col-xs-12">
                            <?php $br = $this->bpas->save_barcode($inv->reference_no, 'code39', 35, false); ?>
                            <img
                ...
                <div class="table-responsive">
                    ...
                    endforeach;
                        ...
                        if ($inv->shipping != 0) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("shipping") . '</td><td style="text-align:right; padding-right:10px;">' . $this->bpas->formatMoney($inv->shipping) . '</td></tr>';
                        } 
            ...
            <div class="buttons">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <?php if ($inv->status != 'approved' && $inv->status != 'reject') { ?>
                        <?php if ($Owner || $Admin || $GP['purchases_order-edit']) { ?>
                        <div class="btn-group">
                            <a href="<?= admin_url('purchases/edit_purchase_order/' . $inv->id) ?>" class="tip btn btn-warning tip" title="<?= lang('edit') ?>">
