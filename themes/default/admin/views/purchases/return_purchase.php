...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('renote', '<?= $this->bpas->decode_html($inv->note); ?>');
                    ...
                    ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('order_discount', (isset($_POST['rediscount']) ? $_POST['rediscount'] : $inv->order_discount > 0 ? $this->bpas->formatDecimal($inv->order_discount_id) : 0), 'class="form-control input-tip input_decimal_percentage" id="rediscount" required="required"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <?php echo form_hidden('biller', $inv->biller_id ? $inv->biller_id : $Settings->default_biller, 'class="form-control" '); ?>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($inv->payment_status == 'paid' || $inv->payment_status == 'partial') {
                                echo '<div class="alert alert-success"><p>' . lang('payment_status') . ': <strong>' . $inv->payment_status . '</strong> & ' . lang('paid_amount') . ' <strong>' . $this->bpas->formatMoney($inv->paid) . '</strong></p><p>' . lang('adjust_payments') . '</p></div>';
                            } else {
                                echo '<div class="alert alert-warning"><p>' . lang('payment_status') . ': <strong>' . $inv->payment_status . '</strong> & ' . lang('paid_amount') . ' <strong>' . $this->bpas->formatMoney($inv->paid) . '</strong></p><p>' . lang('adjust_payments') . '</p></div>';
                            }
                            ?>
                        </div>
