<script type="text/javascript">
    ...
    $(document).on('click', '#add_return', function(){
        ...
        var is = true;
        $.ajax({
            url: '<?php echo admin_url() ?>purchases/checkReturn/' + purchase_id,
            async: false,
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            ?>
                            <input type="hidden" name="total_pay" value="<?php echo $this->bpas->formatMoney($inv->paid) ? $this->bpas->formatMoney($inv->paid) : 0 ?>">
                        </div>
