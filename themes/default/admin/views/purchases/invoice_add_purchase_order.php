...
<body>
					...
					<table class="table" style="margin-top: 10px;">
						<tbody style="font-size: 11px;">
							...
							<?php 
								...
								foreach ($rows as $row) {
									...
									if($row->subtotal == 0){
										...
										$subtotal = $this->bpas->formatMoney($row->subtotal);
									}
							?>
								<tr>
									<td style="vertical-align: middle; text-align: center"><?php echo $no ?></td>
									<td style="vertical-align: middle;">
										<img class="img-circle" style="width:30px; height:30px;" src ="<?= admin_url() ."assets/uploads/thumbs/".$row->image; ?>">
									</td>
							...
							?>
								...
								<td align="right">$<?= $this->bpas->formatMoney($inv->grand_total); ?></td>
							</tr>
							...
							<tr>
								...
								<td align="right">$<?php echo $this->bpas->formatMoney($inv->deposit); ?></td>
							</tr>
							<?php } ?>
							<?php if($inv->paid != 0) { ?>
							<tr>
								...
								<td align="right">$<?php echo $this->bpas->formatMoney($inv->paid-$inv->deposit); ?></td>
							</tr>
							<?php } ?>
							<tr>
								...
								<td align="right">$<?= $this->bpas->formatMoney($inv->grand_total - (($inv->paid-$inv->deposit) + $inv->deposit)); ?></td>
							</tr>
						<?php } ?>
	...
	<div style="width: 821px;margin: 0 auto;">
		<a class="btn btn-warning no-print" href="<?= admin_url('purchases/purchase_order'); ?>">
