...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("purchases/combine_payment_supplier", $attrib); ?>
                ...
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <?php if (!empty($combine_purchases)) {
                        ...
                        foreach ($combine_purchases->result() as $combine_purchase) { ?>
                            <tr class="row<?= $combine_purchase->id ?>">
                                <td><?= $this->bpas->hrld($combine_purchase->date); ?></td>
                                <td><?= $combine_purchase->reference_no; ?></td>                           
								<td class="balance" val='<?=$combine_purchase->balance?>'><?= $this->bpas->formatMoney($combine_purchase->balance); ?></td>
                                <td class="col-xs-3">
					...
					<tfoot>
                        <tr>
                            ...
                            <td><strong id="total_paid"><?= $this->bpas->formatDecimal($tamountpaid); ?></strong></td>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= $this->bpas->formatMoney($total); ?>"
