    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("purchases/edit_purchase_order/" . $inv->id, $attrib)
                ?>

                <div class="row">
                    <div class="col-lg-12">

                        <?php if ($Owner || $Admin || $GP['change_date'] || $Settings->allow_change_date == 1) { ?>
                            <div class="col-md-4">
                                ...
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
										...
										// if($this->input->get('editpurrquestorder')){
											...
											$q = $this->db->get_where('bpas_products',array('id'=>$this->input->get('editpurrquestorder')),1);
                                            $pcode = $q->row();
											// $pcode = $q->row()->code;
                                            ...
                                            <div class="col-sm-4">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        ...
                                                        <input name="amount-paid" type="text" id="amount_1" class="pa form-control kb-pad amount" value="<?= $this->bpas->formatPurDecimal($inv->paid);?>" />
														<input name="amount_o" type="hidden" value="<?=$this->bpas->formatPurDecimal($inv->paid)?>" id="amount_o"/>
                                                    </div>
