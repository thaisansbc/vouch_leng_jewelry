...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('purchases/add_payment/' . $payment->purchase_id, $attrib); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?= form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $payment_refer), 'class="form-control tip" id="reference_no" required="required"'); ?>
                    </div>
                </div>
                <input type="hidden" value="<?php echo $payment->id; ?>" name="ap_requested_id"/>
                                ...
                                <div class="col-sm-6" id="bank_acc">
                                    <div class="form-group">
                                        ...
                                        <?php
                                            ...
                                            echo form_dropdown('bank_account', $bank, (($payment->bank_account)? $payment->bank_account:''), 'id="bank_account_1" class="ba form-control kb-pad bank_account" data-bv-notempty="true"');
                                        ?>
                                    </div>
                                </div>
                            <?php } ?>
