...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?= lang('view_payments') . ' (' . lang('expenses') . ' ' . lang('reference') . ': ' . $inv->reference . ')'; ?></h4>
        </div>
                            ...
                            <tr class="row<?= $payment->id ?>">
                                ...
                                <td>
                                    <div class="text-center">
                                        <a href="<?= admin_url('expenses/payment_note/' . $payment->id) ?>"
                                           data-toggle="modal" data-backdrop="static" data-target="#myModal2"><i class="fa fa-file-text-o"></i></a>
                                  
                                        <a href="<?= admin_url('expenses/edit_payment/' . $payment->id) ?>"
                                        ...
                                        <a href="#" class="po" title="<b><?= $this->lang->line('delete_payment') ?></b>"
                                           data-content="<p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' id='<?= $payment->id ?>' href='<?= admin_url('expenses/delete_payment/' . $payment->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn po-close'><?= lang('no') ?></button>"
