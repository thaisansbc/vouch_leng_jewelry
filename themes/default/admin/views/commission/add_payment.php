                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               value="<?= ($inv->currency_invoice =='USD') ? $this->bpas->formatDecimal($inv->grand_total - $inv->paid) : '0'; ?>"
                            ...
                            <div class="col-sm-4" style="display: none;">
                                <div class="payment">
                                    <div class="form-group">
                                        <?= lang("amount_kh", "amount_2"); ?>
                                        <input name="amount-paid_khm" type="text" id="amount_2"
                                               value="<?= ($inv->currency_invoice =='KHM') ? $this->bpas->formatDecimal(($inv->grand_total - $inv->paid) * $inv->currency_rate_kh) : '0'; ?>"
                            ...
                            <div class="col-sm-4" style="display: none;">
                                <div class="payment">
                                    <div class="form-group">
                                        <?= lang("amount_bat", "amount_3"); ?>
                                        <input name="amount-paid_bat" type="text" id="amount_3"
                                               value="<?= ($inv->currency_invoice =='BAT') ? $this->bpas->formatDecimal(($inv->grand_total - $inv->paid) * $inv->currency_rate_bat) : '0'; ?>"
                                               class="pa form-control kb-pad amount"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                             <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang("commision_type", "slsale_status"); ?>
                                    <?php 
                                    $sst = array('percent' => lang('percent'), 
                                                'case' =>lang('case')
                                    );
                             ...
                             <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang("stl", "stl"); ?>
                                    <input name="amount-paid" type="text" id="stl" value="" class="pa form-control kb-pad amount" required="required"/>
                                </div>
                            </div>
                             <div class="col-sm-4">
                                <div class="form-group">
                                    <?= lang("sa", "sa"); ?>
                                    <input name="amount-paid" type="text" id="sa" value="" class="pa form-control kb-pad amount" required="required"/>
                                </div>
                            </div>
                        </div>
                    </div>
