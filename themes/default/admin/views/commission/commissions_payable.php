...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('commission/getPaymentsCommissionReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [{ "bSortable": false, "mRender": checkbox }, {"mRender": fld},null, {"mRender": ref}, {"mRender": currencyFormat}, null, {"mRender": row_status}, null, { "bSortable": false}],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    commission += parseFloat(aaData[aiDisplay[i]][4]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[4].innerHTML = currencyFormat(parseFloat(commission));
            }
            ...
            {column_number: 6, filter_default_label: "[<?=lang('percent');?>]", filter_type: "text", data: []},
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('commission/commissions_payable'); ?>
                    <div class="row">
                        <div class="col-sm-4">
                ...
                <?php if ($Owner || $GP['bulk_actions']) {
                    echo admin_form_open('commission/commissions_actions', 'id="action-form"');
                }
                ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('commission/getPaymentsCommissionReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('commission/getPaymentsCommissionReport/0/xls/?v=1' . $v)?>";
            return false;
        });
