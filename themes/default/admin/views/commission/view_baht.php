            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    ...
                    $currency_rate_bat=$inv->currency_rate_bat;
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; width:80px; padding-right:10px;">
                                    <?= $bat.$this->bpas->formatMoney($row->real_unit_price * $currency_rate_bat); ?></td>
                                <?php
                                if ($Settings->tax1 && $inv->product_tax > 0) {
                                ...
                                if ($Settings->product_discount && $inv->product_discount != 0) {
                                    echo '<td style="width: 60px; text-align:right; vertical-align:middle;">' .$bat.$this->bpas->formatMoney($row->item_discount * $currency_rate_bat) . '</td>';
                                }
                                ?>
                                <td style="text-align:right; width:70px; padding-right:10px;"><?= 
                                    $bat.$this->bpas->formatMoney($row->subtotal * $currency_rate_bat); ?></td>
                            </tr>
                            <?php
                            $r++;
                        endforeach;
                            ...
                            foreach ($return_rows as $row):
                                ...
                                <tr class="warning">
                                    ...
                                    <td style="text-align:right; width:120px; padding-right:10px;">
                                        <?= $bat.$this->bpas->formatMoney($row->unit_price * $currency_rate_bat); ?></td>
                                    <?php
                                    if ($Settings->tax1 && $inv->product_tax > 0) {
                                        echo '<td style="width: 120px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 ? '<small>('.($Settings->indian_gst ? $row->tax : $row->tax_code).')</small>' : '') . ' ' . $this->bpas->formatMoney($row->item_tax) . '</td>';
                                    }
                        ...
                        <?php
                        if ($return_sale) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("return_total") . ' (' . $bat . ')</td><td style="text-align:right; padding-right:10px;">' . $this->bpas->formatMoney($return_sale->grand_total) . '</td></tr>';
                        }
                        if ($inv->surcharge != 0) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; padding-right:10px; font-weight:bold;">
                                ...
                                echo $this->bpas->formatMoney($total * $currency_rate_bat); ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; font-weight:bold;">
                                ...
                                echo $this->bpas->formatMoney($paid_ * $currency_rate_bat); ?></td>
                        </tr>
                        <tr>
                            <td colspan="<?= $col; ?>"
                            ...
                            <td style="text-align:right; font-weight:bold;">
                                ...
                                echo $this->bpas->formatMoney($balance_ * $currency_rate_bat); ?></td>
                        </tr>
