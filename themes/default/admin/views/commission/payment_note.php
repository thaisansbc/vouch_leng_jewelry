...
<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Monthly Payment</h4>
        </div>
        <div class="modal-body print">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p style="font-weight:bold;"><?= lang("date"); ?>: <?= $this->bpas->hrsd($payment->date); ?></p>
            ...
            <div class="well">
                <table class="table table-borderless" style="margin-bottom:0;">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <strong class="text-right"><?php echo $this->bpas->formatMoney($payment->amount); ?></strong>
                        </td>
                    </tr>
                    <tr>
