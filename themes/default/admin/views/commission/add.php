...
//    localStorage.setItem('exchange_khm', '<?php echo isset($exchange_rate_khm->rate)?$exchange_rate_khm->rate:0 ?>');
//    localStorage.setItem('exchange_bat', '<?php echo isset($exchange_rate_bat->rate)?$exchange_rate_bat->rate:0 ?>');
    //var exchange_khm = localStorage.getItem('exchange_khm');
    //var exchange_bat = localStorage.getItem('exchange_bat');
    
    localStorage.setItem('exchange_khm', '4000');
    localStorage.setItem('exchange_bat', '33');
    var exchange_khm = 4000;
    var exchange_bat = 33;
                    ...
                    <div class="col-lg-12">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											foreach ($projects as $project) {
												$pro[$project->project_id] = $project->project_code != '-' ? $project->project_code.'-'.$project->project_name : $project->project_code;
											}
											echo form_dropdown('project', $pro, (isset($_POST['project']) ? $_POST['project'] : ''), 'id="poproject" data-placeholder="' . lang("select") . ' ' . lang("project") . '" required="required" class="form-control input-tip select" style="width:100%;"');
											?>
										</div>
									</div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                /* $sst = array('pending' => lang('pending'), 
                                            'completed' =>lang('completed'),'order' => lang('Order')
                                );*/
                                $sst = array(
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                /*
                                $pst = array(
                                    'pending' => lang('pending'), 'due' => lang('due'), 
                                    'partial' => lang('partial'), 'paid' => lang('paid')
                                );
                                */
                                $pst = array(
                                    'pending' => lang('pending'),
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="input-group">
                                                    <?= form_input('percent', '0', 'class="form-control" id="percent_type"') ?>
                                                    <span class="input-group-addon pointer" style="padding: 1px 10px;">
                                                        % of Total Price
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        ...
                                                        <input name="amount-paid" value="0" type="text" id="amount_1"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        <?= lang("month", "month"); ?>
                                                        <input name="month" value="0" type="text" id="month"
                                            ...
                                            <div class="col-sm-4" style="display: none;">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        <?= lang("khm", "amount_2"); ?>
                                                        <input name="amount-paid_khm" type="text" id="amount_2"
                                                               class="pa form-control kb-pad amount"/>
                                                    </div>
                                                    <div class="form-group gc" style="display: none;">
                                                        <?= lang("gift_card_no", "gift_card_no"); ?>
                                            ...
                                            <div class="col-sm-4" style="display: none;">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        <?= lang("bath", "amount_3"); ?>
                                                        <input name="amount-paid_bat" type="text" id="amount_3"
                                                               class="pa form-control kb-pad amount"/>
                                                    </div>
                                                    <div class="form-group gc" style="display: none;">
                                                        <?= lang("gift_card_no", "gift_card_no"); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#amount_1,#amount_2,#amount_3").keypress(function(event) {
