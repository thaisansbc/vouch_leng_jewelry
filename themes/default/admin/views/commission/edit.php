                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            foreach ($projects as $project) {
                                                $pro[$project->project_id] = $project->project_code != '-' ? $project->project_code.'/'.$project->project_name : $project->project_code.'/'.$project->project_name;
                                            }
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls"> 
                                    <?php
                                        ...
                                        echo form_dropdown('currency', $cu, $inv->currency_invoice, 'class="form-control tip pcurrency" id="currency" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>
