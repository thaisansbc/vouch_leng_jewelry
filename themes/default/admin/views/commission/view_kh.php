        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="print-only col-xs-12 text-center">
                    ...
                    <img class="text-center" src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>" alt="<?= $biller->company != '-' ? $biller->company : $biller->name; ?>">
                </div>
                <div class="well-sm">
                    ...
                    <div class="col-xs-12">
                        <div class="col-xs-12">
                            ...
                            echo '<p class="text-center" >'.lang("address") .": ".$biller->address . " " . $biller->city . " " . $biller->postal_code . " " . $biller->state . " " . $biller->country.'<br>';
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; width:80px; padding-right:10px;">
                                    <?= $khm.$this->bpas->formatMoney($row->real_unit_price * $currency_rate_kh); ?></td>
                                <?php
                                if ($Settings->tax1 && $inv->product_tax > 0) {
                                ...
                                if ($Settings->product_discount && $inv->product_discount != 0) {
                                    echo '<td style="width: 60px; text-align:right; vertical-align:middle;">' .$khm.$this->bpas->formatMoney($row->item_discount * $currency_rate_kh) . '</td>';
                                }
                                ?>
                                <td style="text-align:right; width:70px; padding-right:10px;"><?= 
                                    $khm.$this->bpas->formatMoney($row->subtotal * $currency_rate_kh); ?></td>
                            </tr>
                            <?php
                            $r++;
                        endforeach;
                            ...
                            foreach ($return_rows as $row):
                                ...
                                <tr class="warning">
                                    ...
                                    <td style="text-align:right; width:120px; padding-right:10px;">
                                        <?= $khm.$this->bpas->formatMoney($row->unit_price * $currency_rate_kh); ?></td>
                                    <?php
                                    if ($Settings->tax1 && $inv->product_tax > 0) {
                        ...
                        <?php
                        if ($return_sale) {
                            echo '<tr><td colspan="' . $col . '" style="text-align:right; padding-right:10px;;">' . lang("return_total") . ' (' . $khm . ')</td><td style="text-align:right; padding-right:10px;">' . $this->bpas->formatMoney($return_sale->grand_total) . '</td></tr>';
                        }
                        if ($inv->surcharge != 0) {
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; padding-right:10px; font-weight:bold;">
                                ...
                                echo $this->bpas->formatMoney($total * $currency_rate_kh); ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right; font-weight:bold;">
                                <?php 
                                $paid_= $return_sale ? ($inv->paid+$return_sale->paid) : $inv->paid;
                                echo $this->bpas->formatMoney($paid_ * $currency_rate_kh); ?></td>
                        </tr>
                        <tr>
                            <td colspan="<?= $col; ?>"
                            ...
                            <td style="text-align:right; font-weight:bold;">
                                <?php 
                                $balance_ =($return_sale ? ($inv->grand_total+$return_sale->grand_total) : $inv->grand_total) - ($return_sale ? ($inv->paid+$return_sale->paid) : $inv->paid);
                                echo $this->bpas->formatMoney($balance_ * $currency_rate_kh); ?></td>
                        </tr>
                        <tr>
                            <td colspan="<?= $col; ?>"
                ...
                <?php if ($inv->payment_status != 'paid') { ?>
                    <div id="payment_buttons" class="row text-center padding10 no-print">
                        ...
                        <?php if ($skrill->active == "1" && $inv->grand_total != "0.00") {
                            ...
                            ?>
                            <div class="col-xs-6 text-center">
                                <form action="https://www.moneybookers.com/bpas/payment.pl" method="post">
