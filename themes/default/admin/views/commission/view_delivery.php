            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td width="70%"><?= $this->bpas->hrld($delivery->date); ?></td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="width: 150px; text-align:center; vertical-align:middle;"><?= $this->bpas->formatQuantity($row->unit_quantity).' '.$row->product_unit_code; ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
