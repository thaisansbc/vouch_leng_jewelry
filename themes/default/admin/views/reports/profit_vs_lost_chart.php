...
<script>
    $(document).ready(function () {
        CURI = '<?= admin_url('reports/profit_vs_lost_chart'); ?>';
    });
</script>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#chart').highcharts({
            ...
            tooltip: {
                formatter: function () {
                    if(this.key == 'Profit and/or Loss') {
            ...
            series: [{
                type: 'pie',
                name: '<?php echo $this->lang->line('profit_and/or_lost_chart'); ?>',
                data: [
                    [
                    ...
                    ['<?php echo $this->lang->line('cost_of_good'); ?>', <?php echo $cost_of_good ? $cost_of_good : 0; ?>],
                    ...
                    {name: '<?php echo $this->lang->line('profit_loss'); ?>', y: <?php echo $profit_loss ? $profit_loss : 0; ?>, positive: <?php echo (($profit_loss < 0) ? 'false' : 'true'); ?>}
                ]
            }]
        });
    });
...
<?php if ($Owner || $Admin) { ?>
    <div class="box" style="margin-top: 15px;">
        <div class="box-header">
            <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i><?= lang('profit_and/or_lost_chart'); ?></h2>
            <div class="box-icon">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                ...
                                foreach ($warehouses as $warehouse) {
                                    echo '<li ' . ($warehouse_id && $warehouse_id == $warehouse->id ? 'class="active"' : '') . '><a href="' . admin_url('reports/profit_vs_lost_chart/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                } ?>
                            </ul>
                        </li>
                    <?php } ?>
