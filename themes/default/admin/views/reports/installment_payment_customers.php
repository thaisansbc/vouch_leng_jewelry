...
<script>
    $(document).ready(function () {
		oTable = $('#InstallmentCustomerTable').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('reports/getInstallmentPaymentCustomers?v=1&'. $v)?>',
...
<?php echo admin_form_open("reports/installment_payment_customers", ' id="form-submit" '); ?>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<table class="print_only" style="width:100%; margin-bottom: 10px">
					...
					<tr>
						<th colspan="2" class="text-center"><u><?= lang('installment_payment_customers_report'); ?></u></th>
					</tr>
					<?= $print_filter ?>
				</table>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getInstallmentPaymentCustomers/pdf/?v=1'.$v)?>";
            return false;
        });
		$('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getInstallmentPaymentCustomers/0/xls/?v=1'.$v)?>";
            return false;
        });
