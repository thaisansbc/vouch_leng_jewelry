...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            {column_number: 3, filter_default_label: "[<?=lang('purchase_order_ref');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('sale_order_ref');?>]", filter_type: "text", data: []},
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("reports/deposits"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?= admin_url('reports/getdepositsReports/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?= admin_url('reports/getdepositsReports/0/xls/?v=1'.$v)?>";
            return false;
        });
