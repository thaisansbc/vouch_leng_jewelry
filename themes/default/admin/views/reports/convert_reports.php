...
<script type="text/javascript">
       $(document).ready(function () {
        var oTable = $('#convert_table').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getConvertReports').'/?v=1'.$v ?>',
...
?>
<?php if ($Owner) {
    echo admin_form_open('reports/convertReport_action', 'id="action-form"');
} ?>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/convert_reports"); ?>
                    <div class="row">
                       <!-- <div class="col-sm-3">
