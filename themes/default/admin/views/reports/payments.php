        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown hide">
                    <a href="#" id="transfer" class="tip" title="<?= lang('updated_transfer') ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#preview').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getPaymentsReport/0/0/preview/?v=1' . $v)?>";
            return false;
        });
        
        $('#transfer').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getPaymentsReport/0/0/0/transfer/?v=1' . $v)?>";
            return false;
        });
