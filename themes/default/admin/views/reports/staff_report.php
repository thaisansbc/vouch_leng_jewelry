                                ...
                                <tr>
                                    ...
                                    if (!empty($msales)) {
                                        foreach ($msales as $value) {
                                            $array[$value->date] = "<table class='table table-hover table-striped table-condensed reports-table data' style='margin:0;'><tr><td>" . lang('product_tax') . '</td></tr><tr><td>' . $this->bpas->formatMoney($value->tax1) . '</td></tr><tr><td>' . lang('order_tax') . '</td></tr><tr><td>' . $this->bpas->formatMoney($value->tax2) . '</td></tr><tr><td>' . lang('total') . '</td></tr><tr><td>' . $this->bpas->formatMoney($value->total) . '</td></tr></table>';
                                        }
