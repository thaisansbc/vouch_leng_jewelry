...
<script>
       $(document).ready(function () {
        	oTable = $('#LoanCollectableTable').dataTable({
	            ...
	            'sAjaxSource': '<?=admin_url('reports/getInstallCollectableReport?v=1&'. $v)?>',
...
<?php echo admin_form_open("reports/installment_collectable", ' id="form-submit" '); ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('installment_collectable_report'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
				<li class="dropdown">
					...
					<div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('borrower', (isset($_POST['customer']) ? $_POST['customer'] : ''), 'class="form-control" id="customer" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('customer') . '"'); ?>
                            </div>
                        </div>
						<div class="col-sm-4">
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getInstallCollectableReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getInstallCollectableReport/0/xls/?v=1'.$v)?>";
            return false;
        });
