...
<script>
    $(document).ready(function() {
        oTable = $('#PQData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('reports/getQuantityAlerts' . ($warehouse_id ? '/?warehouse_id=' . $warehouse_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
            ...
            ?>
            <i class="fa-fw fa fa-calendar-o"></i><?= lang('product_quantity_alerts') . ' (' . ($warehouse_id ? $str : lang('all_warehouses')) . ')'; ?>
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                    ...
                    <table id="PQData" cellpadding="0" cellspacing="0" border="0" class="table table-condensed table-hover table-striped dfTable reports-table">
                        <thead>
                            <tr class="active">
                                ...
                                <th style="text-align: center !important;"><?php echo $this->lang->line('alert_quantity'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
