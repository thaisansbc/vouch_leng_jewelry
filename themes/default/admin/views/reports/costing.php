...
<script>
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getCostingReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld}, null,null, null, null, null, {"mRender": currencyFormat},
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('reports/costing'); ?>
                    <div class="row">
                        <div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table id="SlRData"
                        ...
                        <tr>
                            ...
                            <th><?= lang('saleitem'); ?></th>
                            <th><?= lang('saleid'); ?></th>
                            <th><?= lang('purchase_item_id'); ?></th>
                            <th><?= lang('quantity'); ?></th>
                            <th><?= lang('purchase_net_unit_cost'); ?></th>
                            <th><?= lang('purchase_unit_cost'); ?></th>
                            <th><?= lang('sale_net_unit_price'); ?></th>
                            <th><?= lang('sale_unit_price'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getCostingReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getCostingReport/0/xls/?v=1' . $v)?>";
            return false;
        });
