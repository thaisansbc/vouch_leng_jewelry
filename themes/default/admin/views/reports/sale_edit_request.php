...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EsqTable').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= admin_url('reports/getSaleEditRequest/?v=1' . $v) ?>',
            ...
            "aoColumns": [ 
                {"mRender": fld}, 
                {"mRender": fld}, 
                null,null,null,null,null,null,null,{"bSortable": false, "mRender": img_hl_x},{ "mRender": row_status },
                ]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 0, filter_default_label: "[ yyyy-mm-dd]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-th-large"></i><?= lang('sale_edit_request_report'); ?><?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('reports/sale_edit_request'); ?>
                    <div class="row">
                ...
                <div class="table-responsive">
                    <table id="EsqTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th width="8%"><?= lang('user'); ?></th>
                            <th><?= lang('biller'); ?></th>
                             <th><?= lang('request_note'); ?></th>
                            <th><?= lang('noted'); ?></th>
                            <th width="1%"><?= lang('attachment'); ?></th>
                            <th><?= lang('status'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getSaleEditRequest/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSaleEditRequest/0/xls/?v=1' . $v)?>";
            return false;
        });
