...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        oTable = $('#PoRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getStockReceivedReport/?v=1' . $v) ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[8];
                nRow.className = 'stock_received_detail_link';
                return nRow;
            },
            "aoColumns": [
                {"mRender": fld}, null, null, null, null, null, 
                {"bSearchable": false, "mRender": pqFormat}, {"mRender": striptage}
            ],
            ...
            {column_number: 2, filter_default_label: "[<?=lang('purchase_ref');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('stock_received_report'); ?> <?php
            if ($this->input->post('start_date')) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open('reports/stock_received'); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="purchase_ref"><?= lang('purchase_ref'); ?></label>
                                <?php echo form_input('purchase_ref', (isset($_POST['purchase_ref']) ? $_POST['purchase_ref'] : ''), 'class="form-control tip" id="reference_no"'); ?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getStockReceivedReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getStockReceivedReport/0/xls/?v=1' . $v)?>";
            return false;
        });
        $('#xls_detail').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getStockReceivedReport/0/0/0/excel_deatail/?v=1' . $v)?>";
            return false;
        });
        $('#preview').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getStockReceivedReport/0/0/preview/?v=1' . $v)?>";
            return false;
        });
