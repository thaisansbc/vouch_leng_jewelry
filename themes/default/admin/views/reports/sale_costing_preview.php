        ...
        <div class="row">
            ...
            <div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped">
                    ...
                    <?php 
                    if (!empty($rows)) {
                        $cost = 0; $price = 0; $subtotal = 0; $discount = 0; $vat = 0; $total = 0; $profit = 0;
                        $i = 1;
                        foreach ($rows as $row) { ?>
                            <tr>
                                <td><?= $i; ?></td>
                                ...
                                <td><?= $this->bpas->formatDecimal($row->unit_cost); ?></td>
                                ...
                                <td><?= $this->bpas->formatDecimal($row->subtotal); ?></td>
                                <td><?= $this->bpas->formatDecimal($row->subtotal - ($row->quantity * $row->unit_cost)); ?></td>
                            </tr>
                        <?php 
                        $cost     += $row->unit_cost;
                        ...
                        $vat      += $row->item_tax;
                        $total    += $row->subtotal;
                        $profit   += ($row->subtotal - ($row->quantity * $row->unit_cost));
                        $i++;
                        }
                    }?>
                        <tr>
                            ...
                            <td><strong><?= $this->bpas->formatDecimal($cost); ?></strong></td>
                            <td><strong><?= $this->bpas->formatDecimal($price); ?></strong></td>
                            <td><strong><?= $this->bpas->formatDecimal($subtotal); ?></strong></td>
                            <td><strong><?= $this->bpas->formatDecimal($discount); ?></strong></td>
                            <td><strong><?= $this->bpas->formatDecimal($vat); ?></strong></td>
                            <td><strong><?= $this->bpas->formatDecimal($total); ?></strong></td>
                            <td><strong><?= $this->bpas->formatDecimal($profit); ?></strong></td>
                            <td></td>
                        </tr>
                </table>
