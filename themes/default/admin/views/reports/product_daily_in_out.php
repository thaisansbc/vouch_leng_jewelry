...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PrRData2').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getProductsDaily/?v=1'.$v) ?>',
                ...
                <?php if (!empty($warehouses)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('reports/product_daily_in_out') ?>"><i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($warehouses as $warehouse) {
                               echo '<li><a href="' . admin_url('reports/product_daily_in_out/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12" >
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/product_daily_in_out"); ?>
                    <div class="row">
                        <div class="col-sm-4">
