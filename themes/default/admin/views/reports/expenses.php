...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getExpensesReport' . ($biller_id ? '/' . $biller_id : '') . '/?v=1' . $v); ?>',
...
<div class="box">
    <div class="box-header">
        ...
        ?>
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('expenses_report') . ' (' . $biller_title . ')'; ?> <?php
            if ($this->input->post('start_date')) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open('reports/expenses' . ($biller_id ? '/' . $biller_id : '')); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getExpensesReport/' . ($biller_id ? $biller_id : 0) . '/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getExpensesReport/' . ($biller_id ? $biller_id : 0) . '/0/xls/?v=1' . $v)?>";
            return false;
        });
