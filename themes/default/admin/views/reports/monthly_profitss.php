            ...
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                            <h4><span><?= $this->bpas->formatMoney($costing->sales); ?></span></h4>
                            <!-- <h4><span><?= $this->bpas->formatMoney($costing->sales).' ('.$this->bpas->formatMoney($costing->net_sales).')'; ?></span></h4>-->
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:right;border-bottom: 1px solid #DDD;">
                        <h4>
                            <span><?php $discount = $discount ? $discount->order_discount : 0; echo $this->bpas->formatMoney($discount); ?></span>
                        </h4>
                    </td>
                </tr>
				<tr>
                    ...
                    <td style="text-align:right;border-bottom: 1px solid #DDD;">
                        <h4>
                            <span><?= $this->bpas->formatMoney($shipping->shippings); ?></span>
                        </h4>
                    </td>
                </tr>
				<tr style="display:none;">
                    ...
                    <td style="text-align:right;border-bottom: 1px solid #DDD;">
                        <h4>
                            <span><?= $this->bpas->formatMoney($order_tax->order_taxs); ?></span>
                        </h4>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                        <h4><span><?= $this->bpas->formatMoney($costing->cost); ?></span></h4>
                        <!-- <h4><span><?= $this->bpas->formatMoney($costing->cost).' ('.$this->bpas->formatMoney($costing->net_cost).')'; ?></span></h4> -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <h4>
                            <span><strong><?= $this->bpas->formatMoney($costing->sales - $costing->cost - $discount +$order_tax->order_taxs +$shipping->shippings - $expense); ?></strong></span>
