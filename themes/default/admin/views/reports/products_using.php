...
<script>
    $(document).ready(function () {
        ...
        function qnp_table(x) {
            ...
            var strText = '';
            if (v.length == 1) {
                strText = '<table border="1" width="100%" style="padding: 3px; table-layout: fixed; word-wrap: break-word;"><tr>';
                strText +=  '<td style="padding-right: 5px; text-align: right;">'+formatQuantity2(v[0])+'</td>';
                strText += '</tr></table>';
            } else {
                strText = '<table border="1" width="100%" style="padding: 3px; table-layout: fixed; word-wrap: break-word;"><tr>';
                strText +=  '<td style="width: 33%; padding-right: 5px; text-align: right;">'+formatQuantity2(v[0])+'</td>';
                strText +=  '<td style="width: 33%; padding-right: 5px; text-align: right;">'+formatQuantity2(v[1])+'</td>';
                strText +=  '<td style="width: 33%; padding-right: 5px; text-align: right;">'+formatQuantity2(v[2])+'</td>';
                strText += '</tr></table>';
            }
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getProductsUsingReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [
                null, null, {"mRender": qnp_table, "bSortable": false}, {"mRender": qnp_table, "bSortable": false}, {"mRender": qnp_table, "bSortable": false}, {"mRender": qnp_table, "bSortable": false}, {"mRender": qnp_table, "bSortable": false}, 
            ],
            ...
            //         v  = (aaData[aiDisplay[i]][9]).split('__');
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('products_using_report'); ?> <?php
            if ($this->input->post('start_date')) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open('reports/products_using_report'); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getProductsUsingReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getProductsUsingReport/0/xls/?v=1' . $v)?>";
            return false;
        });
        $('#preview').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getProductsUsingReport/0/0/preview/?v=1' . $v)?>";
            return false;
        });
