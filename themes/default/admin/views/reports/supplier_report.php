        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="small-box padding1010 col-sm-4 bblue">
                    <h3><?= isset($purchases->total_amount) ? $this->bpas->formatMoney($purchases->total_amount) : '0.00' ?></h3>
                        ...
                        <div class="table-responsive">
                            ...
                            <tfoot class="dtFilter">
                                <tr class="active">
                                    ...
                                    <th style="width:10%!important;"><?= lang('grand_total'); ?></th>
                                    <th style="width:8%!important;"><?= lang('paid'); ?></th>
                                    <th style="width:10%!important;"><?= lang('balance'); ?></th>
                                    <th></th>
                                </tr>
                            </tfoot>
                        </table>
