...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#registerTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getRegisterlogs/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld}, {"mRender": fld}, null, {"mRender": currencyFormat},  {"mRender": total_cash},  {"mRender": total_cash},  {"mRender": total_cash}, {"mRender": decode_html}, {"bSortable": false}],
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getRegisterlogs/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getRegisterlogs/0/xls/?v=1' . $v)?>";
            return false;
        });
