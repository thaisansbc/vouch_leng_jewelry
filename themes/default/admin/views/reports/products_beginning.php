    ...
    $(document).ready(function () {
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                $('td', nRow).eq(8).addClass('reward_exchange');
                $('td', nRow).eq(9).addClass('reward_exchange');
                return nRow;
            },
            "aoColumns": [null, null, {"mRender": sps}, {"mRender": spb}, {"mRender": spt}, {"mRender": spj}, {"mRender": spb}, {"mRender": sps}, {"mRender": spt}, {"mRender": spt}, {"mRender": sps}, {"mRender": qnp}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var beginning = 0; var purchases = 0; var transfers = 0; var adjustments = 0; var sold = 0; var returns = 0; var stock = 0; var reward_exchanged = 0; var reward_received = 0;
                var sn = 0, so = 0, sb = 0;
                for (var i = 0; i < aaData.length; i++) {
                    t    = (aaData[aiDisplay[i]][4]).split('__');
                    j    = (aaData[aiDisplay[i]][5]).split('__');
                    s    = (aaData[aiDisplay[i]][6]).split('__');
                    rwex = (aaData[aiDisplay[i]][8]).split('__');
                    rwre = (aaData[aiDisplay[i]][9]).split('__');
                    v    = (aaData[aiDisplay[i]][11]).split('__');
                    ...
                    reward_exchanged += parseFloat(rwex[0]);
                    reward_exchanged -= parseFloat(rwex[1]);
                    reward_received  += parseFloat(rwre[0]);
                    reward_received  -= parseFloat(rwre[1]);
                    stock            += parseFloat(aaData[aiDisplay[i]][10]);
                    sn               += (v[0] ? parseFloat(v[0]) : 0);
                    so               += (v[2] ? parseFloat(v[2]) : 0);
                    sb               += (v[4] ? parseFloat(v[4]) : 0);
                }
                ...
                nCells[8].innerHTML  = '<div class="text-right pull-right" style="width: 100px !important;">'+formatQuantity2(reward_exchanged)+'</div>';
                nCells[9].innerHTML  = '<div class="text-right pull-right" style="width: 100px !important;">'+formatQuantity2(reward_received)+'</div>';
                nCells[10].innerHTML = '<div class="text-right pull-right" style="width: 120px !important;">'+formatQuantity2(stock)+'</div>';
                nCells[11].innerHTML = '<div class="text-right pull-right" style="width: 100px !important;">('+formatQuantity2(sn)+')New, ('+formatQuantity2(so)+')Old, ('+formatQuantity2(sb)+')Broken</div>';
            }
...
<style type="text/css">
    ...
    <?php if (!$Settings->reward_exchange) { ?>
        .reward_exchange { display: none !important; }
    <?php } ?>
</style>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open('reports/products'); ?>ddd
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls" id="subcat_data"> 
                                    <?php echo form_input('subcategory', (isset($_POST['subcategory']) ? $_POST['subcategory'] : ''), 'class="form-control" id="subcategory"  placeholder="' . lang('select_category_to_load') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <table id="PrRData" class="table table-striped table-bordered table-condensed table-hover dfTable reports-table" style="margin-bottom: 5px;">
                        <thead>
                            <tr class="active">
                                ...
                                <th style="text-align: right !important;"><?= lang('beginning'); ?></th>
                                <th style="text-align: right !important;"><?= lang('purchased'); ?></th>
                                <th style="text-align: right !important;"><?= lang('transfer'); ?></th>
                                <th style="text-align: right !important;"><?= lang('adjustment'); ?></th>
                                <th style="text-align: right !important;"><?= lang('sold'); ?></th>
                                <th style="text-align: right !important;"><?= lang('return'); ?></th>
                                <th style="text-align: right !important;" class="reward_exchange"><?= 'R.' . lang('exchanged'); ?></th>
                                <th style="text-align: right !important;" class="reward_exchange"><?= 'R.' . lang('received'); ?></th>
                                <th style="text-align: right !important;"><?= lang('stock_in_hand'); ?></th>
                                <th style="text-align: right !important;"><?= lang('variants'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
