<?php
	...
	if ($this->input->post('submit_view_customer_balance')) {
        ...
        $sales_type     = $this->bpas->fld($this->input->post('sales_type'));
        $issued_by      = $this->bpas->fld($this->input->post('issued_by'));
	}
?>
...
<script>
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
			...
			'sAjaxSource': '<?= admin_url('reports/getSalemanReportDetail/?v=1' .$v) ?>',
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
				<?php echo admin_form_open("reports/view_saleman_report/" . $user_id); ?>
                    <div class="row">
                        <div class="col-sm-4">
