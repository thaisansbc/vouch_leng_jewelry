                    ...
                    <?php if (!empty($charts) && ($Owner || $Admin)) { ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu"
                                ...
                                <li><a href="<?= admin_url('reports/cash_chart') ?>"><i
                                            class="fa fa-building-o"></i> <?= lang('all_charts') ?></a></li>
                                <li class="divider"></li>
                                <?php
                                foreach ($charts as $chart) {
                                    echo '<li ' . ($account_id && $accountcode == $chart->accountcode ? 'class="active"' : '') . '><a href="' . admin_url('reports/cash_chart/' . $chart->accountcode) . '"><i class="fa fa-building"></i>' . $chart->accountname . '</a></li>';
                                }
                                ?>
                            </ul>
                        </li>
