        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="small-box padding1010 col-sm-4 bblue">
                    <h3 class="bold"><?= isset($sales->total_amount) ? $this->bpas->formatMoney($sales->total_amount) : '0.00' ?></h3>
            ...
            <div class="col-sm-6">
                <div class="small-box padding1010 col-sm-4 bblue">
                    <h3 class="bold"><?= isset($purchases->total_amount) ? $this->bpas->formatMoney($purchases->total_amount) : '0.00' ?></h3>

                    <p class="bold"><?= $purchases->total . ' ' . lang('purchases') ?></p>
                </div>
                <div class="small-box padding1010 col-sm-4 blightOrange">
                    <h3><?= isset($purchases->paid) ? $this->bpas->formatMoney($purchases->paid) : '0.00' ?></h3>

                    <p><?= lang('total_paid') ?></p>
                </div>
                <div class="small-box padding1010 col-sm-4 borange">
                    <h3><?= (isset($purchases->total_amount) || isset($purchases->paid)) ? $this->bpas->formatMoney($purchases->total_amount - $purchases->paid) : '0.00' ?></h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.table .day_num').click(function () {
                ...
                var href = '<?= admin_url('reports/profit_by_pm'); ?>/'+ date + '/' + user_id;
            ...
            $('#pdf').click(function (event) {
                ...
                window.location.href = "<?=admin_url('reports/daily_sales/'.$year.'/'.$month.'/pdf')?>";
                return false;
            });
    ...
    <div id="monthly-con" class="tab-pane fade in">
                        ...
                        <?php if (!empty($warehouses) && !$this->session->userdata('warehouse_id')) { ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                    <li><a href="<?=admin_url('reports/monthly_sales_by_pm/0/'.$year)?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                                    <li class="divider"></li>
                                    <?php
                                        foreach ($warehouses as $warehouse) {
                                                echo '<li><a href="' . admin_url('reports/monthly_sales_by_pm/'.$warehouse->id.'/'.$year) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                            }
                                        ?>
                                </ul>
                            </li>
                            ...
                            <table class="table table-striped dfTable reports-table">
                                ...
                                <tr>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/01/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_january"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/02/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_february"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/03/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_march"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/04/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_april"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/05/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_may"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/06/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_june"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/07/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_july"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/08/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_august"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/09/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_september"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/10/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_october"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/11/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_november"); ?>
                                        </a>
                                    </td>
                                    <td class="bold text-center">
                                        <a href="<?= admin_url('reports/monthly_profit_by_pm/'.$year.'/12/'.$user_id); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
                                            <?= lang("cal_december"); ?>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    if (!empty($sales_monthly)) {
                                        foreach ($sales_monthly as $value) {
                                            $array[$value->date] = "<table class='table table-hover table-striped table-condensed data' style='margin:0;'><tbody>
                                            <tr><td>" . $this->lang->line("amount") . "</td></tr>
                                            <tr><td>" . $this->bpas->formatMoney($value->total) . "</td></tr>
                                            <tr><td>" . $this->lang->line("order_discount") . "</td></tr>
                                            <tr><td>" . $this->bpas->formatMoney($value->order_discount) . "</td></tr>
                                            <tr><td>" . $this->lang->line("shipping") . "</td></tr>
                                            <tr><td>" . $this->bpas->formatMoney($value->shipping) . "</td></tr>
                                            <tr><td>" . $this->lang->line("product_tax") . "</td></tr>
                                            <tr><td>" . $this->bpas->formatMoney($value->tax1) . "</td></tr>
                                            <tr><td>" . $this->lang->line("order_tax") . "</td></tr>
                                            <tr><td>" . $this->bpas->formatMoney($value->tax2) . "</td></tr>
                                            <tr><td>" . $this->lang->line("total") . "</td></tr>
                                            <tr><td>" . $this->bpas->formatMoney($value->total - $value->order_discount)  . "</td></tr>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#pdf').click(function (event) {
                    event.preventDefault();
                    window.location.href = "<?=admin_url('reports/monthly_sales_by_pm/'.$year.'/pdf')?>";
                    return false;
                });
                $('#image').click(function (event) {
                    event.preventDefault();
        ...
        <script>
            $(document).ready(function () {
                var oTable = $('#SlRData').dataTable({
                    ...
                    'sAjaxSource': '<?= admin_url('reports/get_sale_report_by_pm/?v=1' . $v) ?>',
        ...
        <script>
            $(document).ready(function () {
                var oTable = $('#SORBPMData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= admin_url('reports/get_so_report_by_pm/?v=1' . $v) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
