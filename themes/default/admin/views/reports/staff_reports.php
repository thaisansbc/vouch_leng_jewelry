                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table dfTable reports-table ">
                                <tr class="year_roller">
                                 ...
                                 <tr>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id."/$year/01"); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_january"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/02'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_february"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/03'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_march"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/04'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_april"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/05'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_may"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/06'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_june"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/07'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_july"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/08'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_august"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/09'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_september"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/10'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_october"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/11'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_november"); ?>
										</a>
									</td>
									<td class="bold text-center">
										<a href="<?= admin_url('reports/monthly_profits/'.$user_id.'/'.$year.'/12'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
											<?= lang("cal_december"); ?>
										</a>
									</td>
								</tr>
                                <tr>
                                    ...
                                    if (!empty($msales)) {
                                        ...
                                        foreach ($msales as $value){
                                            ...
                                            $array[$value->date] = "<table class='table table-hover table-striped table-condensed data' style='margin:0;color:#428BCA;'><tr><td>" . lang("total") . "</td></tr><tr><td>" . $this->bpas->formatMoney($value->total). "</td></tr>
											<tr><td>" . lang("order_discount") . "</td></tr><tr><td>" . $this->bpas->formatMoney($value->order_discount)."</td></tr>
											<tr><td>" . lang("product_tax") . "</td></tr><tr><td>" . $this->bpas->formatMoney($value->tax1)."</td></tr><tr><td>" . lang("order_tax") . "</td></tr><tr><td>" . $this->bpas->formatMoney($value->tax2)."</td></tr><tr><td>" . lang("grand_total") . "</td></tr><tr><td>" . $this->bpas->formatMoney($grand_total). "</td></tr><tr><td>" . lang("award_points") . "</td></tr><tr><td>" . intval($value->total / $this->Settings->each_sale) . "</td></tr></table>";
                                        }
        ...
        <script>
            $(document).ready(function () {
                ...
                var oTable = $('#PayRData').dataTable({
                    ...
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= admin_url('reports/getPaymentsReportStaff/?v=1' . $p) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table id="LGTable"
                                               class="table table-hover table-striped reports-table">
                                            <thead>
                                            <tr>
                                                <th><?= lang('email'); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
		$('.table .day_num').click(function (){
            ...
            var href = '<?= admin_url('reports/profit_staff/'.$user_id); ?>/'+date;
