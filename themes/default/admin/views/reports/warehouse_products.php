        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/warehouse_reports"); ?>
                    <div class="row">
                        <div class="col-sm-3">
										...
										if ($q->num_rows() > 0) {
											...
											foreach ($q->result() as $row) {												
												if($row->qb == ""){
													...
													echo '<td class="ware'. $ware->id .'" title="'. $ware->id .'">'.$this->bpas->formatQuantity($row->qb).'</td>';
								...
								<td>
									<div class="text-right">
										<div class="btn-group text-left total">
											<?= $this->bpas->formatQuantity($total_wh_amount); ?>
										</div>
									</div>
								</td>
							</tr>
