        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/adjustment_report/",'method="GET"'); ?>
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <?php echo form_input('start_date', (isset($_GET['start_date']) ? $_GET['start_date'] : $this->bpas->hrsd($start_date)), 'class="form-control date" id="start_date"'); ?>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <?= lang("end_date", "end_date"); ?>
                                <?php echo form_input('end_date', (isset($_GET['end_date']) ? $_GET['end_date'] : $this->bpas->hrsd($end_date)), 'class="form-control date" id="end_date"'); ?>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-condensed table-striped">
						...
						foreach($items as $item){ 
						       $query=$this->db->query("
							           SELECT bpas_adjustment_items.quantity as qty_adjust,bpas_adjustment_items.type,bpas_products.code as codes,bpas_products.name as product_names,bpas_products.quantity as QOH,bpas_product_variants.name as variant,bpas_units.name as unit
                                       From bpas_adjustment_items
									   left JOIN bpas_products ON bpas_products.id=bpas_adjustment_items.product_id 
										LEFT JOIN bpas_product_variants ON bpas_product_variants.id = bpas_adjustment_items.option_id 
										LEFT JOIN bpas_units ON bpas_units.id=bpas_products.unit  
									   where bpas_adjustment_items.adjust_id = {$item->id}
					...
					?>
						       <tr>
								   ...
								   <td class="text-center"><?= $this->bpas->formatQuantity($q->qty_adjust)?></td>  
							   </tr>
