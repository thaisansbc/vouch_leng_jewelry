...
<script>
    $(document).ready(function () {
        oTable = $('#FCustomerData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getFuelCustomersReport/?v=1' . $v); ?>',
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("reports/fuel_customers_report"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?= admin_url('reports/getFuelCustomersReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getFuelCustomersReport/0/xls/?v=1'.$v)?>";
            return false;
        });
