        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/saleman_detail"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <?php 
							...
							?>
								<tr>
									...
									<td><?= $row->due_date ? $this->bpas->hrld($row->due_date) : '' ?></td>
                                    ...
                                    <td class="text-right"><?= $this->bpas->formatMoney($row->grand_total) ?></td>
                                    <td class="text-right"><?= $this->bpas->formatMoney($row->return_sale) ?></td>
                                    <td class="text-right"><?= $this->bpas->formatMoney($row->paid) ?></td>
                                    <td class="text-right"><?= $this->bpas->formatMoney($row->deposit) ?></td>
                                    <td class="text-right"><?= $this->bpas->formatMoney($row->discount) ?></td>
                                    <td class="text-right"><?= $this->bpas->formatMoney($row->balance) ?></td>
									<td class="text-center">
							...
							<tr>
									...
									<td class="text-right"><b><?= $this->bpas->formatMoney($total_return_sale) ?></b></td>
                                    <td class="text-right"><b><?= $this->bpas->formatMoney($total_paid) ?></b></td>
                                    <td class="text-right"><b><?= $this->bpas->formatMoney($total_deposit) ?></b></td>
									<td class="text-right"><b><?= $this->bpas->formatMoney($total_discount) ?></b></td>
                                    <td class="text-right"><b><?= $this->bpas->formatMoney($total_balance) ?></b></td>
							...
							<tr class="foot">
								...
								<td class="text-right"><b><?=$this->bpas->formatMoney($grand_total_sales)?></b></td>
								<td class="text-right"><b><?=$this->bpas->formatMoney($grand_total_return)?></b></td>
                                <td class="text-right"><b><?=$this->bpas->formatMoney($grand_total_paid)?></b></td>
                                <td class="text-right"><b><?=$this->bpas->formatMoney($grand_total_deposit)?></b></td>
                                <td class="text-right"><b><?=$this->bpas->formatMoney($grand_total_discount)?></b></td>
								<td class="text-right"><b><?=$this->bpas->formatMoney($grand_total_balance)?></b></td>
...
<script>
    $(document).ready(function(){
       ...
       /* $("#excel").click(function(e){
            e.preventDefault();
            window.location.href = "<?= admin_url('reports/saleman_detail_action/0/xls/'.$saleman2) ?>";
            return false;
        });
        $('#pdf').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/saleman_detail_action/pdf/?v=1'.$v)?>";
            return false;
        });*/
