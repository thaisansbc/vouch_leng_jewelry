...
<script>
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getLeasingReport/?v=1' . $v) ?>',
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var gtotal = 0, paid = 0, balance = 0;interest = 0;
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('loans_report'); ?> <?php
            if ($this->input->post('start_date')) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("reports/loans"); ?>
                    <div class="row">
                ...
                <div class="table-responsive">
                    <table id="SlRData"
                        ...
                        <tr>
							...
							<th><?= lang("sale_ref"); ?></th>
                            <th><?= lang("paid"); ?></th>
                            <th><?= lang("loan_payment"); ?></th>
                            <th><?= lang("monthly_payment"); ?></th>
                            <th><?= lang("interest"); ?></th>
                            <th><?= lang("status"); ?></th>
						</tr>
                        </thead>
