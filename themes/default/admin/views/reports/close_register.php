    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?= lang('close_register') . ' (' . $this->bpas->hrld($register_open_time ? $register_open_time : $this->session->userdata('register_open_time')) . ' - ' . $this->bpas->hrld($inv->closed_at) . ')'; ?></h4>
        </div>
            ...
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->bpas->formatMoney($inv->cash_in_hand); ?></span></h4>
                    </td>
                </tr>
                <tr>
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <h4>
                            <?php if ($pos_settings->allow_total_cash_in_hand == 1) { ?>
                            ...
                            <?php } else { ?>
                                <?php $total_cash_amount = $cashsales->paid ? (($cashsales->paid) + ($refunds->returned ? $refunds->returned : 0) - ($returns->total ? $returns->total : 0) - $expense) : ($this->session->userdata('cash_in_hand') - $expense - ($returns->total ? $returns->total : 0)); ?>
                            <?php } ?>
                ...
                <tr>
                    <td width="300px;" style="font-weight:bold;">
                        <?php if ($pos_settings->allow_total_cash_in_hand == 0) { ?>
                    ...
                    <table style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                $totalTax = 0;
                                $totalDiscount = 0;
                                $getProductsInOut = $this->reports_model->getProductsInOut($category->category_id, null, $inv->date, $inv->closed_at, $inv->user_id);
                                $j = 1;
