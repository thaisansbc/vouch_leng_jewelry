        ...
        <script>
			$(document).ready(function () {
				...
				var oTable = $('#SlRData').dataTable({
					...
					'sAjaxSource': '<?= admin_url('reports/getCustomerSaleReport/?v=1' .$v) ?>',
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
							<table id="SlRData" class="table table-hover table-striped table-condensed reports-table reports-table">
                                <thead>
                                    <tr>
        ...
        <script>
			$(document).ready(function () {
				...
				var oTable = $('#SOData').dataTable({
					...
					"iDisplayLength": <?= $Settings->rows_per_page ?>,
					'bProcessing': true, 'bServerSide': true,
					'sAjaxSource': '<?= admin_url('reports/getCustomerSaleOrderReport/?v=1' .$v) ?>',
					'fnServerData': function (sSource, aoData, fnCallback) {
						aoData.push({
							"name": "<?= $this->security->get_csrf_token_name() ?>",
							"value": "<?= $this->security->get_csrf_hash() ?>"
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
							<table id="SOData" class="table table-hover table-striped table-condensed reports-table reports-table">
                                <thead>
                                    <tr>
										<th style="text-align: center;">
			...
			<div class="box-content">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="table-responsive">
							<table id="QuRData" class="table table-hover table-striped table-condensed">
								<thead>
									<tr>
										<th><?= lang("date"); ?></th>
										<th><?= lang("reference_no"); ?></th>
	...
	<div id="returns-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			var oTable = $('#PRESLData').dataTable({
				...
				"iDisplayLength": <?= $Settings->rows_per_page ?>,
				'bProcessing': true, 'bServerSide': true,
				'sAjaxSource': '<?= admin_url('reports/getReturnsReport/?v=1&customer='.$user_id) ?>',
				'fnServerData': function (sSource, aoData, fnCallback) {
					aoData.push({
						"name": "<?= $this->security->get_csrf_token_name() ?>",
						"value": "<?= $this->security->get_csrf_hash() ?>"
			...
			<div class="box-content">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="table-responsive">
							<table id="PRESLData" class="table table-hover table-striped">
								<thead>
									<tr>
										<th><?= lang("date"); ?></th>
										<th><?= lang("reference_no"); ?></th>
	...
	<div id="deposits-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			...
			var oTable = $('#DEPData').dataTable({
					...
					"iDisplayLength": <?= $Settings->rows_per_page ?>,
					'bProcessing': true, 'bServerSide': true,
					'sAjaxSource': '<?= admin_url('reports/getDepositsReport/?v=1&customer='.$user_id) ?>',
					'fnServerData': function (sSource, aoData, fnCallback) {
						aoData.push({
							"name": "<?= $this->security->get_csrf_token_name() ?>",
							"value": "<?= $this->security->get_csrf_hash() ?>"
			...
			<div class="box-content">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="table-responsive">
							<table id="DEPData" class="table table-hover table-striped">
								<thead>
								<tr class="primary">
	...
	<div id="products-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			...
			var oTable = $('#PRPData').dataTable({
					...
					"iDisplayLength": <?= $Settings->rows_per_page ?>,
					'bProcessing': true, 'bServerSide': true,
					'sAjaxSource': '<?= admin_url('reports/getProductsReports1/?v=1'.$p) ?>',
					'fnServerData': function (sSource, aoData, fnCallback) {
						aoData.push({
							"name": "<?= $this->security->get_csrf_token_name() ?>",
							"value": "<?= $this->security->get_csrf_hash() ?>"
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="proform">
                            ...
                            <?php echo admin_form_open("reports/customer_sale_report/" . $user_id."#products-con"); ?>
                            <div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<?= lang("start_date", "start_date"); ?>
						...
						<div class="table-responsive">
							<table id="PRPData" class="table table-hover table-striped">
								<thead>
								<tr class="primary">
									<th style="min-width:30px; width: 30px; text-align: center;">
										<input class="checkbox checkth" type="checkbox" name="check"/>
	...
	<div id="expenese-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			...
			var oTable = $('#EXData').dataTable({
					...
					"iDisplayLength": <?= $Settings->rows_per_page ?>,
					'bProcessing': true, 'bServerSide': true,
					'sAjaxSource': '<?= admin_url('reports/getExpenses/?v=1'.$p) ?>',
					'fnServerData': function (sSource, aoData, fnCallback) {
						aoData.push({
							"name": "<?= $this->security->get_csrf_token_name() ?>",
							"value": "<?= $this->security->get_csrf_hash() ?>"
		...
		<div class="box">
			<div class="box-content">
				<div class="row">
					<div class="col-lg-12">
						<div class="table-responsive">
							<table id="EXData" class="table table-hover table-striped">
								<thead>
								<tr class="primary">
									<th style="min-width:30px; width: 30px; text-align: center;">
										<input class="checkbox checkth" type="checkbox" name="check"/>
