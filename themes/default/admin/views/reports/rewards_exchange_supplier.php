...
<script>
    $(document).ready(function() {
        ...
        oTable = $('#SLData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('reports/getRewardsExchangeSupplier/?v=1' . $v) ?>',
...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('rewards_exchange_suppiler_reports');?></h2>
    <div class="box-icon">
        <ul class="btn-tasks">
            <li class="dropdown">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("reports/supplier_rewards_exchange_report"); ?>
                    <div class="row">
                    <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#xls').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getRewardsExchangeSupplier/xls/?v=1' . $v)?>";
            return false;
        });
        $('#xls2').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getRewardsExchangeSupplier/0/xls2/?v=1' . $v)?>";
            return false;
        });
    });
</script>