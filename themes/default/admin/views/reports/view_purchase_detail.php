                    ...
                    <?php if (!empty($purchase_details)) {
                        foreach ($purchase_details as $pur_detail) { ?>
                            <tr>
								...
								<td><?= $this->bpas->formatDecimal($pur_detail->item_tax); ?></td>
								<td><?= $this->bpas->formatDecimal($pur_detail->discount); ?></td>
                                <td><?= $this->bpas->formatDecimal($pur_detail->unit_cost); ?></td>
								<td><?= $this->bpas->formatDecimal($pur_detail->shipping); ?></td>
                                <td><?= $this->bpas->formatQuantity($pur_detail->quantity); ?></td>
								<td><?= $this->bpas->formatMoney(($pur_detail->unit_cost*$pur_detail->quantity) + $pur_detail->shipping); ?></td>
                            </tr>
                        <?php }
                    } else {
