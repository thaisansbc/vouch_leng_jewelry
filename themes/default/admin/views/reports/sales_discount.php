...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getSalesDiscountReport/?v=1' . $v) ?>',
	...
	<div class="box-content">
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    <?php echo admin_form_open("reports/sales_discount"); ?>
                    <div class="row">
						<div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="rcustomer"><?= lang("customer"); ?></label><br>
