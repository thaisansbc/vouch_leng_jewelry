                    ...
                    <?php if (!empty($sale_details)) {
                        foreach ($sale_details as $sale_detail) { ?>
                            <tr>
                                ...
                                <td><?= $this->bpas->formatDecimal($sale_detail->unit_price); ?></td>
                                <td><?= $this->bpas->formatQuantity($sale_detail->quantity); ?></td>
								<td><?= $this->bpas->formatMoney($sale_detail->unit_price*$sale_detail->quantity); ?></td>
                            </tr>
                        <?php }
                    } else {
