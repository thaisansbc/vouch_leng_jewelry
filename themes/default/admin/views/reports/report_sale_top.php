...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRDatas').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getSaleTop/?v=1' . $v) ?>',
...
<?php if ($Owner) {
    echo admin_form_open('reports/sale_top_action', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <input type="hidden" name="start_date" value="<?= $this->input->post('start_date') ;?>">
                <input type="hidden" name="end_date" value="<?= $this->input->post('end_date') ;?>">
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("reports/report_sale_top"); ?>
                    <div class="row">
                        <div class="col-sm-4">
