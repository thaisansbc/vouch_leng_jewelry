    ...
    $(function () {
        ...
        $('#chart').highcharts({
            ...
            series: [{
                ...
                data: [
                    ['<?php echo $this->lang->line('stock_value_by_price'); ?>', <?= $this->bpas->formatMoney($total_return_sales->total_amount) ?>],
                    ['<?php echo $this->lang->line('stock_value_by_cost'); ?>', <?= $this->bpas->formatMoney($total_payment_received->total_amount) ?>],
            ...
            <div class="box-icon">
                ...
                <div class="controls">
                    <div class="input-group">
                        ...
                        <input type="text"
                            value="<?= (isset($start) ? $this->bpas->hrld($start) : '') . ' - ' . (isset($end) ? $this->bpas->hrld($end) : ''); ?>"
