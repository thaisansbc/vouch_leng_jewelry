...
<script>
    $(document).ready(function () {
        CURI = '<?= admin_url('reports/payments_received'); ?>'; 
    });
</script>
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            'bProcessing': true, 
            'bServerSide': true,
            'sAjaxSource': '<?= admin_url('reports/getPaymentsReceivedReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [
                // NO, Date, Ref, Customer, Paid By, Total Pay, Penalty, Discount, Grand Total, Type, Action
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var total_pay = 0, penalty = 0, discount = 0, grand_total = 0;
                for (var i = 0; i < aaData.length; i++) {
                    total_pay   += parseFloat(aaData[aiDisplay[i]][5]);
                    penalty     += parseFloat(aaData[aiDisplay[i]][6]);
                ...
                nCells[6].innerHTML = currencyFormat(parseFloat(penalty));
...
<style>
    #dtFilter-filter--PayRData-9 { text-align: center; }
</style>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('payments_received_report'); ?> 
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open('reports/payments_received'); ?>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <table id="PayRData" class="table table-hover table-condensed reports-table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?= lang('customer'); ?></th>
                                <th><?= lang('paid_by'); ?></th>
                                <th style="text-align: right !important; width: 10% !important;"><?= lang('total_pay'); ?></th>
                                <th style="text-align: right !important; width: 10% !important;"><?= lang('penalty'); ?></th>
                                <th style="text-align: right !important; width: 10% !important;"><?= lang('discount'); ?></th>
                                <th style="text-align: right !important; width: 10% !important;"><?= lang('grand_total'); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getPaymentsReceivedReport/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getPaymentsReceivedReport/0/xls/?v=1' . $v)?>";
            return false;
        });
        $('#preview').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getPaymentsReceivedReport/0/0/preview/?v=1' . $v)?>";
            return false;
        });
        $('#transfer').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getPaymentsReceivedReport/0/0/0/transfer/?v=1' . $v)?>";
            return false;
        });
