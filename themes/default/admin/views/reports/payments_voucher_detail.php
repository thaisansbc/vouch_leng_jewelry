...
<head>
	<meta charset="UTF-8">
	<title><?= lang('payments_voucher_detail') ?></title>
...
<body>
			...
			<div style="position: relative; min-height: 28.5cm;">
				...
				<div class="row" style="font-size: 14px; margin-top: 15px !important;">
						...
						<table style="width: 100%;">
							<tbody>
								...
								<tr>
									<td><?= lang('vender') ?></td>
									<td>:</td>
									<td><?= $supplier ? ($supplier->company && $supplier->company != '-' ? $supplier->company : $supplier->name) : ''; ?></td>
								</tr>
								<tr>
									<td><?= lang('phone') ?></td>
									<td>:</td>
								...
								<tr>
									...
									<td style="vertical-align: top;"><?= $supplier ? ($supplier->address . ' ' . $supplier->postal_code . ' ' . $supplier->city . ' ' . $supplier->country . ' ' . $supplier->state) : ''; ?></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="col-xs-5">
						<table style="width: 100%;">
							<tbody>
								<tr>
									<td style="width: 34%; vertical-align: top;"><?= lang('company') ?></td>
								...
								<tr>
									<td><?= lang('phone') ?></td>
									<td>:</td>
									<td><?= $warehouse ? $warehouse->phone : ''; ?></td>
								</tr>
								<tr>
									<td style="vertical-align: top;"><?= lang('address') ?></td>
									<td style="vertical-align: top;">:</td>
									<td style="vertical-align: top;"><?= $warehouse ? strip_tags($warehouse->address) : ''; ?></td>
								</tr>
								<tr>
				...
				<div class="row">
					<div class="col-xs-12 text-center">
						<h3 style="font-family: 'Khmer OS Muol Light'; margin-top: 15px; color: #2874A6 !important;">បណ្ណបង់ប្រាក់</h3>
						<h4 style="font-weight: bold; font-family: 'Time New Romance';"><?= strtoupper(lang('payment_voucher')); ?></h4>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-12">
	...
	<div style="width: 21cm; margin: 0 auto;">
		<a class="btn btn-warning no-print" href="<?= admin_url('reports/payments_voucher'); ?>">
