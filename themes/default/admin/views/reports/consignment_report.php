...
<ul id="myTab" class="nav nav-tabs no-print">
    <li class=""><a href="#sales-con" class="tab-grey"><?= lang('consignment') ?></a></li>
    ...
    <div id="sales-con" class="tab-pane fade in">
        ...
        <div class="box sales-table">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-heart nb"></i><?= lang('consignment_report'); ?> <?php
                if ($this->input->post('start_date')) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="form">
                            ...
                            <?php echo admin_form_open('reports/consignment_report/' . $product); ?>
                            <div class="row">
