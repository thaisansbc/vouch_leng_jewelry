                    ...
                    <table id="PRData" class="table table-hover table-striped table-condensed">
                        ...
                        <tbody>
							...
							<tr>
								...
								<td class="text-right"><?= $this->bpas->formatQuantity($p_qty) ?> <br><?php  echo $unit_name;?></td>
								<td class="text-right"><?= $p_cost ?></td>
								<td class="text-right"><?= $this->bpas->formatQuantity($qty_on_hand) ?></td>
								<td class="text-right"><?= $cost ?></td>
								<td class="text-right"><?= $this->bpas->formatMoney($asset_value) ?></td>
							</tr>
							<?php 
	...
	$(document).ready(function(){
		...
		*/
		...
		$('#excel').on('click', function (e) {
            ...
            e.preventDefault();
                window.location.href = "<?= admin_url('reports/inventory/0/xls/'.$reference1.'/'.$wahouse_id1.'/'.$product_id1.'/'.$from_date1.'/'.$to_date1.'/'.$stockType1.'/'.$cate_id1.'/'.$biller1) ?>";
                return false;
        });
