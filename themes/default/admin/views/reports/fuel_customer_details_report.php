...
<script>
    $(document).ready(function () {
        oTable = $('#FCustomerDData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getFuelCustomerDetailsReport/?v=1' . $v); ?>',
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo admin_form_open("reports/fuel_customer_details_report"); ?>
                    <div class="row">
						<div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getFuelCustomerDetailsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getFuelCustomerDetailsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
