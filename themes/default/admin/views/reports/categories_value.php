<script>
    $(document).ready(function () {
        var oTable = $('#PrRData1').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getCategoriesValueReport/?v=1') ?>',
...
<script type="text/javascript">
    $(document).ready(function () {
        // $('#pdf').click(function (event) {
            ...
            // window.location.href = "<?=admin_url('reports/getCategoriesValueReport/pdf/?v=1'.$v)?>";
            // return false;
        // });
        // $('#xls').click(function (event) {
            // event.preventDefault();
            // window.location.href = "<?=admin_url('reports/getCategoriesValueReport/0/xls/?v=1'.$v)?>";
            // return false;
        // });
