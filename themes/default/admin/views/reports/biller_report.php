    ...
    <div id="sales-con" class="tab-pane fade in">
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#SlRData').dataTable({
                ...
                'sAjaxSource': '<?= admin_url('reports/getSellReport/?v=1' .$v) ?>',
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="form">
                            ...
                            <?php echo admin_form_open("reports/biller_report/" . $user_id); ?>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="purchaseform">
                            ...
                            <?php echo admin_form_open("reports/biller_report/" . $user_id."#purchase-con"); ?>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="payform">
                            ...
                            <?php echo admin_form_open("reports/biller_report/" . $user_id."/#payments-con"); ?>
                            <div class="row">
	...
	<div id="quotes-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			var oTable = $('#QuRData').dataTable({
				...
				"iDisplayLength": <?= $Settings->rows_per_page ?>,
				'bProcessing': true, 'bServerSide': true,
				'sAjaxSource': '<?= admin_url('reports/getQuotesReport/?v=1&biller='.$user_id) ?>',
				'fnServerData': function (sSource, aoData, fnCallback) {
					aoData.push({
						"name": "<?= $this->security->get_csrf_token_name() ?>",
						"value": "<?= $this->security->get_csrf_hash() ?>"
	...
	<div id="returns-con" class="tab-pane fade in">
		...
		$(document).ready(function () {
			var oTable = $('#PRESLData').dataTable({
				...
				"iDisplayLength": <?= $Settings->rows_per_page ?>,
				'bProcessing': true, 'bServerSide': true,
				'sAjaxSource': '<?= admin_url('reports/getReturnsReport/?v=1&biller='.$user_id) ?>',
				'fnServerData': function (sSource, aoData, fnCallback) {
					aoData.push({
						"name": "<?= $this->security->get_csrf_token_name() ?>",
						"value": "<?= $this->security->get_csrf_hash() ?>"
		...
		<script>
			$(document).ready(function () {
				...
				var oTable = $('#PrRData').dataTable({
					...
					"iDisplayLength": <?= $Settings->rows_per_page ?>,
					'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= admin_url('reports/getProductsBiller'.($warehouse_id ? '/'.$warehouse_id : '').'/?v=1'.$v) ?>',
					// 'sAjaxSource': '<?= admin_url('reports/getProductsBiller/?v=1'.$v) ?>',
					'fnServerData': function (sSource, aoData, fnCallback) {
						aoData.push({
							"name": "<?= $this->security->get_csrf_token_name() ?>",
							"value": "<?= $this->security->get_csrf_hash() ?>"
					...
					<ul class="btn-tasks">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                                <li><a href="<?= admin_url('reports/biller_report') ?>"><i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                                <li class="divider"></li>
                                <?php
                                foreach ($warehouses as $warehouse) {
                                   echo '<li><a href="' . admin_url('reports/biller_report/' . ($user_id ? $user_id : '') . '/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                                }
                                ?>
                            </ul>
                        </li>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="productform">
							...
							<?php echo admin_form_open("reports/biller_report/".$user_id."/#product-con"); ?>
								<div class="row">
