        ...
        <div class="row">
            <div class="col-lg-12">
                 ...
                 <div id="form">
                    ...
                    <?php echo admin_form_open("reports/convert_report_detail/".$convert->product_id .'/'. 0 . '/'.$start.'/'.$end,'method="GET"'); ?>
                    <div class="row">
                        <div class="col-sm-3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped print-table order-table">
						...
						foreach($convert_detail as $convert){
							if($convert->bom_id){
						    $query = $this->db->query("
							                    SELECT bpas_convert_items.status,bpas_convert_items.product_code,bpas_convert_items.product_name,bpas_convert_items.quantity,bpas_units.name as unit,bpas_product_variants.name as var_name,bpas_convert_items.cost From bpas_convert_items LEFT JOIN bpas_products ON bpas_products.id=bpas_convert_items.product_id LEFT JOIN bpas_units ON bpas_units.id =bpas_products.unit
                                                LEFT JOIN bpas_product_variants ON bpas_product_variants.id=bpas_convert_items.option_id  
												where bpas_convert_items.convert_id ='$convert->id'")->result();	
						?>
