        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
					...
					?>
						<table id="SLData" class="table table-striped table-condensed">
							<thead>
								<tr>
							...
							<tbody>					
								<tr>
									...
									<td><?= $this->bpas->hrsd($saleInvoice->date)?></td>
									...
									<td><?= $this->bpas->formatMoney($saleInvoice->grand_total)?></td>
								</tr>
								<tr>
									<td></td>
									<td colspan="7">
										<table class="tables" border="1">
														...
														<td>
															<?php 
																if ($pay->type == 'returned') {
																	$amount = (-1) * $pay->amount;
																	echo $this->bpas->formatMoney((-1) * $pay->amount);
																} else {
																	$amount = $pay->amount;
																	echo $this->bpas->formatMoney($pay->amount);
																}
																$total_amt += $amount;
															?>
														</td>
											...
											<tfoot>
												<tr>
													...
													<td colspan="4" class="text-left bold"><?= $this->bpas->formatMoney($total_amt); ?></td>
												</tr>
											</tfoot>
										</table>
									</td>
