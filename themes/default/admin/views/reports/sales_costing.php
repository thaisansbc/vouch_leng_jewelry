...
<style>
    ...
    #SlRData > tfoot > tr > th:nth-child(14) > div, #SlRData > tfoot > tr > th:nth-child(13) > div, #SlRData > tfoot > tr > th:nth-child(12) > div, #SlRData > tfoot > tr > th:nth-child(11) > div { width: 100px; }
</style>
<style type="text/css">
    body {
...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getSales_with_Costing_Report/?v=1' . $v) ?>',
            ...
            "aoColumns": [
                ...
                // {"bSearchable": false, "mRender": pqFormat1 },
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    if(aaData[aiDisplay[i]][10] != null){
                        cost += parseFloat(aaData[aiDisplay[i]][10]);
                    }
                ...
                nCells[10].innerHTML = currencyFormat(parseFloat(cost));
                ...
                <div class="table-responsive">
                    <table id="SlRData" class="table table-hover table-striped table-condensed reports-table">
                        ...
                        <tr>
                            ...
                            <th style="text-align: right !important;"><?= lang('costing'); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getSales_with_Costing_Report/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSales_with_Costing_Report/0/xls/?v=1' . $v)?>";
            return false;
        });
        $('#xls2').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSales_with_Costing_Report/0/0/0/0/xls2/?v=1' . $v)?>";
            return false;
        });
        $('#xls_detail').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSales_with_Costing_Report/0/0/0/excel_deatail/?v=1' . $v)?>";
            return false;
        });
        $('#preview').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSales_with_Costing_Report/0/0/preview/?v=1' . $v)?>";
            return false;
        });
