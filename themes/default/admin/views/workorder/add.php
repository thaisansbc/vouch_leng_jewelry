            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
					...
					<div class="form-group standard cost">
                        ...
                        <?= form_input('cost', (isset($_POST['cost']) ? $_POST['cost'] : ($product ? $this->bpas->formatDecimal($product->cost) : '')), 'class="form-control tip number_only" id="cost" required="required"') ?>
                    </div>
					
					<div class="form-group all">
                        <?= lang("product_price", "price") ?>
                        <?= form_input('price', (isset($_POST['price']) ? $_POST['price'] : ($product ? $this->bpas->formatDecimal($product->price) : '')), 'class="form-control tip number_only"  id="price" required="required"') ?>
                    </div>
                    ...
                    <div class="form-group standard">
                        ...
                        <div
                            class="input-group"> <?= form_input('alert_quantity', (isset($_POST['alert_quantity']) ? $_POST['alert_quantity'] : ($product ? $this->bpas->formatQuantity($product->alert_quantity) : 0)), 'class="form-control tip" id="alert_quantity"') ?>
                    ...
                    <div class="standard">
                        ...
                        <div class="well well-sm" id="attr-con" style="<?= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?>">
                            ...
                            <div class="table-responsive">
                                <table id="attrTable" class="table table-condensed table-striped" style="<?= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?>margin-bottom: 0; margin-top: 10px;">
                                    <thead>
                                    <tr class="active">
                                        <th><?= lang('name') ?></th>
									...
									?>
                                            <tr class="attr">
												...
												<td class="quantity_unit text-center"><input type="hidden" name="attr_quantity_unit[]" value="<?= $this->bpas->formatQuantity($option->qty_unit);?>"><span><?= $this->bpas->formatQuantity($option->qty_unit);?></span></td>
												
												<td class="price text-right"><input type="hidden" name="attr_price[]" value="<?= $this->bpas->formatQuantity($option->price);?>"><span><?= $this->bpas->formatQuantity($option->price);?></span></td>
