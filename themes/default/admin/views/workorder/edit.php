...
foreach ($warehouses_products as $warehouses_product) {
    $pQty += $this->bpas->formatQuantity($warehouses_product->quantity);
}
                   ...
                   <?php 
                    ...
                    ?>
                        <div class="form-group all">
                            ...
                            echo form_dropdown('unit', $ut, (isset($_POST['unit']) ? $_POST['unit'] : ($product ? $this->bpas->formatDecimal($product->unit) : '')), 'class="form-control" id="unit" required="required" placeholder="'.lang('select_units').'" style="width:100%;"');
                            ?>
                        </div>
                    <?php
                    }else{
                    ?>
                        <div class="form-group all">
                            ...
                            echo form_dropdown('unit', $ut, (isset($_POST['unit']) ? $_POST['unit'] : ($product ? $this->bpas->formatDecimal($product->unit) : '')), 'class="form-control select" id="unit" required="required" placeholder="'.lang('select_units').'" style="width:100%;"');
                            ?>
                        </div>
                    <?php
                    }
                    ...
                    <?php  if(empty($product_item)){ ?>
                        <div class="form-group standard">
                            ...
                            <?= form_input('cost', (isset($_POST['cost']) ? $_POST['cost'] : ($product ? $this->bpas->formatDecimal($product->cost) : '')), 'class="form-control tip" id="costs" required="required"') ?>
                        </div>
                    <?php }else{ ?>
                        <div class="form-group standard">
                            <?= lang("product_cost", "cost") ?>
                            <?= form_input('cost', (isset($_POST['cost']) ? $_POST['cost'] : ($product ? $this->bpas->formatDecimal($product->cost) : '')), 'class="form-control tip pcost" id="costs" required="required"') ?>
                        </div>
                    <?php  } ?>
                    ...
                    <?php if(empty($product_item)) { ?>
						<div class="form-group all">
							...
							<?= form_input('price', (isset($_POST['price']) ? $_POST['price'] : ($product ? $this->bpas->formatDecimal($product->price) : '')), 'class="form-control tip" id="prices" required="required"') ?>
						</div>
                    <?php }else { ?>
						<div class="form-group all">
							<?= lang("product_price", "price") ?>
							
							<?= form_input('price', (isset($_POST['price']) ? $_POST['price'] : ($product ? $this->bpas->formatDecimal($product->price) : '')), 'class="form-control tip pprice" id="prices" required="required"') ?>
						</div>
                    <?php } ?>
                    ...
                    <div class="form-group standard">
                        ...
                        <div
                            class="input-group"> <?= form_input('alert_quantity', (isset($_POST['alert_quantity']) ? $_POST['alert_quantity'] : ($product ? $this->bpas->formatDecimal($product->alert_quantity) : 0)), 'class="form-control tip palert" id="alert_quantity"') ?>
                        ...
                        <div class="well well-sm">
                            ...
                            <!-- <table class="table table-condensed table-striped" -->
                                ...
                                // foreach ($product_options as $option) {
                                    ...
                                    // '<td class="quantity_unit text-center col-xs-2"><span>' . $this->bpas->formatQuantity($option->qty_unit) . '</span></td>'.
                                    //'<td class="quantity text-center col-xs-2"><span>' . $this->bpas->formatQuantity($option->wh_qty) . '</span></td>'.
                                    //'<td class="cost text-right col-xs-2">' . $this->bpas->formatMoney($option->cost) . '</td>'.
                                    // '<td class="price text-right col-xs-2">' . $this->bpas->formatMoney($option->price) . '</td></tr>';
                                // }
                            ?>
                            <!-- </tbody> -->
                            <!-- </table> -->
                            ...
                            <div class="table-responsive">
                                <table id="attrTable" class="table table-condensed table-striped" style="margin-bottom: 0; margin-top: 10px;">
                                    <thead>
                                    <tr class="active">
                                        <th><?= lang('name') ?></th>
                                        <!--<th><?= lang('warehouse') ?></th>-->
