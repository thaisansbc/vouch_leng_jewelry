                ...
                <div class="row">
                    <div class="col-md-9 col-sm-9">
                        <ul id="myTab" class="nav nav-tabs">
                            ...
                            <li class="dropdown">
                                ...
                                <ul aria-labelledby="more" role="menu" class="dropdown-menu">
                                    ...
                                    <li class=""><a href="#property_agreement"><?= lang('property_agreement') ?></a></li>
                                    <li class=""><a href="#service_agreement"><?= lang('service_agreement') ?></a></li>
                                    <li class=""><a href="#payslip"><?= lang('payslip') ?></a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="property_agreement" class="tab-pane fade">
                                <?= admin_form_open('system_settings/email_templates/property_agreement'); ?>

                                <?php echo form_textarea('mail_body', (isset($_POST['mail_body']) ? html_entity_decode($_POST['mail_body']) : html_entity_decode($property_agreement)), 'class="form-control" id="comment"'); ?>
                            ...
                            <div id="service_agreement" class="tab-pane fade">
                                <?= admin_form_open('system_settings/email_templates/service_agreement'); ?>

                                <?php echo form_textarea('mail_body', (isset($_POST['mail_body']) ? html_entity_decode($_POST['mail_body']) : html_entity_decode($service_agreement)), 'class="form-control" id="comment"'); ?>
                            ...
                            <div id="payslip" class="tab-pane fade">
                                <?= admin_form_open('system_settings/email_templates/payslip'); ?>

                                <?php echo form_textarea('mail_body', (isset($_POST['mail_body']) ? html_entity_decode($_POST['mail_body']) : html_entity_decode($payslip)), 'class="form-control" id="comment"'); ?>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="margin5">
                            ...
                            <?= lang('sale'); ?>
                            <pre>{customer_company} {order_link} {reference_number} {quote_number} {service_name}</pre>
