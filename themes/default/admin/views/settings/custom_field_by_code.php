...
<script>
    $(document).ready(function () {
        $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getcustom_fieldbycode?v=1'.$v); ?>',
...
<div class="breadcrumb-header">
    <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang($page); ?></h2>
        ...
        <ul class="btn-tasks">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                    <li>
                        <a href="<?php echo admin_url('system_settings/add_custom_field/'.$page); ?>" data-toggle="modal" data-target="#myModal">
