...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open("system_settings/add_cash_account", $attrib); ?>
        <div class="modal-body">
            ...
            ?>
				<div class="form-group">
                    ...
                    <?php 
                    echo form_dropdown('account_code', $acc, '', 'class="form-control select" id="account_code" style="width:100%;" required="required"');
                    ?>
				</div>
			<?php } ?>
			<div class="form-group">
