...
<script>
    $(document).ready(function () {
        oTable = $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getMulti_buyGroups') ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_price_group') ?>" class="tip" href="<?php echo admin_url('system_settings/add_multi_buys'); ?>" data-toggle="modal" data-backdrop="static" data-target="#myModal">
