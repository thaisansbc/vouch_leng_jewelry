...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart('system_settings/import_language_by_csv', $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>

            <div class="well well-small">
                <a href="<?php echo base_url(); ?>assets/csv/sample_language.csv" class="btn btn-primary pull-right"><i
                        class="fa fa-download"></i> Download Sample File</a>
                <span class="text-warning"><?= lang('csv1'); ?></span><br/><?= lang('csv2'); ?> 
                <span class="text-info">
                    (<?= lang('code') . ', ' . lang('english') . ', ' . lang('khmer') . ', ' . lang('chinese') . ', ' . lang('thai') . ', 
                        ' . lang('vietnamese'); ?>
                    )</span> <?= lang('csv3'); ?><br>
