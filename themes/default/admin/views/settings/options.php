...
<script>
    $(document).ready(function () {
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getOptions') ?>',
...
<div class="breadcrumb-header">
    ...
    <div class="box-icon">
        <ul class="btn-tasks">
            <li class="dropdown"><a href="<?php echo admin_url('system_settings/add_option'); ?>"
                                    data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="icon fa fa-plus"></i></a>
            </li>
        </ul>
    </div>
</div>
