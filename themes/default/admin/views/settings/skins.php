    ...
    $(document).ready(function () {
      ...
      function userstatus(x) {
        ...
        $('#SMTData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getSkins') ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox},null,{"mRender" :status},null,{"mRender" : fsd}, { "mRender" : fsd}, 
            { "fnRender": function (o) {
                        if(o.aData[6] != null){
                            var st = [];
                            var products_by_id = o.aData[6].split(",");
                    ...
                    }},null ,{"mRender" : userstatus}, {"bSortable": false}
                  ]
           
        });
    });
</script>
 <?= admin_form_open('system_settings/skins_actions', 'id="action-form"') ?> 
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo admin_url('system_settings/add_skins'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('Add_Skins') ?></a></li>
                        <li><a href="#" id="excel" data-action="export_excel"><i
                                    class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>
                        
                        <li class="divider"></li>
                        <li><a href="#" id="delete" data-action="delete"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_skins') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="SMTData" class="table table-bordered table-hover table-striped">
                        <thead>
                        <tr>
                            <th style="min-width:30px; width: 50px; text-align: center;">
                                <input class="checkbox checkth" type="checkbox" name="check"/>
                            </th>
							<th><?php echo $this->lang->line("Customer"); ?></th>
                            <th><?php echo $this->lang->line("Targert_Type"); ?></th>
