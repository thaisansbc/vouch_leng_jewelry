    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?php echo form_input('atten_name', $warehouse->atten_name, 'class="form-control" id="atten_name"'); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?= form_dropdown('saleable', $saleable, $warehouse->saleable, 'class="form-control"'); ?>
            </div>
            <div class="form-group">
                ...
                <input id="logo" type="file" data-browse-label="<?= lang('browse'); ?>" name="logo" data-show-upload="false" data-show-preview="false" class="form-control file">
                 ...
                 <div class="form-group">
                     ...
                     <div class="controls">
                         ...
                         echo form_dropdown('default_currency', $cu, $warehouse->default_currency, 'class="form-control tip" id="currency" required="required" style="width:100%;"');
                         ?>
                     </div>
                 </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    ...
                    echo form_dropdown('warehouse_over_selling', $opt,  $warehouse->overselling, 'class="form-control" style="width:100%;"');
                    ?>
                </div>
            </div>
            <?php }?>
