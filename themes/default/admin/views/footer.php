...
var lang = {use: '<?=lang('use');?>', return: '<?=lang('return');?>', paid: '<?=lang('paid');?>', unpaid: '<?=lang('unpaid');?>', requested: '<?=lang('requested');?>', approved: '<?=lang('approved');?>', reject: '<?=lang('rejected');?>', rejected: '<?=lang('rejected');?>', order: '<?=lang('ordered');?>', pending: '<?=lang('pending');?>', completed: '<?=lang('completed');?>', ordered: '<?=lang('ordered');?>', received: '<?=lang('received');?>', partial: '<?=lang('partial');?>', sent: '<?=lang('sent');?>', r_u_sure: '<?=lang('r_u_sure');?>', due: '<?=lang('due');?>', returned: '<?=lang('returned');?>', transferring: '<?=lang('transferring');?>', active: '<?=lang('active');?>', inactive: '<?=lang('inactive');?>', unexpected_value: '<?=lang('unexpected_value');?>', no_match_found: '<?=lang('no_match_found');?>', select_above: '<?=lang('select_above');?>', download: '<?=lang('download');?>', making: '<?=lang('making');?>',verified: '<?=lang('verified');?>',spoiled: '<?=lang('spoiled');?>',paid: '<?=lang('paid');?>', expired: '<?=lang('expired');?>', assigned: '<?=lang('assigned');?>',cleared: '<?=lang('cleared');?>', approved: '<?=lang('approved');?>',inactive: '<?=lang('inactive');?>', unexpected_value: '<?=lang('unexpected_value');?>',payoff: '<?=lang('payoff');?>', pawn_rate: '<?=lang('pawn_rate');?>', pawn_received: '<?=lang('pawn_received');?>', pawn_sent: '<?=lang('pawn_sent');?>', closed: '<?=lang('closed');?>', yes: '<?=lang('yes');?>', no: '<?=lang('no');?>', morning: '<?=lang('morning');?>', afternoon: '<?=lang('afternoon');?>', full: '<?=lang('full');?>', freight: '<?=lang('freight');?>', packaging: '<?=lang('packaging');?>', take_away: '<?=lang('take_away');?>', fixed: '<?=lang('fixed');?>', difference: '<?=lang('difference');?>', checked_in: '<?=lang('checked_in');?>', checked_out: '<?=lang('checked_out');?>',checked: '<?=lang('checked');?>', expense : '<?= lang('expense') ?>', draft : '<?= lang('draft') ?>', enrolled : '<?= lang('enrolled') ?>', 
        ...
        wax_model_creation_qty: '<?=lang('wax_model_creation_qty')?>',
        casting_qty: '<?=lang('casting_qty')?>',
        filing_pre_polishing_qty: '<?=lang('filing_pre_polishing_qty')?>',
        stone_setting_qty: '<?=lang('stone_setting_qty')?>',
        final_polishing_qty: '<?=lang('final_polishing_qty')?>',
        quality_inspection_qty: '<?=lang('quality_inspection_qty')?>',
        packaging_qty: '<?=lang('packaging_qty')?>',
        wax_model_creation_qty_required: '<?=lang('wax_model_creation_qty_required')?>',
        casting_qty_required: '<?=lang('casting_qty_required')?>',
        filing_pre_polishing_qty_required: '<?=lang('filing_pre_polishing_qty_required')?>',
        stone_setting_qty_required: '<?=lang('stone_setting_qty_required')?>',
        final_polishing_qty_required: '<?=lang('final_polishing_qty_required')?>',
        quality_inspection_qty_required: '<?=lang('quality_inspection_qty_required')?>',
        packaging_qty_required: '<?=lang('packaging_qty_required')?>',
        wax_model_creation_qty_greater_than_casting_qty: '<?=lang('wax_model_creation_qty_greater_than_casting_qty')?>',
        casting_qty_greater_than_filing_pre_polishing_qty: '<?=lang('casting_qty_greater_than_filing_pre_polishing_qty')?>',
        filing_pre_polishing_qty_greater_than_stone_setting_qty: '<?=lang('filing_pre_polishing_qty_greater_than_stone_setting_qty')?>',
        stone_setting_qty_greater_than_final_polishing_qty: '<?=lang('stone_setting_qty_greater_than_final_polishing_qty')?>',
        final_polishing_qty_greater_than_quality_inspection_qty: '<?=lang('final_polishing_qty_greater_than_quality_inspection_qty')?>',
        quality_inspection_qty_greater_than_packaging_qty: '<?=lang('quality_inspection_qty_greater_than_packaging_qty')?>',
    };
</script>
