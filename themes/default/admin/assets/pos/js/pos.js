...
function loadItems() {
    ...
    if (localStorage.getItem('positems')) {
        ...
        //    if (localStorage.getItem('language') != 'khmer'){
                tr_html += '<td class="text-right"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + (ssubtotal != 0 ? '$' + ssubtotal : 'Free') + '</span></td>';
        //    }else{
        //         tr_html += '<td class="text-right"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + (ssubtotalkh != 0 ?  ssubtotalkh + '៛'  : 'ឥតគិតថ្លៃ') + '</span></td>';
        //    }
