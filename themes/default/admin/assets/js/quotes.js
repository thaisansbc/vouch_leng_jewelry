    ...
    if (localStorage.getItem('quitems')) {
        ...
        $.each(sortedItems, function() {
            ...
            tr_html =
                ...
                item_option +
                '"><input name="product_comment[]" type="hidden" class="roption" value="' +
                item_comment +
                ...
                '" data-item="' +
                item_id +
                '" title="Edit" style="cursor:pointer;"></i> <i class="pull-right fa-regular fa fa-rectangle-list '+(item_comment != '' ? '' :'-o')+' tip pointer comment" id="' + row_no + '" data-item="' + item_id + '" title="Comment" style="cursor:pointer;margin-right:5px;"></i></td>';
            tr_html +=
