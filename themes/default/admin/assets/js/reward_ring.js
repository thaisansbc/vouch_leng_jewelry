...
function loadItems() {
    if (localStorage.getItem('qaitems')) {
        ...
        $.each(sortedItems, function () {
            ...
            tr_html = '<td><input name="product_id[]" type="hidden" class="rid" value="' + product_id + '"><span class="sname" id="name_' + row_no + '">' + item_code +' - ' + item_name + ' (' + product_unit_name + ')' + '</span>'+
                '<input type="text" name="money[]" class="form-control money" style="width: 200px;float: right;"/>'+
                '</td>';
            ...
            tr_html += '<td><input type="text" name="money[]" class="form-control money"/></td>';
