...
function searchProducts(t) {
    $("#loading").show();
    console.log(site.shop_url);
    var e = {};
    e[site.csrf_token] = site.csrf_token_value, e.filters = get_filters(), e.format = "json", $.ajax({
...
function update_cart(t) {
    if (t.total_items && t.total_items > 0) {
        ...
        a += "<tr><td>" + lang.product_tax + '</td><td class="text-right">' + t.total_item_tax + "</td></tr>", a += "<tr><td>" + lang.total + '</td><td class="text-right">' + t.total + "</td></tr>", !1 !== site.settings.tax2 && (a += "<tr><td>" + lang.order_tax + '</td><td class="text-right">' + t.order_tax + "</td></tr>"), a += "<tr><td>" + lang.shipping + ' *</td><td class="text-right">' + t.shipping + "</td></tr>", a += '<tr><td colspan="2"></td></tr>', a += '<tr class="active text-bold"><td>' + lang.grand_total + '</td><td class="text-right">' + t.grand_total + "</td></tr>", $("<tbody>" + a + "</tbody>").appendTo("#cart-totals"), $("#total-items").text(t.total_items + "(" + t.total_unique_items + ")"), $(".cart-item-option").selectpicker("refresh"), $(".cart-empty-msg").hide(), $(".cart-contents").show()
...
function formatSA(t) {
    ...
    return "" != s && (a = "," + a), s.replace(/\B(?=(\d{2})+(?!\d))/g, ",") + a + e
}
...
function saa_alert(t, e, a, s) {
    a = a || lang.delete, e = e || lang.x_reverted_back, s = s || {}, s._method = a, s[site.csrf_token] = site.csrf_token_value, swal({
        title: lang.r_u_sure,
        html: e,
        type: "question",
        showCancelButton: !0,
...
function add_address(t) {
    ...
    if (istates) {
        ...
        a.id = "address-state", a.name = "state", a.className = "selectpickerstate mobile-device", a.setAttribute("data-live-search", !0), a.setAttribute("title", "State");
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(t, e) {
                $("#address-line-1").val() || e(lang.line_1 + " " + lang.is_required), $("#address-city").val() || e(lang.city + " " + lang.is_required), $("#address-state").val() || e(lang.state + " " + lang.is_required), $("#address-country").val() || e(lang.country + " " + lang.is_required), $("#address-phone").val() || e(lang.phone + " " + lang.is_required), t()
            })
        },
        onOpen: function() {
            if ($("#address-line-1").val(t.line1 ? t.line1 : "").focus(), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) $(".selectpickerstate").selectpicker({
                ...
                for (var e = document.querySelectorAll(".mobile-device"), a = 0; a < e.length; a++) e[a].classList.remove("mobile-device");
...
function email_form() {
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(t, e) {
                $("#form-name").val() || e(lang.name + " " + lang.is_required), $("#form-email").val() || e(lang.email + " " + lang.is_required), $("#form-subject").val() || e(lang.subject + " " + lang.is_required), $("#form-message").val() || e(lang.message + " " + lang.is_required), validateEmail($("#form-email").val()) || e(lang.email_is_invalid), t()
            })
        },
        onOpen: function() {
            $("#form-name").focus()
...
$(function() {
    ...
    if ($(".theme-color").click(function(t) {
        ...
        t.preventDefault();
        var e = {};
        e.rowid = $(this).attr("data-rowid"), saa_alert(site.site_url + "cart/remove", !1, "post", e)
        ...
        o[site.csrf_token] = site.csrf_token_value, o.rowid = s, o.qty = a.find(".cart-item-qty").val(), o.option = a.find(".cart-item-option").children("option:selected").val(), update_cart_item(i, o, e, $(this), t.target.type)
        ...
        $('[data-target="#lightbox"]').on("click", function(t) {
            ...
            a.find(".close").addClass("hidden"), a.find("img").attr("src", s), a.find("img").attr("alt", i), a.find("img").css(o), a.find(".modal-content").removeClass("swal2-hide").addClass("swal2-show")
        }), a.on("shown.bs.modal", function(t) {
            var e = a.find("img");
            a.find(".modal-dialog").css({
                width: e.width()
            }), a.find(".close").removeClass("hidden"), a.addClass("fade"), $(".modal-backdrop").addClass("fade")
    ...
    s.match("#") && $('.nav-tabs a[href="#' + s.split("#")[1] + '"]').tab("show"), $(document).on("click", ".show-tab", function(t) {
